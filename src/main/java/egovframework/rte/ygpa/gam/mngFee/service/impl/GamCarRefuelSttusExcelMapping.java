...
public class GamCarRefuelSttusExcelMapping extends EgovExcelMapping {
	...
	public Object mappingColumn(HSSFRow row) {
		...
		GamCarRefuelSttusExcelVo vo = new GamCarRefuelSttusExcelVo();
		vo.setCarRegistNo(EgovExcelUtil.getValue(cell0));
		vo.setRefuelMt(EgovExcelUtil.getValue(cell1));
		vo.setRefuelQy(EgovExcelUtil.getValue(cell2));
		return vo;
