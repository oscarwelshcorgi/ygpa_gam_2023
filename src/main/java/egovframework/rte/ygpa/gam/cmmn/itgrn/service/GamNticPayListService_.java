...
public interface GamNticPayListService_ {
	 ...
	 * 시납부현황목록조회 상세화면
	 * @param emplyrId
	 * @return GamNticPayListVO_
	 * @throws Exception
	 */
	public GamNticPayListVO_ gamNticPayListSelectView(GamNticPayListVO_ nticPayListVO) throws Exception;
}