...
public class GamAssetRentSttusInqireServiceImpl  extends AbstractServiceImpl implements GamAssetRentSttusInqireService {
	 ...
	 * @exception Exception
	 */
	public void insertAssetRentSttusInqireFirst(GamAssetRentSttusInqireVO vo) throws Exception {
		gamAssetRentSttusInqireDao.insertAssetRentSttusInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertAssetRentSttusInqireRenew(GamAssetRentSttusInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//자산임대 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamAssetRentSttusInqireDao.selectAssetRentSttusInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamAssetRentSttusInqireDao.insertAssetRentSttusInqireRenew(vo); 
		
		//자산임대상세정보 조회
		List detailList = gamAssetRentSttusInqireDao.selectAssetRentSttusInqireDetailInfo(vo);
		
		GamAssetRentSttusInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamAssetRentSttusInqireDetailVO();
			resultVo = (GamAssetRentSttusInqireDetailVO)detailList.get(i);
			...
			//자산임대상세 복사등록
			gamAssetRentSttusInqireDao.insertAssetRentSttusInqireDetailRenew(resultVo); 
		}
		
		GamAssetRentSttusInqireVO updRentVO = new GamAssetRentSttusInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamAssetRentSttusInqireDao.selectAssetRentSttusInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamAssetRentSttusInqireDao.updateAssetRentSttusInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void deleteAssetRentSttusInqire(GamAssetRentSttusInqireVO vo) throws Exception {

		gamAssetRentSttusInqireDao.deleteAssetRentSttusInqirePhoto(vo); //자산임대 사진정보 삭제

		gamAssetRentSttusInqireDao.deleteAssetRentSttusInqireDetail(vo); //자산임대 상세정보 삭제

		gamAssetRentSttusInqireDao.deleteAssetRentSttusInqire(vo); // 자산임대정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deleteAssetRentSttusInqireDetail(GamAssetRentSttusInqireVO vo) throws Exception {
		gamAssetRentSttusInqireDao.deleteAssetRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertAssetRentSttusInqireDetail(GamAssetRentSttusInqireDetailVO vo) throws Exception {
		gamAssetRentSttusInqireDao.insertAssetRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateAssetRentSttusInqireDetail(GamAssetRentSttusInqireDetailVO vo) throws Exception {
		gamAssetRentSttusInqireDao.updateAssetRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteAssetRentSttusInqireDetail2(GamAssetRentSttusInqireDetailVO vo) throws Exception {
		gamAssetRentSttusInqireDao.deleteAssetRentSttusInqireDetail2(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateAssetRentSttusInqirePrmisn(GamAssetRentSttusInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamAssetRentSttusInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamAssetRentSttusInqireDao.insertAssetRentSttusInqireLevReqest(vo);
		    }
			
		}

		//자산임대 허가여부를 수정
		gamAssetRentSttusInqireDao.updateAssetRentSttusInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateAssetRentSttusInqirePrmisnCancel(GamAssetRentSttusInqireLevReqestVO vo) throws Exception {
		gamAssetRentSttusInqireDao.updateAssetRentSttusInqirePrmisnCancel(vo);
	}
