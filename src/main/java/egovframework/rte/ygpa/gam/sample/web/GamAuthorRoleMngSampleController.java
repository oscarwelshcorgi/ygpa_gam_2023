...
@Controller
public class GamAuthorRoleMngSampleController {
	...
	@RequestMapping(value="/sample/gamAuthorRoleMng.do")
    String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	model.addAttribute("windowId", windowId);
    	return "/ygpa/gam/sample/GamAuthorRoleMng";
    }
    ...
    @RequestMapping(value="/sample/gamAuthorRoleList.do")
