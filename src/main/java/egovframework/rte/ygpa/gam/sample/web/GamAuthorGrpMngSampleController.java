...
@Controller
public class GamAuthorGrpMngSampleController {
	...
	@RequestMapping(value="/sample/gamAuthorGrpMng.do")
    String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	model.addAttribute("windowId", windowId);

    	List list = egovAuthorManageService.selectAuthorAllList(new AuthorManageVO());
        model.addAttribute("authorManageList", list);

    	return "/ygpa/gam/sample/GamAuthorGrpMng";
    }
	...
	@RequestMapping(value="/sample/gamAuthorGroupList.do")
