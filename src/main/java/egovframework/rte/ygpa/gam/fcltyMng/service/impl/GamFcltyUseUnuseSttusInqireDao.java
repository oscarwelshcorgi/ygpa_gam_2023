...
public class GamFcltyUseUnuseSttusInqireDao extends YGPAAbstractDAO {
	...
	public GamFcltyUseUnuseSttusInqireVO selectFcltyUseUnuseSttusInqireListTotCnt(GamFcltyUseUnuseSttusInqireVO searchVO) throws Exception {
		return (GamFcltyUseUnuseSttusInqireVO)getSqlMapClientTemplate().queryForObject("gamFcltyUseUnuseSttusInqireDao.selectFcltyUseUnuseSttusInqireListTotCnt_S", searchVO);
	}
	 ...
	 * @param searchVO
	 */
	public List selectFcltyUseUnuseSttusInqireChartList(GamFcltyUseUnuseSttusInqireVO searchVO) {
		return list("gamFcltyUseUnuseSttusInqireDao.selectFcltyUseUnuseSttusInqireChartList_D", searchVO);
