...
public class GamFcltyRepairSttusInqireDao extends YGPAAbstractDAO {
	...
	public GamFcltyRepairSttusInqireVO selectFcltyRepairSttusInqireListTotCnt(GamFcltyRepairSttusInqireVO vo) throws Exception {
		return (GamFcltyRepairSttusInqireVO) selectByPk("gamFcltyRepairSttusInqireDao.selectFcltyRepairSttusInqireListTotCnt_S", vo);
	}
	 ...
	 * @throws Exception
	 */
	public EgovMap selectFcltyRepairSttusInqireDetail(GamFcltyRepairSttusInqireVO vo) throws Exception{
		return (EgovMap) selectByPk("gamFcltyRepairSttusInqireDao.selectFcltyRepairSttusInqireDetail_S", vo);
	}
