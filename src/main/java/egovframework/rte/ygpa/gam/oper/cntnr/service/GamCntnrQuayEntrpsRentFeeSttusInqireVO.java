...
/**
 * @Class Name : GamCntnrQuayEntrpsRentFeeSttusInqireVO.java
 * @Description : 컨테이너부두임대업체별사용료현황조회 VO class
 ...
 */
public class GamCntnrQuayEntrpsRentFeeSttusInqireVO extends ComDefaultVO {
