...
/**
 * @Class Name : GamTestPrtFcltyNticArrvlDtaInqireLevReqestVO.java
 * @Description : 항만시설고지도래현황조회 VO class
 ...
 */
public class GamTestPrtFcltyNticArrvlDtaInqireLevReqestVO extends ComDefaultVO {
