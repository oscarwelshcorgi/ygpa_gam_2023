...
/**
 * @Class Name : GamMarineCenterUseExprInqireVO.java
 * @Description : 마린센터임대만기도래자료조회(마린센터임대) VO class
 ...
 */
public class GamMarineCenterUseExprInqireVO extends ComDefaultVO {
