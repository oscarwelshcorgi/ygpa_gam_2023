...
/**
 * @Class Name : GamAssetRentSttusInqireLevReqestVO.java
 * @Description : 자산임대현황조회(징수의뢰) VO class
 ...
 */
public class GamTrainPortRentSttusInqireLevReqestVO extends ComDefaultVO {
