...
/**
 * @Class Name : GamCntnrQuayRentMngtLevReqestVO.java
 * @Description : 컨테이너부두사용목록관리 징수의뢰 VO class
 ...
 */
public class GamCntnrQuayRentMngtLevReqestVO extends ErpCmmnCdDefaultVO {
