...
/**
 * @Class Name : GamTestPrtFcltyMtRentFeeSttusInqireVO.java
 * @Description : 항만시설월별사용료현황조회 VO class
...
public class GamTestPrtFcltyMtRentFeeSttusInqireVO extends ComDefaultVO {
