...
public class GamCntnrQuayNticArrvlDtaInqireServiceImpl  extends AbstractServiceImpl implements GamCntnrQuayNticArrvlDtaInqireService {
    ...
    /**
	 * 컨테이너부두임대고지도래 최초 신청을 등록한다.
	 * @param vo GamCntnrQuayNticArrvlDtaInqireVO
	 * @exception Exception
	 */
	public void insertCntnrQuayNticArrvlDtaInqireFirst(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqireMaxNo(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireMaxNo(searchVO);
    }

    /**
	 * 컨테이너부두임대고지도래 연장 신청을 등록한다.
	 * @param vo GamCntnrQuayNticArrvlDtaInqireVO
	 * @exception Exception
	 */
	public void insertCntnrQuayNticArrvlDtaInqireRenew(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//컨테이너부두임대 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireRenew(vo); 
		
		//컨테이너부두임대상세정보 조회
		List detailList = gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireDetailInfo(vo);
		
		GamCntnrQuayNticArrvlDtaInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamCntnrQuayNticArrvlDtaInqireDetailVO();
			resultVo = (GamCntnrQuayNticArrvlDtaInqireDetailVO)detailList.get(i);
			...
			//컨테이너부두임대상세 복사등록
			gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireDetailRenew(resultVo); 
		}
		
		GamCntnrQuayNticArrvlDtaInqireVO updRentVO = new GamCntnrQuayNticArrvlDtaInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayNticArrvlDtaInqire(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqire(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCntnrQuayNticArrvlDtaInqire(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {

		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqirePhoto(vo); //컨테이너부두임대 사진정보 삭제

		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqireDetail(vo); //컨테이너부두임대 상세정보 삭제

		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqire(vo); // 컨테이너부두임대정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCntnrQuayNticArrvlDtaInqireDetail(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertCntnrQuayNticArrvlDtaInqireDetail(GamCntnrQuayNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayNticArrvlDtaInqireDetail(GamCntnrQuayNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCntnrQuayNticArrvlDtaInqireDetail2(GamCntnrQuayNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqireDetail2(vo);
	}
    ...
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqirePrmisnInfo(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqirePrmisnInfo(searchVO);
    }
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayNticArrvlDtaInqirePrmisn(GamCntnrQuayNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamCntnrQuayNticArrvlDtaInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireLevReqest(vo);
		    }
			
		}

		//컨테이너부두임대 허가여부를 수정
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayNticArrvlDtaInqirePrmisnCancel(GamCntnrQuayNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqirePrmisnCancel(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertCntnrQuayNticArrvlDtaInqireFile(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.insertCntnrQuayNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayNticArrvlDtaInqireFile(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCntnrQuayNticArrvlDtaInqirePhotoSingle(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.deleteCntnrQuayNticArrvlDtaInqirePhotoSingle(vo);
	}
    ...
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqireMaxKey(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireMaxKey(searchVO);
    }
	...
	public void updateCntnrQuayNticArrvlDtaInqireComment(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireComment(vo);
	}
    ...
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqireRenewInfo(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireRenewInfo(searchVO);
    }
	...
	public void updateCntnrQuayNticArrvlDtaInqireRenewInfo(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireRenewInfo(vo);
	}
    ...
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqireCurrRenewInfo(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireCurrRenewInfo(searchVO);
    }
    ...
    public GamCntnrQuayNticArrvlDtaInqireVO selectCntnrQuayNticArrvlDtaInqireDetailQuaycd(GamCntnrQuayNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamCntnrQuayNticArrvlDtaInqireDao.selectCntnrQuayNticArrvlDtaInqireDetailQuaycd(searchVO);
    }
	...
	public void updateCntnrQuayNticArrvlDtaInqireQuaycd(GamCntnrQuayNticArrvlDtaInqireVO vo) throws Exception {
		gamCntnrQuayNticArrvlDtaInqireDao.updateCntnrQuayNticArrvlDtaInqireQuaycd(vo);
	}
