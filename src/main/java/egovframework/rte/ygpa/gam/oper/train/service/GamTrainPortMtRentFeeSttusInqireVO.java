...
/**
 * @Class Name : GamTrainPortMtRentFeeSttusInqireVO.java
 * @Description : 철송장임대월별사용료현황조회 VO class
 ...
 */
public class GamTrainPortMtRentFeeSttusInqireVO extends ComDefaultVO {
