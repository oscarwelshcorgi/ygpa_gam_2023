...
/**
 * @Class Name : GamMarineCenterUseExprInqireDetailVO.java
 * @Description : 마린센터임대만기도래자료조회(상세) VO class
 ...
 */
public class GamMarineCenterUseExprInqireDetailVO extends ComDefaultVO {
