...
/**
 * @Class Name : GamTrainPortRentLstMngtDetailVO.java
 * @Description : 철송장사용목록관리 상세 VO class
 ...
 */
public class GamTrainPortRentLstMngtDetailVO extends ErpCmmnCdDefaultVO {
