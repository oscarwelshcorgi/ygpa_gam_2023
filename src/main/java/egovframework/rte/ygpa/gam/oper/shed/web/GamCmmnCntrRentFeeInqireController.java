...
/**
 * @Class Name : GamCmmnCntrRentFeeInqireController.java
 ...
 */
@Controller
public class GamCmmnCntrRentFeeInqireController {
	...
	*/
    ...
    @Resource(name = "gamCmmnCntrRentFeeInqireService")
    private GamCmmnCntrRentFeeInqireService gamCmmnCntrRentFeeInqireService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/oper/shed/gamCmmnCntrRentFeeInqire.do")
    String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	...
    	return "/ygpa/gam/oper/shed/GamCmmnCntrRentFeeInqire";
    }
    ...
    @RequestMapping(value="/oper/shed/selectGamCmmnCntrRentFeeInqire.do", method=RequestMethod.POST)
    @ResponseBody Map selectGamCmmnCntrRentFeeInqireList(GamCmmnCntrRentFeeInqireVO searchVO) throws Exception {
    	...
    	totalCnt = gamCmmnCntrRentFeeInqireService.selectGamCmmnCntrRentFeeInqireListTotCnt(searchVO);
    	List resultList = gamCmmnCntrRentFeeInqireService.selectGamCmmnCntrRentFeeInqireList(searchVO);
    	
    	// 배후단지임대료관리 정보
    	GamCmmnCntrRentFeeInqireVO resultInfo = gamCmmnCntrRentFeeInqireService.selectGamCmmnCntrRentFeeInqireInfo(searchVO);
