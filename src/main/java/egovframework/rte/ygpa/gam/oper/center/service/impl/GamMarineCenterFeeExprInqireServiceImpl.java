...
public class GamMarineCenterFeeExprInqireServiceImpl  extends AbstractServiceImpl implements GamMarineCenterFeeExprInqireService {
	 ...
	 * @exception Exception
	 */
	public void insertMarineCenterFeeExprInqireFirst(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertMarineCenterFeeExprInqireRenew(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//마린센터임대 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamMarineCenterFeeExprInqireDao.selectMarineCenterFeeExprInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireRenew(vo); 
		
		//마린센터임대상세정보 조회
		List detailList = gamMarineCenterFeeExprInqireDao.selectMarineCenterFeeExprInqireDetailInfo(vo);
		
		GamMarineCenterFeeExprInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamMarineCenterFeeExprInqireDetailVO();
			resultVo = (GamMarineCenterFeeExprInqireDetailVO)detailList.get(i);
			...
			//마린센터임대상세 복사등록
			gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireDetailRenew(resultVo); 
		}
		
		GamMarineCenterFeeExprInqireVO updRentVO = new GamMarineCenterFeeExprInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamMarineCenterFeeExprInqireDao.selectMarineCenterFeeExprInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void updateMarineCenterFeeExprInqire(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqire(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteMarineCenterFeeExprInqire(GamMarineCenterFeeExprInqireVO vo) throws Exception {

		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqirePhoto(vo); //마린센터임대 사진정보 삭제

		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqireDetail(vo); //마린센터임대 상세정보 삭제

		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqire(vo); // 마린센터임대정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deleteMarineCenterFeeExprInqireDetail(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertMarineCenterFeeExprInqireDetail(GamMarineCenterFeeExprInqireDetailVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateMarineCenterFeeExprInqireDetail(GamMarineCenterFeeExprInqireDetailVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteMarineCenterFeeExprInqireDetail2(GamMarineCenterFeeExprInqireDetailVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqireDetail2(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateMarineCenterFeeExprInqirePrmisn(GamMarineCenterFeeExprInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamMarineCenterFeeExprInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireLevReqest(vo);
		    }
			
		}

		//마린센터임대 허가여부를 수정
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateMarineCenterFeeExprInqirePrmisnCancel(GamMarineCenterFeeExprInqireLevReqestVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqirePrmisnCancel(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertMarineCenterFeeExprInqireFile(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.insertMarineCenterFeeExprInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateMarineCenterFeeExprInqireFile(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteMarineCenterFeeExprInqirePhotoSingle(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.deleteMarineCenterFeeExprInqirePhotoSingle(vo);
	}
	...
	public void updateMarineCenterFeeExprInqireRenewInfo(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqireRenewInfo(vo);
	}
	...
	public void updateMarineCenterFeeExprInqireQuaycd(GamMarineCenterFeeExprInqireVO vo) throws Exception {
		gamMarineCenterFeeExprInqireDao.updateMarineCenterFeeExprInqireQuaycd(vo);
	}
