...
/**
 * @Class Name : GamCntnrQuayUseExprInqireDetailVO.java
 * @Description : 컨테이너부두임대만기도래자료조회(상세) VO class
 ...
 */
public class GamCntnrQuayUseExprInqireDetailVO extends ComDefaultVO {
