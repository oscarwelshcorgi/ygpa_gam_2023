...
/**
 * @Class Name : GamMarineCenterUseExprInqireController.java
 * @Description : 마린센터임대만기도래자료조회
 ...
 */
@Controller
public class GamMarineCenterUseExprInqireController {
    ...
    @Resource(name = "gamMarineCenterUseExprInqireService")
    private GamMarineCenterUseExprInqireService gamMarineCenterUseExprInqireService;
	
    
    /**
     * 마린센터임대만기도래관리 화면을 로딩한다. 
     *
     * @param windowId
     * @param model the model
     * @return "/ygpa/gam/oper/center/GamMarineCenterUseExprInqire"
     * @throws Exception the exception  
     */
	@RequestMapping(value="/oper/center/gamMarineCenterUseExprInqire.do")
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
		...
		//공시지가정보
		GamMarineCenterUseExprInqireVO gvo = new GamMarineCenterUseExprInqireVO();
		List olnlpList = gamMarineCenterUseExprInqireService.selectOlnlpInfo();
    ...
    @RequestMapping(value="/oper/center/gamSelectMarineCenterUseExprInqireList.do", method=RequestMethod.POST)
	@ResponseBody Map selectMarineCenterUseExprInqireList(GamMarineCenterUseExprInqireVO searchVO) throws Exception {
		...
		//마린센터임대목록
    	totalCnt = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireListTotCnt(searchVO);
    	List assetRentList = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireList(searchVO);
    	
    	paginationInfo.setTotalRecordCount(totalCnt);
        searchVO.setPageSize(paginationInfo.getLastPageNoOnPageList());
    	
    	//총면적, 총사용료
    	GamMarineCenterUseExprInqireVO resultSum = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireSum(searchVO);
     ...
     */
	@SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/oper/center/gamSelectMarineCenterUseExprInqireDetailList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectMarineCenterUseExprInqireDetailList(GamMarineCenterUseExprInqireVO searchVO) throws Exception {
		...
		// 마린센터임대상세리스트 및 총건수
		totalCnt = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireDetailListTotCnt(searchVO);
		List resultList = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireDetailList(searchVO);
     ...
     * @throws Exception
     */
	@RequestMapping(value="/oper/center/gamSaveMarineCenterUseExprInqire.do")
	@ResponseBody Map<String, Object> saveMarineCenterUseExprInqire(@RequestParam Map<String, Object> dataList) throws Exception {

		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		GamMarineCenterUseExprInqireDetailVO saveDetailVO = new GamMarineCenterUseExprInqireDetailVO(); 
    	...
    	try {
    		...
    		//마린센터임대저장
    		GamMarineCenterUseExprInqireVO saveVO= new GamMarineCenterUseExprInqireVO();
    		...
    		if( form.get("mngYear") == null || "".equals(form.get("mngYear")) ) {
    			GamMarineCenterUseExprInqireVO keyVO = new GamMarineCenterUseExprInqireVO();
    			keyVO = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireMaxKey(saveVO);
    			...
    			gamMarineCenterUseExprInqireService.insertMarineCenterUseExprInqireFirst(saveVO);
    	        ...
    	        gamMarineCenterUseExprInqireService.updateMarineCenterUseExprInqire(saveVO);
    		...
    		for( int i = 0 ; i < insertList.size() ; i++ ) {
    			...
    			GamMarineCenterUseExprInqireDetailVO insertDetailVO = new GamMarineCenterUseExprInqireDetailVO();
    			...
    			gamMarineCenterUseExprInqireService.insertMarineCenterUseExprInqireDetail(insertDetailVO);
    		}
    		...
    		for( int i = 0 ; i < updateList.size() ; i++ ) {
    			...
    			GamMarineCenterUseExprInqireDetailVO updateDetailVO = new GamMarineCenterUseExprInqireDetailVO();
    			...
    			gamMarineCenterUseExprInqireService.updateMarineCenterUseExprInqireDetail(updateDetailVO);
    		}
    		...
    		for( int i = 0 ; i < deleteList.size() ; i++ ) {
    			...
    			GamMarineCenterUseExprInqireDetailVO deleteDetailVO = new GamMarineCenterUseExprInqireDetailVO();
    			...
    			gamMarineCenterUseExprInqireService.deleteMarineCenterUseExprInqireDetail2(deleteDetailVO);
    		}
    		...
    		for( int i = 0 ; i < insertFileList.size() ; i++ ) {
    			...
    			GamMarineCenterUseExprInqireVO insertFileVO = new GamMarineCenterUseExprInqireVO();
    			...
    			gamMarineCenterUseExprInqireService.insertMarineCenterUseExprInqireFile(insertFileVO);
    		}
    		
    		for( int i = 0 ; i < updateFileList.size() ; i++ ) {
    			Map resultMap = updateFileList.get(i);
    			
    			GamMarineCenterUseExprInqireVO updateFileVO = new GamMarineCenterUseExprInqireVO();
    			...
    			gamMarineCenterUseExprInqireService.updateMarineCenterUseExprInqireFile(updateFileVO);
    		}
    		
    		for( int i = 0 ; i < deleteFileList.size() ; i++ ) {
    			Map resultMap = deleteFileList.get(i);
    			
    			GamMarineCenterUseExprInqireVO deleteFileVO = new GamMarineCenterUseExprInqireVO();
    			...
    			gamMarineCenterUseExprInqireService.deleteMarineCenterUseExprInqirePhotoSingle(deleteFileVO);
    		}
    		
    		//총사용료, 총면적, 총사용기간 조회
    		GamMarineCenterUseExprInqireVO paramVO = new GamMarineCenterUseExprInqireVO(); 
    		...
    		updRentVO = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireCurrRenewInfo(paramVO);
    		...
    		if( updRentVO != null ) {
    			...
    			//총사용료, 총면적, 총사용기간 업데이트
    			gamMarineCenterUseExprInqireService.updateMarineCenterUseExprInqireRenewInfo(updRentVO);
    			
    			//부두코드 가져오기
    			GamMarineCenterUseExprInqireVO quaycdVO = new GamMarineCenterUseExprInqireVO();
    			quaycdVO = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireDetailQuaycd(updRentVO);
    			
    			//부두코드 업데이트
    			if( quaycdVO == null || quaycdVO.getQuayCd() == null || "".equals(quaycdVO.getQuayCd()) ) {
    				quaycdVO = new GamMarineCenterUseExprInqireVO();
    			...
    			gamMarineCenterUseExprInqireService.updateMarineCenterUseExprInqireQuaycd(quaycdVO);
    		}
     ...
     * 마린센터임대 최초신청을 등록한다.
     * @param String
     * @param gamMarineCenterUseExprInqireVO
     * @param bindingResult
     * @return map
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamInsertMarineCenterUseExprInqireFirst.do") 
    public @ResponseBody Map insertMarineCenterUseExprInqireFirst(
    	   @RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
    	...
    	*/
        ...
        if("insert".equals(cmd)) {
	        beanValidator.validate(gamMarineCenterUseExprInqireVO, bindingResult);
			...
			//if(gamMarineCenterUseExprInqireVO.getProgrmDc()==null || progrmManageVO.getProgrmDc().equals("")){progrmManageVO.setProgrmDc(" ");}
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamInsertMarineCenterUseExprInqireRenew.do") 
    public @ResponseBody Map insertMarineCenterUseExprInqireRenew(
    	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO,
   	       BindingResult bindingResult)
           throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamUpdateMarineCenterUseExprInqire.do") 
    public @ResponseBody Map updateMarineCenterUseExprInqireFirst(
    	   @RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
    	   BindingResult bindingResult)
           throws Exception {
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamDeleteMarineCenterUseExprInqire.do") 
    public @ResponseBody Map deleteMarineCenterUseExprInqire(
    	   //@RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamMarineCenterUseExprInqireDetailVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        if( EgovStringUtil.isEmpty(gamMarineCenterUseExprInqireVO.getPrmisnYn()) || gamMarineCenterUseExprInqireVO.getPrmisnYn().equals("N") ) { //허가여부가 'N'이면 삭제가능
        	...
        	/*
        	resultLevReqestCnt = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireLevReqestCnt(gamMarineCenterUseExprInqireVO); //징수의뢰 정보 카운트
        	
        	if( gamMarineCenterUseExprInqireVO.getPrmisnYn().equals("Y") && resultLevReqestCnt == 0 ) { //허가여부가 Y이고 징수의뢰테이블에 정보가 없으면 삭제가능
            	deleteFlag = "Y";
            }
            */
        	deleteFlag = "N";
    	...
    	if("Y".equals(deleteFlag)) {
	        gamMarineCenterUseExprInqireService.deleteMarineCenterUseExprInqire(gamMarineCenterUseExprInqireVO);
     ...
     * 마린센터임대 상세를 등록한다.
     * @param String
     * @param gamMarineCenterUseExprInqireDetailVO
     * @param bindingResult
     * @return map
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamInsertMarineCenterUseExprInqireDetail.do") 
    public @ResponseBody Map insertMarineCenterUseExprInqireDetail(
    	   @RequestParam("detailCmd") String detailCmd, 
    	   @ModelAttribute("gamMarineCenterUseExprInqireDetailVO") GamMarineCenterUseExprInqireDetailVO gamMarineCenterUseExprInqireDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        */
        ...
        GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO = new GamMarineCenterUseExprInqireVO();
        gamMarineCenterUseExprInqireVO.setPrtAtCode(gamMarineCenterUseExprInqireDetailVO.getDetailPrtAtCode());
        gamMarineCenterUseExprInqireVO.setMngYear(gamMarineCenterUseExprInqireDetailVO.getDetailMngYear());
        gamMarineCenterUseExprInqireVO.setMngNo(gamMarineCenterUseExprInqireDetailVO.getDetailMngNo());
        gamMarineCenterUseExprInqireVO.setMngCnt(gamMarineCenterUseExprInqireDetailVO.getDetailMngCnt());
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamUpdateMarineCenterUseExprInqireDetail.do") 
    public @ResponseBody Map updateMarineCenterUseExprInqireDetail(
    	   @RequestParam("detailCmd") String detailCmd, 
    	   @ModelAttribute("gamMarineCenterUseExprInqireDetailVO") GamMarineCenterUseExprInqireDetailVO gamMarineCenterUseExprInqireDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
    	...
    	*/
    	...
    	log.debug("######################################## gamMarineCenterUseExprInqireVO.getDetailPrtAtCode() => " + gamMarineCenterUseExprInqireDetailVO.getDetailPrtAtCode());
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamDeleteMarineCenterUseExprInqireDetail.do") 
    public @ResponseBody Map deleteMarineCenterUseExprInqireDetail(
    	   @ModelAttribute("gamMarineCenterUseExprInqireDetailVO") GamMarineCenterUseExprInqireDetailVO gamMarineCenterUseExprInqireDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        */
    	...
    	gamMarineCenterUseExprInqireService.deleteMarineCenterUseExprInqireDetail2(gamMarineCenterUseExprInqireDetailVO);
     ...
     * 승낙 팝업화면을 로딩한다. 
     *
     * @param gamMarineCenterUseExprInqireLevReqestVO
     * @param model the model
     * @return "/ygpa/gam/oper/center/GamPopupMarineCenterUseExprInqirePrmisn"
     * @throws Exception the exception  
     */
	@RequestMapping(value="/oper/center/popup/showMarineCenterUseExprInqirePrmisn.do") 
    String showEntrpsInfo(GamMarineCenterUseExprInqireLevReqestVO gamMarineCenterUseExprInqireLevReqestVO, ModelMap model) throws Exception {
		...
		model.addAttribute("gamMarineCenterUseExprInqireInfo", gamMarineCenterUseExprInqireLevReqestVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamInsertMarineCenterUseExprInqirePrmisn.do") 
    public @ResponseBody Map insertMarineCenterUseExprInqireLevReqest(
    	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        //징수의뢰 테이블에 갯수 카운트 조회
        int levReqestCnt = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireLevReqestCnt(gamMarineCenterUseExprInqireVO);
        ...
        GamMarineCenterUseExprInqireLevReqestVO levReqestInfo = new GamMarineCenterUseExprInqireLevReqestVO();
		...
		levReqestInfo.setChrgeKnd( gamMarineCenterUseExprInqireVO.getChrgeKnd() );
		levReqestInfo.setVatYn( gamMarineCenterUseExprInqireVO.getVatYn() );
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamUpdateMarineCenterUseExprInqirePrmisnCancel.do") 
    public @ResponseBody Map updateMarineCenterUseExprInqirePrmisnCancel(
     	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
     	   BindingResult bindingResult)
            throws Exception {
     ...
     */
	@SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/oper/center/gamSelectMarineCenterUseExprInqireFileList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectMarineCenterUseExprInqireFileList(GamMarineCenterUseExprInqireVO searchVO) throws Exception {
		...
		//마린센터임대목록
    	totalCnt = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireFileListTotCnt(searchVO);
    	List assetFileList = gamMarineCenterUseExprInqireService.selectMarineCenterUseExprInqireFileList(searchVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/center/gamUpdateMarineCenterUseExprInqireComment.do") 
    public @ResponseBody Map updateMarineCenterUseExprInqireComment(
    	   @ModelAttribute("gamMarineCenterUseExprInqireVO") GamMarineCenterUseExprInqireVO gamMarineCenterUseExprInqireVO, 
    	   BindingResult bindingResult)
           throws Exception {
    	...
    	*/
        if( gamMarineCenterUseExprInqireVO.getMngYear() == null || "".equals(gamMarineCenterUseExprInqireVO.getMngYear()) ) {
        	updateFlag = "N";
        } else {
        	updateFlag = "Y";
        }
