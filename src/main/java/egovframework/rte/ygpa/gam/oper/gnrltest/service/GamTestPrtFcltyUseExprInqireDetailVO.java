...
/**
 * @Class Name : GamTestPrtFcltyUseExprInqireDetailVO.java
 * @Description : 항만시설사용만기도래자료조회(상세) VO class
 ...
 */
public class GamTestPrtFcltyUseExprInqireDetailVO extends ComDefaultVO {
