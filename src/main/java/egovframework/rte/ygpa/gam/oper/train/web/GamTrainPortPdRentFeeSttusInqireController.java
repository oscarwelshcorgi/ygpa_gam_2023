...
public class GamTrainPortPdRentFeeSttusInqireController {
	...
	@ResponseBody Map selectTrainPortPdRentFeeSttusInqireList(GamTrainPortPdRentFeeSttusInqireVO searchVO) throws Exception {
		...
		//목록
		totalCnt = gamTrainPortPdRentFeeSttusInqireService.selectTrainPortPdRentFeeSttusInqireListTotCnt(searchVO);
    	List resultList = gamTrainPortPdRentFeeSttusInqireService.selectTrainPortPdRentFeeSttusInqireList(searchVO);
    	
    	//사용료합계, 감면사용료합계 
    	GamTrainPortPdRentFeeSttusInqireVO resultSum = gamTrainPortPdRentFeeSttusInqireService.selectTrainPortPdRentFeeSttusInqireSum(searchVO);
