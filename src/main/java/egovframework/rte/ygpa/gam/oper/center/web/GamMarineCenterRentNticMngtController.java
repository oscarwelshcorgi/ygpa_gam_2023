...
public class GamMarineCenterRentNticMngtController {
    ...
    @RequestMapping(value="/oper/center/gamSelectMarineCenterRentNticMngtList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectMarineCenterRentNticMngtList(GamMarineCenterRentNticMngtVO searchVO) throws Exception {
