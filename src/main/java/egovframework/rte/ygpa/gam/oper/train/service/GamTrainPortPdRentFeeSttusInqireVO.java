...
/**
 * @Class Name : GamTrainPortPdRentFeeSttusInqireVO.java
 * @Description : 철송장임대기간별사용료현황조회 VO class
 ...
 */
public class GamTrainPortPdRentFeeSttusInqireVO extends ComDefaultVO {
