...
/**
 * @Class Name : GamTrainPortRentfeeInqireController.java
 ...
 */
@Controller
public class GamTrainPortRentfeeInqireController {
	...
	*/
    ...
    @Resource(name = "gamTrainPortRentfeeInqireService")
    private GamTrainPortRentfeeInqireService gamTrainPortRentfeeInqireService;
	 ...
	 * @exception Exception
	 */
    @RequestMapping(value="/oper/train/gamTrainPortRentfeeInqire.do")
    String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	...
    	return "/ygpa/gam/oper/train/GamTrainPortRentfeeInqire";
    }
    ...
    @RequestMapping(value="/oper/train/selectGamTrainPortRentfeeInqire.do", method=RequestMethod.POST)
    @ResponseBody Map selectGamTrainPortRentfeeInqireList(GamTrainPortRentfeeInqireVO searchVO) throws Exception {
    	...
    	totalCnt = gamTrainPortRentfeeInqireService.selectGamTrainPortRentfeeInqireListTotCnt(searchVO);
    	List resultList = gamTrainPortRentfeeInqireService.selectGamTrainPortRentfeeInqireList(searchVO);
    	
    	// 배후단지임대료관리 정보
    	GamTrainPortRentfeeInqireVO resultInfo = gamTrainPortRentfeeInqireService.selectGamTrainPortRentfeeInqireInfo(searchVO);
