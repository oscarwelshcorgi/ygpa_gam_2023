...
/**
 * @Class Name : GamMarineCenterRentSttusInqireDetailVO.java
 * @Description : 마린센터임대현황조회 상세 VO class
 ...
 */
public class GamMarineCenterRentSttusInqireDetailVO extends ComDefaultVO {
