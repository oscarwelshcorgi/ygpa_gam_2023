...
public class GamTrainPortRentSttusInqireController {
    ...
    @RequestMapping(value="/oper/train/selectTrainPortRentSttusInqireList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectTrainPortRentSttusInqireList(GamTrainPortRentSttusInqireVO searchVO) throws Exception {
     ...
     */
	@SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/oper/train/selectTrainPortRentSttusInqireDetailList.do", method=RequestMethod.POST)
