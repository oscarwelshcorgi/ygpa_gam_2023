...
public class GamTrainPortNticArrvlDtaInqireServiceImpl  extends AbstractServiceImpl implements GamTrainPortNticArrvlDtaInqireService {
    ...
    /**
	 * 철송장임대고지도래 최초 신청을 등록한다.
	 * @param vo GamTrainPortNticArrvlDtaInqireVO
	 * @exception Exception
	 */
	public void insertTrainPortNticArrvlDtaInqireFirst(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqireMaxNo(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireMaxNo(searchVO);
    }

    /**
	 * 철송장임대고지도래 연장 신청을 등록한다.
	 * @param vo GamTrainPortNticArrvlDtaInqireVO
	 * @exception Exception
	 */
	public void insertTrainPortNticArrvlDtaInqireRenew(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//철송장임대 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireRenew(vo); 
		
		//철송장임대상세정보 조회
		List detailList = gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireDetailInfo(vo);
		
		GamTrainPortNticArrvlDtaInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamTrainPortNticArrvlDtaInqireDetailVO();
			resultVo = (GamTrainPortNticArrvlDtaInqireDetailVO)detailList.get(i);
			...
			//철송장임대상세 복사등록
			gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireDetailRenew(resultVo); 
		}
		
		GamTrainPortNticArrvlDtaInqireVO updRentVO = new GamTrainPortNticArrvlDtaInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void updateTrainPortNticArrvlDtaInqire(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqire(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteTrainPortNticArrvlDtaInqire(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {

		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqirePhoto(vo); //철송장임대 사진정보 삭제

		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqireDetail(vo); //철송장임대 상세정보 삭제

		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqire(vo); // 철송장임대정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deleteTrainPortNticArrvlDtaInqireDetail(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertTrainPortNticArrvlDtaInqireDetail(GamTrainPortNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateTrainPortNticArrvlDtaInqireDetail(GamTrainPortNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteTrainPortNticArrvlDtaInqireDetail2(GamTrainPortNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqireDetail2(vo);
	}
    ...
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqirePrmisnInfo(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqirePrmisnInfo(searchVO);
    }
	 ...
	 * @exception Exception
	 */
	public void updateTrainPortNticArrvlDtaInqirePrmisn(GamTrainPortNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamTrainPortNticArrvlDtaInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireLevReqest(vo);
		    }
			
		}

		//철송장임대 허가여부를 수정
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateTrainPortNticArrvlDtaInqirePrmisnCancel(GamTrainPortNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqirePrmisnCancel(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertTrainPortNticArrvlDtaInqireFile(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.insertTrainPortNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateTrainPortNticArrvlDtaInqireFile(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteTrainPortNticArrvlDtaInqirePhotoSingle(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.deleteTrainPortNticArrvlDtaInqirePhotoSingle(vo);
	}
    ...
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqireMaxKey(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireMaxKey(searchVO);
    }
	...
	public void updateTrainPortNticArrvlDtaInqireComment(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireComment(vo);
	}
    ...
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqireRenewInfo(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireRenewInfo(searchVO);
    }
	...
	public void updateTrainPortNticArrvlDtaInqireRenewInfo(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireRenewInfo(vo);
	}
    ...
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqireCurrRenewInfo(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireCurrRenewInfo(searchVO);
    }
    ...
    public GamTrainPortNticArrvlDtaInqireVO selectTrainPortNticArrvlDtaInqireDetailQuaycd(GamTrainPortNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamTrainPortNticArrvlDtaInqireDao.selectTrainPortNticArrvlDtaInqireDetailQuaycd(searchVO);
    }
	...
	public void updateTrainPortNticArrvlDtaInqireQuaycd(GamTrainPortNticArrvlDtaInqireVO vo) throws Exception {
		gamTrainPortNticArrvlDtaInqireDao.updateTrainPortNticArrvlDtaInqireQuaycd(vo);
	}
