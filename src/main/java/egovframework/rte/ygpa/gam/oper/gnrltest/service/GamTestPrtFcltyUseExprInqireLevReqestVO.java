...
/**
 * @Class Name : GamTestPrtFcltyUseExprInqireLevReqestVO.java
 * @Description : 항만시설사용만기도래자료조회(징수의뢰) VO class
 ...
 */
public class GamTestPrtFcltyUseExprInqireLevReqestVO extends ComDefaultVO {
