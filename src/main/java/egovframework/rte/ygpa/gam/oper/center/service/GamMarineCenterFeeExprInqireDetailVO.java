...
/**
 * @Class Name : GamAssetUseExprInqireDetailVO.java
 * @Description : 마린센터임대고지도래자료조회(상세) VO class
 ...
 */
public class GamMarineCenterFeeExprInqireDetailVO extends ComDefaultVO {
