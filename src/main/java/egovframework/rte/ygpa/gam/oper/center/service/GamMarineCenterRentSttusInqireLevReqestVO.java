...
/**
 * @Class Name : GamMarineCenterRentSttusInqireLevReqestVO.java
 * @Description : 마린센터임대현황조회(징수의뢰) VO class
 ...
 */
public class GamMarineCenterRentSttusInqireLevReqestVO extends ComDefaultVO {
