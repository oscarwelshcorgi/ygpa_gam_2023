...
public class GamPrtFcltyNticArrvlDtaInqireServiceImpl  extends AbstractServiceImpl implements GamPrtFcltyNticArrvlDtaInqireService {
	 ...
	 * @exception Exception
	 */
	public void insertPrtFcltyNticArrvlDtaInqireFirst(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
    public GamPrtFcltyNticArrvlDtaInqireVO selectPrtFcltyNticArrvlDtaInqireMaxNo(GamPrtFcltyNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireMaxNo(searchVO);
    }
	 ...
	 * @exception Exception
	 */
	public void insertPrtFcltyNticArrvlDtaInqireRenew(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//항만시설사용 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireRenew(vo); 
		
		//항만시설사용상세정보 조회
		List detailList = gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireDetailInfo(vo);
		
		GamPrtFcltyNticArrvlDtaInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamPrtFcltyNticArrvlDtaInqireDetailVO();
			resultVo = (GamPrtFcltyNticArrvlDtaInqireDetailVO)detailList.get(i);
			...
			//항만시설사용상세 복사등록
			gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireDetailRenew(resultVo); 
		}
		
		GamPrtFcltyNticArrvlDtaInqireVO updRentVO = new GamPrtFcltyNticArrvlDtaInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void updatePrtFcltyNticArrvlDtaInqire(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqire(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deletePrtFcltyNticArrvlDtaInqire(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {

		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqirePhoto(vo); //항만시설사용 사진정보 삭제

		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqireDetail(vo); //항만시설사용 상세정보 삭제

		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqire(vo); // 항만시설사용정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deletePrtFcltyNticArrvlDtaInqireDetail(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertPrtFcltyNticArrvlDtaInqireDetail(GamPrtFcltyNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updatePrtFcltyNticArrvlDtaInqireDetail(GamPrtFcltyNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deletePrtFcltyNticArrvlDtaInqireDetail2(GamPrtFcltyNticArrvlDtaInqireDetailVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqireDetail2(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updatePrtFcltyNticArrvlDtaInqirePrmisn(GamPrtFcltyNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamPrtFcltyNticArrvlDtaInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireLevReqest(vo);
		    }
			
		}

		//항만시설사용 허가여부를 수정
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updatePrtFcltyNticArrvlDtaInqirePrmisnCancel(GamPrtFcltyNticArrvlDtaInqireLevReqestVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqirePrmisnCancel(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertPrtFcltyNticArrvlDtaInqireFile(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.insertPrtFcltyNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updatePrtFcltyNticArrvlDtaInqireFile(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deletePrtFcltyNticArrvlDtaInqirePhotoSingle(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.deletePrtFcltyNticArrvlDtaInqirePhotoSingle(vo);
	}
    ...
    public GamPrtFcltyNticArrvlDtaInqireVO selectPrtFcltyNticArrvlDtaInqireMaxKey(GamPrtFcltyNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireMaxKey(searchVO);
    }
	...
	public void updatePrtFcltyNticArrvlDtaInqireComment(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireComment(vo);
	}
    ...
    public GamPrtFcltyNticArrvlDtaInqireVO selectPrtFcltyNticArrvlDtaInqireRenewInfo(GamPrtFcltyNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireRenewInfo(searchVO);
    }
	...
	public void updatePrtFcltyNticArrvlDtaInqireRenewInfo(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireRenewInfo(vo);
	}
    ...
    public GamPrtFcltyNticArrvlDtaInqireVO selectPrtFcltyNticArrvlDtaInqireCurrRenewInfo(GamPrtFcltyNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireCurrRenewInfo(searchVO);
    }
    ...
    public GamPrtFcltyNticArrvlDtaInqireVO selectPrtFcltyNticArrvlDtaInqireDetailQuaycd(GamPrtFcltyNticArrvlDtaInqireVO searchVO) throws Exception {
        return gamPrtFcltyNticArrvlDtaInqireDao.selectPrtFcltyNticArrvlDtaInqireDetailQuaycd(searchVO);
    }
	...
	public void updatePrtFcltyNticArrvlDtaInqireQuaycd(GamPrtFcltyNticArrvlDtaInqireVO vo) throws Exception {
		gamPrtFcltyNticArrvlDtaInqireDao.updatePrtFcltyNticArrvlDtaInqireQuaycd(vo);
	}
