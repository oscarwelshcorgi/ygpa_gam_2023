...
/**
 * @Class Name : GamHtldEntrpsRentFeeSttusInqireVO.java
 * @Description : 배후단지임대업체별사용료현황조회 VO class
 ...
 */
public class GamHtldEntrpsRentFeeSttusInqireVO extends ComDefaultVO {
