...
/**
 * @Class Name : GamMarineCenterRentStairStsReportVO.java
 * @Description : 마린센터층별사용료현황조회 VO class
 ...
 */
public class GamMarineCenterRentStairStsReportVO extends ComDefaultVO {
    ...
    /** 감면사용료 합계 */
    private String sumTotalRdcxptFeeSum;
	...
	/**
	 * @return the sumTotalRdcxptFeeSum
	 */
	public String getSumTotalRdcxptFeeSum() {
		return sumTotalRdcxptFeeSum;
	}

	/**
	 * @param sumTotalRdcxptFeeSum the sumTotalRdcxptFeeSum to set
	 */
	public void setSumTotalRdcxptFeeSum(String sumTotalRdcxptFeeSum) {
		this.sumTotalRdcxptFeeSum = sumTotalRdcxptFeeSum;
	}
