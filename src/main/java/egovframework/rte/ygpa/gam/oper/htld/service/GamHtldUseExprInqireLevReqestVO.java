...
/**
 * @Class Name : GamHtldUseExprInqireLevReqestVO.java
 * @Description : 배후단지임대만기도래자료조회(징수의뢰) VO class
 ...
 */
public class GamHtldUseExprInqireLevReqestVO extends ComDefaultVO {
