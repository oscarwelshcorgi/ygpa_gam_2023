...
/**
 * @Class Name : GamHtldNticArrvlDtaInqireLevReqestVO.java
 * @Description : 배후단지임대고지도래현황조회 VO class
 ...
 */
public class GamHtldNticArrvlDtaInqireLevReqestVO extends ComDefaultVO {
