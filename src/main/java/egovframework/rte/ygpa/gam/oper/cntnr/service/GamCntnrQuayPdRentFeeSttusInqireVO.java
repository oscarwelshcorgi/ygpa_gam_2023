...
/**
 * @Class Name : GamCntnrQuayPdRentFeeSttusInqireVO.java
 * @Description : 컨테이너부두임대기간별사용료현황조회 VO class
 ...
 */
public class GamCntnrQuayPdRentFeeSttusInqireVO extends ComDefaultVO {
