...
/**
 * @Class Name : GamTrainPortRentMngtLevReqestVO.java
 * @Description : 철송장사용목록관리 징수의뢰 VO class
 ...
 */
public class GamTrainPortRentMngtLevReqestVO extends ErpCmmnCdDefaultVO {
