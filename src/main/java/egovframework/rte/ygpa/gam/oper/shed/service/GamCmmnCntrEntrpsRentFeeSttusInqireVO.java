...
/**
 * @Class Name : GamCmmnCntrEntrpsRentFeeSttusInqireVO.java
 * @Description : 공컨장치장임대업체별사용료현황조회 VO class
 ...
 */
public class GamCmmnCntrEntrpsRentFeeSttusInqireVO extends ComDefaultVO {
