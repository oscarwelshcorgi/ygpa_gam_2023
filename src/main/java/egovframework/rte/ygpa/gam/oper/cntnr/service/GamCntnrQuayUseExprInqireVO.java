...
/**
 * @Class Name : GamCntnrQuayUseExprInqireVO.java
 * @Description : 컨테이너부두임대만기도래자료조회(컨테이너부두임대) VO class
 ...
 */
public class GamCntnrQuayUseExprInqireVO extends ComDefaultVO {
