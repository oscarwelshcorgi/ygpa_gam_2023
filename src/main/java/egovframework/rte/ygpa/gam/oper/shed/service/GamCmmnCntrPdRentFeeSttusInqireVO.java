...
/**
 * @Class Name : GamCmmnCntrPdRentFeeSttusInqireVO.java
 * @Description : 공컨장치장임대기간별사용료현황조회 VO class
 ...
 */
public class GamCmmnCntrPdRentFeeSttusInqireVO extends ComDefaultVO {
