...
/**
 * @Class Name : GamTestPrtFcltyRentFeePaySttusMngtVO.java
 * @Description : 항만시설납부현황관리 VO class
...
public class GamTestPrtFcltyRentFeePaySttusMngtVO extends ComDefaultVO {
