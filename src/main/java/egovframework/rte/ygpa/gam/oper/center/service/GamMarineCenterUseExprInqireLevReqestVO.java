...
/**
 * @Class Name : GamMarineCenterUseExprInqireLevReqestVO.java
 * @Description : 마린센터임대만기도래자료조회(징수의뢰) VO class
 ...
 */
public class GamMarineCenterUseExprInqireLevReqestVO extends ComDefaultVO {
