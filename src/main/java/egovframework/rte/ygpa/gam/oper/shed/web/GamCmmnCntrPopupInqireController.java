...
/**
 * @Class Name : GamCmmnCntrPopupInqireController.java
 ...
 */
@Controller
public class GamCmmnCntrPopupInqireController {
    ...
    @Resource(name = "gamCmmnCntrPopupInqireService")
    private GamCmmnCntrPopupInqireService gamCmmnCntrPopupInqireService;
	
    
    /**
     * 공컨장치장 정보현황알림 화면을 로딩한다. 
     *
     * @param windowId
     ...
     */
	@RequestMapping(value="/oper/shed/gamCmmnCntrPopupInqire.do")
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
		...
		GamAssetPopupInqireVO resultMap = gamCmmnCntrPopupInqireService.selectCmmnCntrPopupInqire(gamAssetPopupInqireVO);
    	...
    	return "/ygpa/gam/oper/shed/GamCmmnCntrPopupInqire"; 
    }
