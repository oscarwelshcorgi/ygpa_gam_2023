 ...
 */
@Controller
public class GamTrainPortPopupInqireController {
    ...
    @Resource(name = "gamTrainPortPopupInqireService")
    private GamTrainPortPopupInqireService gamTrainPortPopupInqireService;
     ...
     */
	@RequestMapping(value="/oper/train/gamTrainPortPopupInqire.do")
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
		...
		GamAssetPopupInqireVO resultMap = gamTrainPortPopupInqireService.selectTrainPortPopupInqire(gamAssetPopupInqireVO);
    	...
    	return "/ygpa/gam/oper/train/GamTrainPortPopupInqire"; 
    }
