...
/**
 * @Class Name : GamMarineCenterRentArStsReportVO.java
 * @Description : 마린센터면적별사용료현황조회 VO class
 ...
 */
public class GamMarineCenterRentArStsReportVO extends ComDefaultVO {
    ...
    private String totSumRocxptFee;
	...
	/**
	 * @return the totSumRocxptFee
	 */
	public String getTotSumRocxptFee() {
		return totSumRocxptFee;
	}

	/**
	 * @param totSumRocxptFee the totSumRocxptFee to set
	 */
	public void setTotSumRocxptFee(String totSumRocxptFee) {
		this.totSumRocxptFee = totSumRocxptFee;
	}
