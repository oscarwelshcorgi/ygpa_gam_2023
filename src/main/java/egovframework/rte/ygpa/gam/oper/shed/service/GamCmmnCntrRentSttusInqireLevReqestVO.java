...
/**
 * @Class Name : GamCmmnCntrRentSttusInqireLevReqestVO.java
 * @Description : 공컨장치장임대현황조회(징수의뢰) VO class
 ...
 */
public class GamCmmnCntrRentSttusInqireLevReqestVO extends ComDefaultVO {
