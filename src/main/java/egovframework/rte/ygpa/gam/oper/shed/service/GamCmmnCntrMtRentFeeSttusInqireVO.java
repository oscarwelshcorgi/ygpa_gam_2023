...
/**
 * @Class Name : GamCmmnCntrMtRentFeeSttusInqireVO.java
 * @Description : 공컨장치장임대월별사용료현황조회 VO class
 ...
 */
public class GamCmmnCntrMtRentFeeSttusInqireVO extends ComDefaultVO {
