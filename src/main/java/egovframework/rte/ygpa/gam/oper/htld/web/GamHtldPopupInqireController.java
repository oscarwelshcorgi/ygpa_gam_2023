...
/**
 * @Class Name : GamHtldPopupInqireController.java
 ...
 */
@Controller
public class GamHtldPopupInqireController {
    ...
    @Resource(name = "gamHtldPopupInqireService")
    private GamHtldPopupInqireService gamHtldPopupInqireService;
	
    
    /**
     * 배후단지  정보현황알림 화면을 로딩한다. 
     *
     * @param windowId
     ...
     */
	@RequestMapping(value="/oper/htld/gamHtldPopupInqire.do")
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
		...
		GamAssetPopupInqireVO resultMap = gamHtldPopupInqireService.selectHtldPopupInqire(gamAssetPopupInqireVO);
    	...
    	return "/ygpa/gam/oper/htld/GamHtldPopupInqire"; 
    }
