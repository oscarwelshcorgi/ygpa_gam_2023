...
/**
 * @Class Name : GamMarineCenterRentCmpyStsReportVO.java
 * @Description : 마린센터업체별사용료현황조회 VO class
 ...
 */
public class GamMarineCenterRentCmpyStsReportVO extends ComDefaultVO {
