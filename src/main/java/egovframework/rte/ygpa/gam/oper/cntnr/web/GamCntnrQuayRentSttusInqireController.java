...
public class GamCntnrQuayRentSttusInqireController {
	...
	*/
    ...
    @RequestMapping(value="/oper/cntnr/selectGamCntnrQuayRentSttusInqire.do", method=RequestMethod.POST)
    @ResponseBody Map selectGamCntnrQuayRentSttusInqireList(GamCntnrQuayRentSttusInqireVO searchVO) throws Exception {
    	...
    	totalCnt = gamCntnrQuayRentSttusInqireService.selectGamCntnrQuayRentSttusInqireListTotCnt(searchVO);
    	List resultList = gamCntnrQuayRentSttusInqireService.selectGamCntnrQuayRentSttusInqireList(searchVO);
    	
    	// 배후단지임대현황 정보
    	GamCntnrQuayRentSttusInqireVO resultInfo = gamCntnrQuayRentSttusInqireService.selectGamCntnrQuayRentSttusInqireInfo(searchVO);
