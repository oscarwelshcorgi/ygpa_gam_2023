...
/**
 * @Class Name : GamMarineCenterPdRentfeeSttusInqireVO.java
 * @Description : 마린센터기간별사용료현황조회 VO class
 ...
 */
public class GamMarineCenterPdRentfeeSttusInqireVO extends ComDefaultVO {
