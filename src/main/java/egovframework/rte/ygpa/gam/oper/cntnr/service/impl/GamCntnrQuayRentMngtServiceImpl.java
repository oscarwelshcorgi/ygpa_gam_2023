...
public class GamCntnrQuayRentMngtServiceImpl extends AbstractServiceImpl implements GamCntnrQuayRentMngtService {
	 ...
	 * @exception Exception
	 */
	public void updateCntnrQuayRentMngtPrmisn(GamCntnrQuayRentMngtLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamCntnrQuayRentMngtDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamCntnrQuayRentMngtDao.insertCntnrQuayRentMngtLevReqest(vo);
		    }
			
		}

		//컨테이너부두임대 허가여부를 수정
		gamCntnrQuayRentMngtDao.updateCntnrQuayRentMngtPrmisn(vo);
	}
