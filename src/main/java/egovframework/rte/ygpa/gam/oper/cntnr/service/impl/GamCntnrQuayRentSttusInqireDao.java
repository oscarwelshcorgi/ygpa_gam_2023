...
public class GamCntnrQuayRentSttusInqireDao extends EgovAbstractDAO {
	 ...
	 * @exception Exception
	 */
	public List selectGamCntnrQuayRentSttusInqireList(GamCntnrQuayRentSttusInqireVO searchVO) {
		 return list("gamCntnrQuayRentSttusInqireDao.selectGamCntnrQuayRentSttusInqireList_D", searchVO);
	}
	...
	public int selectGamCntnrQuayRentSttusInqireListTotCnt(GamCntnrQuayRentSttusInqireVO searchVO) {
		return  (Integer)getSqlMapClientTemplate().queryForObject("gamCntnrQuayRentSttusInqireDao.selectGamCntnrQuayRentSttusInqireListTotCnt_S", searchVO);
	}
	...
	public GamCntnrQuayRentSttusInqireVO selectGamCntnrQuayRentSttusInqireInfo(GamCntnrQuayRentSttusInqireVO searchVO) throws Exception {
		return (GamCntnrQuayRentSttusInqireVO) selectByPk("gamCntnrQuayRentSttusInqireDao.selectGamCntnrQuayRentSttusInqireInfo_S", searchVO);
	}
}
