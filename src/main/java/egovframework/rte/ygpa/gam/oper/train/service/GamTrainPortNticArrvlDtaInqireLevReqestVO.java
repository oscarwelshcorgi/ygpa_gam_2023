...
/**
 * @Class Name : GamTrainPortNticArrvlDtaInqireLevReqestVO.java
 * @Description : 철송장임대고지도래현황조회 VO class
 ...
 */
public class GamTrainPortNticArrvlDtaInqireLevReqestVO extends ComDefaultVO {
