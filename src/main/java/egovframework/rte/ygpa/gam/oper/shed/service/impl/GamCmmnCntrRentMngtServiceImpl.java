...
public class GamCmmnCntrRentMngtServiceImpl extends AbstractServiceImpl implements GamCmmnCntrRentMngtService {
	...
	public void insertCmmnCntrRentMngtRenew(GamCmmnCntrRentMngtVO vo) throws Exception {
		gamCmmnCntrRentMngtDao.insertCmmnCntrRentMngtRenew(vo); //공컨장치장 복사등록
		
		//공컨장치장 복사등록된  MngCnt의 max값을 가져온다.
		...
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			...
			gamCmmnCntrRentMngtDao.insertCmmnCntrRentMngtDetailRenew(resultVo); //공컨장치장상세 복사등록
		}
	}
	...
	public void deleteCmmnCntrRentMngt(GamCmmnCntrRentMngtVO vo) throws Exception {
		...
		gamCmmnCntrRentMngtDao.deleteCmmnCntrRentMngtPhoto(vo); //자산임대 사진정보 삭제
		
		gamCmmnCntrRentMngtDao.deleteCmmnCntrRentMngtDetail(vo); //자산임대 상세정보 삭제
		
		gamCmmnCntrRentMngtDao.deleteCmmnCntrRentMngt(vo); // 자산임대정보 삭제
	}
