...
/**
 * @Class Name : GamTrainPortEntrpsRentFeeSttusInqireVO.java
 * @Description : 철송장임대업체별사용료현황조회 VO class
 ...
 */
public class GamTrainPortEntrpsRentFeeSttusInqireVO extends ComDefaultVO {
