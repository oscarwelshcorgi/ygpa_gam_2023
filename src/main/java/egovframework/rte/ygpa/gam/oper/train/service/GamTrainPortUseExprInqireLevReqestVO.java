...
/**
 * @Class Name : GamTrainPortUseExprInqireLevReqestVO.java
 * @Description : 철송장임대만기도래자료조회(징수의뢰) VO class
 ...
 */
public class GamTrainPortUseExprInqireLevReqestVO extends ComDefaultVO {
