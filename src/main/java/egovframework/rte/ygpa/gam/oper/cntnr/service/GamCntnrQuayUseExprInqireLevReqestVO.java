...
/**
 * @Class Name : GamCntnrQuayUseExprInqireLevReqestVO.java
 * @Description : 컨테이너부두임대만기도래자료조회(징수의뢰) VO class
 ...
 */
public class GamCntnrQuayUseExprInqireLevReqestVO extends ComDefaultVO {
