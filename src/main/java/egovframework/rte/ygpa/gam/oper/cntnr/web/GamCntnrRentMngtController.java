...
/**
 * @Class Name : GamCntnrRentMngtController.java
 ...
 */
@Controller
public class GamCntnrRentMngtController {
    ...
    @Resource(name = "gamCntnrRentMngtService")
    private GamCntnrRentMngtService gamCntnrRentMngtService;
	
    
    /**
     * 컨테이너부두사용목록관리 화면을 로딩한다. 
     *
     * @param windowId
     * @param model the model
     * @return "/ygpa/gam/oper/cntnr/GamCntnrRentMngt"
     * @throws Exception the exception  
     */
	@RequestMapping(value="/oper/cntnr/gamCntnrRentMngt.do")
    ...
    @RequestMapping(value="/oper/cntnr/selectCntnrRentMngtList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectCntnrRentMngtList(GamCntnrRentMngtVO searchVO) throws Exception {
		...
		//컨테이너부두사용목록
    	totalCnt = gamCntnrRentMngtService.selectCntnrRentMngtListTotCnt(searchVO);
    	List resultList = gamCntnrRentMngtService.selectCntnrRentMngtList(searchVO);
    	
    	//총면적, 총사용료
    	GamCntnrRentMngtVO resultSum = gamCntnrRentMngtService.selectCntnrRentMngtSum(searchVO);
     ...
     */
	@SuppressWarnings({ "rawtypes", "unchecked" })
    @RequestMapping(value="/oper/cntnr/selectCntnrRentMngtDetailList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectCntnrRentMngtDetailList(GamCntnrRentMngtVO searchVO) throws Exception {
		...
		// 컨테이너부두상세리스트 및 총건수
		totalCnt = gamCntnrRentMngtService.selectCntnrRentMngtDetailListTotCnt(searchVO);
		List resultList = gamCntnrRentMngtService.selectCntnrRentMngtDetailList(searchVO);
     ...
     * 컨테이너부두 최초신청을 등록한다.
     * @param String
     * @param gamCntnrRentMngtVO
     * @param bindingResult
     * @return map
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamInsertCntnrRentMngtFirst.do") 
    public @ResponseBody Map insertCntnrRentMngtFirst(
    	   @RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamCntnrRentMngtVO") GamCntnrRentMngtVO gamCntnrRentMngtVO, 
    	...
    	*/
        ...
        if("insert".equals(cmd)) {
	        beanValidator.validate(gamCntnrRentMngtVO, bindingResult);
			...
			//if(gamCntnrRentMngtVO.getProgrmDc()==null || progrmManageVO.getProgrmDc().equals("")){progrmManageVO.setProgrmDc(" ");}
	    	gamCntnrRentMngtService.insertCntnrRentMngtFirst(gamCntnrRentMngtVO);
        ...
        */
    	...
    	if("insert".equals(cmd)) {
	    	//확인후 변경혀라~~
	    	gamCntnrRentMngtVO.setReqstSeCd("1");   //신청구분코드   (1:최초, 2:연장, 3	:변경, 4	:취소) 이게 맞나?
	    	gamCntnrRentMngtVO.setRegUsr("admin1"); //등록자 (세션 로그인 아이디)
	    	gamCntnrRentMngtVO.setUpdUsr("admin1"); //등록자 (세션 로그인 아이디)
	    	//gamCntnrRentMngtVO.setDeptcd("A001");   //부서코드 (세션?) 
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamInsertCntnrRentMngtRenew.do") 
    public @ResponseBody Map insertCntnrRentMngtRenew(
    	   @ModelAttribute("gamCntnrRentMngtVO") GamCntnrRentMngtVO gamCntnrRentMngtVO,
   	       BindingResult bindingResult)
           throws Exception {
    	...
    	GamCntnrRentMngtVO resultVO = gamCntnrRentMngtService.selectCntnrRentMngtMaxNo(gamCntnrRentMngtVO);
    	
    	if( gamCntnrRentMngtVO.getMngCnt().equals(resultVO.getMaxMngCnt()) ) {
    		//키 같고 max관리번호가 같으면 연장신청 등록
        	
    		gamCntnrRentMngtService.insertCntnrRentMngtRenew(gamCntnrRentMngtVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamUpdateCntnrRentMngt.do") 
    public @ResponseBody Map updateCntnrRentMngtFirst(
    	   @RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamCntnrRentMngtVO") GamCntnrRentMngtVO gamCntnrRentMngtVO, 
    	   BindingResult bindingResult)
           throws Exception {
    	...
    	if("modify".equals(cmd)) {
	    	//확인후 변경혀라~~
	    	gamCntnrRentMngtVO.setReqstSeCd("3");   //신청구분코드   (1:최초, 2:연장, 3	:변경, 4	:취소) 이게 맞나?
	    	gamCntnrRentMngtVO.setUpdUsr("admin1"); //등록자 (세션 로그인 아이디)
	    	//gamCntnrRentMngtVO.setDeptcd("A001");   //부서코드 (세션?) 
	    	
	        gamCntnrRentMngtService.updateCntnrRentMngt(gamCntnrRentMngtVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamDeleteCntnrRentMngt.do") 
    public @ResponseBody Map deleteCntnrRentMngt(
    	   //@RequestParam("cmd") String cmd, 
    	   @ModelAttribute("gamCntnrRentMngtDetailVO") GamCntnrRentMngtVO gamCntnrRentMngtVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        if( gamCntnrRentMngtVO.getPrmisnYn().equals("N") ) { //허가여부가 'N'이면 삭제가능
        	deleteFlag = "Y";
        } else {
        	resultLevReqestCnt = gamCntnrRentMngtService.selectCntnrRentMngtLevReqestCnt(gamCntnrRentMngtVO); //징수의뢰 정보 카운트
        	
        	if( gamCntnrRentMngtVO.getPrmisnYn().equals("Y") && resultLevReqestCnt == 0 ) { //허가여부가 Y이고 징수의뢰테이블에 정보가 없으면 삭제가능
            	deleteFlag = "Y";
            }
        }
    	
    	if("Y".equals(deleteFlag)) {
	        gamCntnrRentMngtService.deleteCntnrRentMngt(gamCntnrRentMngtVO);
     ...
     * 컨테이너부두사용 상세를 등록한다.
     * @param String
     * @param gamCntnrRentMngtDetailVO
     * @param bindingResult
     * @return map
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamInsertCntnrRentMngtDetail.do") 
    public @ResponseBody Map insertCntnrRentMngtDetail(
    	   @RequestParam("detailCmd") String detailCmd, 
    	   @ModelAttribute("gamCntnrRentMngtDetailVO") GamCntnrRentMngtDetailVO gamCntnrRentMngtDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        */
        ...
        GamCntnrRentMngtVO gamCntnrRentMngtVO = new GamCntnrRentMngtVO();
        gamCntnrRentMngtVO.setPrtAtCode(gamCntnrRentMngtDetailVO.getDetailPrtAtCode());
        gamCntnrRentMngtVO.setMngYear(gamCntnrRentMngtDetailVO.getDetailMngYear());
        gamCntnrRentMngtVO.setMngNo(gamCntnrRentMngtDetailVO.getDetailMngNo());
        gamCntnrRentMngtVO.setMngCnt(gamCntnrRentMngtDetailVO.getDetailMngCnt());
        
        //임대정보 조회후 승낙여부 체크
        GamCntnrRentMngtVO rentPrmisnInfo = gamCntnrRentMngtService.selectCntnrRentMngtPrmisnInfo(gamCntnrRentMngtVO);
        ...
        if( EgovStringUtil.isEmpty(rentPrmisnInfo.getPrmisnYn()) || !rentPrmisnInfo.getPrmisnYn().equals("Y") ) { //임대정보가 승낙이 되지 않았을 경우에만 등록가능
        	if("insert".equals(detailCmd)) {
    	    	//확인후 변경혀라~~
    	    	gamCntnrRentMngtDetailVO.setRegUsr("admin1"); //등록자 (세션 로그인 아이디)
    	    	gamCntnrRentMngtDetailVO.setUpdUsr("admin1"); //등록자 (세션 로그인 아이디)
    	    	
    	        gamCntnrRentMngtService.insertCntnrRentMngtDetail(gamCntnrRentMngtDetailVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamUpdateCntnrRentMngtDetail.do") 
    public @ResponseBody Map updateCntnrRentMngtDetail(
    	   @RequestParam("detailCmd") String detailCmd, 
    	   @ModelAttribute("gamCntnrRentMngtDetailVO") GamCntnrRentMngtDetailVO gamCntnrRentMngtDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
    	...
    	*/
    	...
    	log.debug("######################################## gamCntnrRentMngtVO.getDetailPrtAtCode() => " + gamCntnrRentMngtDetailVO.getDetailPrtAtCode());
        ...
        */
        ...
        if( EgovStringUtil.isEmpty(rentPrmisnInfo.getPrmisnYn()) || !rentPrmisnInfo.getPrmisnYn().equals("Y") ) { //임대정보가 승낙이 되지 않았을 경우에만 수정가능
	    	if("modify".equals(detailCmd)) {
		        ...
		        gamCntnrRentMngtService.updateCntnrRentMngtDetail(gamCntnrRentMngtDetailVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamDeleteCntnrRentMngtDetail.do") 
    public @ResponseBody Map deleteCntnrRentMngtDetail(
    	   @ModelAttribute("gamCntnrRentMngtDetailVO") GamCntnrRentMngtDetailVO gamCntnrRentMngtDetailVO, 
    	   BindingResult bindingResult)
           throws Exception {
        ...
        */
    	...
    	gamCntnrRentMngtService.deleteCntnrRentMngtDetail2(gamCntnrRentMngtDetailVO);
     ...
     * 승낙 팝업화면을 로딩한다. 
     *
     * @param gamCntnrRentMngtLevReqestVO
     * @param model the model
     * @return "/ygpa/gam/oper/cntnr/GamPopupCntnrRentMngtPrmisn"
     * @throws Exception the exception  
     */
	@RequestMapping(value="/oper/cntnr/popup/showCntnrRentMngtPrmisn.do")
    String showEntrpsInfo(GamCntnrRentMngtLevReqestVO gamPrtFcltyRentLevReqestVO, ModelMap model) throws Exception {
		...
		model.addAttribute("gamCntnrRentMngtInfo", gamPrtFcltyRentLevReqestVO);
     ...
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/popup/gamInsertCntnrRentMngtPrmisn.do") 
    public @ResponseBody Map insertPrtFcltyRentLevReqest(
        ...
        //징수의뢰 테이블에 갯수 카운트 조회
        int levReqestCnt = gamCntnrRentMngtService.selectCntnrRentMngtLevReqestCnt(gamCntnrRentMngtVO);
        ...
        GamCntnrRentMngtLevReqestVO levReqestInfo = new GamCntnrRentMngtLevReqestVO();
		...
		levReqestInfo.setChrgeKnd( gamCntnrRentMngtVO.getChrgeKnd() );
		levReqestInfo.setVatYn( gamCntnrRentMngtVO.getVatYn() );
        ...
        gamCntnrRentMngtService.updateCntnrRentMngtPrmisn(levReqestInfo);
    ...
    /**
     * 컨테이너부두 승낙취소(허가취소)를 한다.
     * @param gamCntnrRentMngtVO
     * @param bindingResult
     * @return map
     * @throws Exception
     */
    @RequestMapping(value="/oper/cntnr/gamUpdateCntnrRentMngtPrmisnCancel.do") 
    public @ResponseBody Map updateCntnrRentMngtPrmisnCancel(
     	   @ModelAttribute("gamCntnrRentMngtVO") GamCntnrRentMngtVO gamCntnrRentMngtVO, 
     	   BindingResult bindingResult)
            throws Exception {
         ...
         gamCntnrRentMngtService.updateCntnrRentMngtPrmisnCancel(levReqestInfo);
