...
public class GamCntnrRentMngtController {
	...
	*/
    ...
    @RequestMapping(value="/oper/cntnr/selectGamCntnrRentMngt.do", method=RequestMethod.POST)
    @ResponseBody Map selectGamCntnrRentMngtList(GamCntnrRentMngtVO searchVO) throws Exception {
    	...
    	totalCnt = gamCntnrRentMngtService.selectGamCntnrRentMngtListTotCnt(searchVO);
    	List resultList = gamCntnrRentMngtService.selectGamCntnrRentMngtList(searchVO);
    	
    	// 배후단지임대 정보
    	GamCntnrRentMngtVO resultInfo = gamCntnrRentMngtService.selectGamCntnrRentMngtInfo(searchVO);
