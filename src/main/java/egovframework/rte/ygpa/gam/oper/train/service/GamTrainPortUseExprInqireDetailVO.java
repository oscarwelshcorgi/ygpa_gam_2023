...
/**
 * @Class Name : GamTrainPortUseExprInqireDetailVO.java
 * @Description : 철송장임대만기도래자료조회(상세) VO class
 ...
 */
public class GamTrainPortUseExprInqireDetailVO extends ComDefaultVO {
