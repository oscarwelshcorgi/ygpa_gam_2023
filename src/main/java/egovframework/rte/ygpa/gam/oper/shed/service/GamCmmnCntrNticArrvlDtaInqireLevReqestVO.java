...
/**
 * @Class Name : GamCmmnCntrNticArrvlDtaInqireLevReqestVO.java
 * @Description : 공컨장치장임대고지도래현황조회 VO class
 ...
 */
public class GamCmmnCntrNticArrvlDtaInqireLevReqestVO extends ComDefaultVO {
