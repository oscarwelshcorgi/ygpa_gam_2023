...
public class GamTrainPortEntrpsRentFeeSttusInqireController {
	...
	@ResponseBody Map selectTrainPortEntrpsRentFeeSttusInqireList(GamTrainPortEntrpsRentFeeSttusInqireVO searchVO) throws Exception {
		...
		//목록
		totalCnt = gamTrainPortEntrpsRentFeeSttusInqireService.selectTrainPortEntrpsRentFeeSttusInqireListTotCnt(searchVO);
    	List resultList = gamTrainPortEntrpsRentFeeSttusInqireService.selectTrainPortEntrpsRentFeeSttusInqireList(searchVO);
    	
    	//전체사용료합계
    	GamTrainPortEntrpsRentFeeSttusInqireVO resultSum = gamTrainPortEntrpsRentFeeSttusInqireService.selectTrainPortEntrpsRentFeeSttusInqireSum(searchVO);
