...
/**
 * @Class Name : GamCntnrRentFeePaySttusMngtController.java
 ...
 */
@Controller
public class GamCntnrRentFeePaySttusMngtController {
    ...
    @Resource(name = "gamCntnrRentFeePaySttusMngtService")
    private GamCntnrRentFeePaySttusMngtService gamCntnrRentFeePaySttusMngtService;
	
    
    /**
     * 컨테이너부두납부현황관리 화면을 로딩한다. 
     *
     * @param windowId
     * @param model the model
     * @return "/ygpa/gam/oper/cntnr/GamCntnrRentFeePaySttusMngt"
     * @throws Exception the exception  
     */
	@RequestMapping(value="/oper/cntnr/gamCntnrRentFeePaySttusMngt.do")
    ...
    @RequestMapping(value="/oper/cntnr/gamSelectCntnrRentFeePaySttusMngtList.do", method=RequestMethod.POST)
	public @ResponseBody Map selectCntnrRentFeePaySttusMngtList(GamCntnrRentFeePaySttusMngtVO searchVO) throws Exception {
		...
		//자산임대목록
    	totalCnt = gamCntnrRentFeePaySttusMngtService.selectCntnrRentFeePaySttusMngtListTotCnt(searchVO);
    	List resultList = gamCntnrRentFeePaySttusMngtService.selectCntnrRentFeePaySttusMngtList(searchVO);
    	
    	//자료수, 사용료, 부가세, 고지액
    	GamCntnrRentFeePaySttusMngtVO resultSum = gamCntnrRentFeePaySttusMngtService.selectCntnrRentFeePaySttusMngtSum(searchVO);
