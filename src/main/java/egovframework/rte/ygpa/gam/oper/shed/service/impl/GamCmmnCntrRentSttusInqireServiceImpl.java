...
public class GamCmmnCntrRentSttusInqireServiceImpl extends AbstractServiceImpl implements GamCmmnCntrRentSttusInqireService {
	 ...
	 * @exception Exception
	 */
	public void insertCmmnCntrRentSttusInqireFirst(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireFirst(vo);
	}
	 ...
	 * @exception Exception
	 */
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqireMaxNo(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireMaxNo(searchVO);
    }
	 ...
	 * @exception Exception
	 */
	public void insertCmmnCntrRentSttusInqireRenew(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		LoginVO loginVO = (LoginVO) EgovUserDetailsHelper.getAuthenticatedUser();
		
		//공컨장치장임대 복사등록된  MngCnt의 max값을 가져온다.
		String maxMngCnt = gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireMaxMngCnt(vo);
		...
		vo.setReqstSeCd("2");
		gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireRenew(vo); 
		
		//공컨장치장임대상세정보 조회
		List detailList = gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireDetailInfo(vo);
		
		GamCmmnCntrRentSttusInqireDetailVO resultVo = null;
		
		for( int i = 0 ; i < detailList.size() ; i++ ) {
			resultVo = new GamCmmnCntrRentSttusInqireDetailVO();
			resultVo = (GamCmmnCntrRentSttusInqireDetailVO)detailList.get(i);
			...
			//공컨장치장임대상세 복사등록
			gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireDetailRenew(resultVo); 
		}
		
		GamCmmnCntrRentSttusInqireVO updRentVO = new GamCmmnCntrRentSttusInqireVO();
		
		//총사용료, 총면적, 총사용기간 조회
		updRentVO = gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireRenewInfo(vo);
		...
		if( updRentVO != null ) {
			...
			gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireRenewInfo(updRentVO);
		}
	}
	 ...
	 * @exception Exception
	 */
	public void updateCmmnCntrRentSttusInqire(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqire(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCmmnCntrRentSttusInqire(GamCmmnCntrRentSttusInqireVO vo) throws Exception {

		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqirePhoto(vo); //공컨장치장임대 사진정보 삭제

		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqireDetail(vo); //공컨장치장임대 상세정보 삭제

		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqire(vo); // 공컨장치장임대정보 삭제
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCmmnCntrRentSttusInqireDetail(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertCmmnCntrRentSttusInqireDetail(GamCmmnCntrRentSttusInqireDetailVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCmmnCntrRentSttusInqireDetail(GamCmmnCntrRentSttusInqireDetailVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireDetail(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCmmnCntrRentSttusInqireDetail2(GamCmmnCntrRentSttusInqireDetailVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqireDetail2(vo);
	}
    ...
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqirePrmisnInfo(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqirePrmisnInfo(searchVO);
    }
	 ...
	 * @exception Exception
	 */
	public void updateCmmnCntrRentSttusInqirePrmisn(GamCmmnCntrRentSttusInqireLevReqestVO vo) throws Exception {
		...
		int monthCnt = gamCmmnCntrRentSttusInqireDao.selectUsagePdMonthCnt(vo);
		...
		for( int i = 0; i < startRetVal.length; i++ ) {
		    ...
		    if( dayCnt[i] > 0 ) {
				...
				//징수의뢰 insert
				gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireLevReqest(vo);
		    }
			
		}

		//공컨장치장임대 허가여부를 수정
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqirePrmisn(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCmmnCntrRentSttusInqirePrmisnCancel(GamCmmnCntrRentSttusInqireLevReqestVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqirePrmisnCancel(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void insertCmmnCntrRentSttusInqireFile(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.insertCmmnCntrRentSttusInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void updateCmmnCntrRentSttusInqireFile(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireFile(vo);
	}
	 ...
	 * @exception Exception
	 */
	public void deleteCmmnCntrRentSttusInqirePhotoSingle(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.deleteCmmnCntrRentSttusInqirePhotoSingle(vo);
	}
    ...
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqireMaxKey(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireMaxKey(searchVO);
    }
	...
	public void updateCmmnCntrRentSttusInqireComment(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireComment(vo);
	}
    ...
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqireRenewInfo(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireRenewInfo(searchVO);
    }
	...
	public void updateCmmnCntrRentSttusInqireRenewInfo(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireRenewInfo(vo);
	}
    ...
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqireCurrRenewInfo(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireCurrRenewInfo(searchVO);
    }
    ...
    public GamCmmnCntrRentSttusInqireVO selectCmmnCntrRentSttusInqireDetailQuaycd(GamCmmnCntrRentSttusInqireVO searchVO) throws Exception {
        return gamCmmnCntrRentSttusInqireDao.selectCmmnCntrRentSttusInqireDetailQuaycd(searchVO);
    }
	...
	public void updateCmmnCntrRentSttusInqireQuaycd(GamCmmnCntrRentSttusInqireVO vo) throws Exception {
		gamCmmnCntrRentSttusInqireDao.updateCmmnCntrRentSttusInqireQuaycd(vo);
	}
