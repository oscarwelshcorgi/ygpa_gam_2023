...
public interface GamCntnrQuayPdRentFeeSttusInqireService {
	 ...
	 * @exception Exception
	 */
    int selectCntnrQuayPdRentFeeSttusInqireListTotCnt(GamCntnrQuayPdRentFeeSttusInqireVO searchVO) throws Exception;
	 ...
	 * @exception Exception
	 */
    GamCntnrQuayPdRentFeeSttusInqireVO selectCntnrQuayPdRentFeeSttusInqireSum(GamCntnrQuayPdRentFeeSttusInqireVO searchVO) throws Exception;
