 ...
 */
@Controller
public class GamSocRentProcessSetoffLgerController {
	...
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	...
    	return "/ygpa/gam/soc/GamSocRentProcessSetoffLger";
    }
    
    
    /**
     * 투자비보전(임대)상계처리대장 목록을 조회한다.
     *
     * @param searchVO
     * @return map
	...
	public @ResponseBody Map selectSocRentProcessSetoffLgerList(GamSocRentProcessSetoffLgerVO searchVO) throws Exception {
		...
		//투자비보전(임대)상계처리대장 리스트
    	List socRentProcessSetoffLgerList = gamSocRentProcessSetoffLgerService.selectSocRentProcessSetoffLgerList(searchVO);
    	
    	//투자비보전(임대)상계처리대장 리스트 총갯수 및 금액합계
    	GamSocRentProcessSetoffLgerVO socRentProcessSetoffLgerDetailSum = gamSocRentProcessSetoffLgerService.selectSocRentProcessSetoffLgerListSum(searchVO);
    	
		totalCnt = socRentProcessSetoffLgerDetailSum.getTotalCnt();
		sumExmpAmnt = socRentProcessSetoffLgerDetailSum.getSumExmpAmnt();
		sumExmpAmntPa = socRentProcessSetoffLgerDetailSum.getSumExmpAmntPa();
		sumAmnt = socRentProcessSetoffLgerDetailSum.getSumAmnt();
    	...
    	map.put("resultList", socRentProcessSetoffLgerList);
	...
	public String selectSocRentProcessSetoffLgerListPrint(@RequestParam Map<String, Object> socRentProcessSetoffLgerOpt, ModelMap model) throws Exception {
    	...
    	if(!isAuthenticated) {
	        map.put("resultCode", 1);
    		map.put("resultMsg", egovMessageSource.getMessage("fail.common.login"));
        	return "/ygpa/gam/soc/GamSocRentProcessSetoffLgerPrint";
    	}

		ObjectMapper mapper = new ObjectMapper();
		GamSocRentProcessSetoffLgerVO searchVO;

    	searchVO = mapper.convertValue(socRentProcessSetoffLgerOpt, GamSocRentProcessSetoffLgerVO.class);
		...
		GamSocRentProcessSetoffLgerVO totalSumCnt = gamSocRentProcessSetoffLgerService.selectSocRentProcessSetoffLgerListSum(searchVO);
    	List socRentProcessSetoffLgerList = gamSocRentProcessSetoffLgerService.selectSocRentProcessSetoffLgerList(searchVO);
        ...
        model.addAttribute("resultList", socRentProcessSetoffLgerList);
