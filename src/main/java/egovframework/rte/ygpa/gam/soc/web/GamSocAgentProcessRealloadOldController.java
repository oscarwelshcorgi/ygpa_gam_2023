...
@Controller
public class GamSocAgentProcessRealloadOldController {
    ...
    @RequestMapping(value="/soc/gamSocAgentProcessRealloadOld.do")
	public String indexMain(@RequestParam("window_id") String windowId, ModelMap model) throws Exception {
    	...
    	return "/ygpa/gam/soc/GamSocAgentProcessRealloadOld";
    }
}
