...
@Service("gamMapsArchFcltyInqireService")
public class GamMapsArchFcltyInqireServiceImpl extends AbstractServiceImpl
		implements GamMapsArchFcltyInqireService {

	@Resource(name="gamMapsArchFcltyInqireDAO")
	  private GamMapsArchFcltyInqireDAO gamMapsArchFcltyInqireDAO;
	...
	public EgovMap selectFcltySpecInfo(Map vo) throws Exception {
		return gamMapsArchFcltyInqireDAO.selectMapsFcltyCdInfo(vo);
	}
	...
	public List selectFcltyFileList(Map vo) throws Exception {
		...
		return gamMapsArchFcltyInqireDAO.selectMapsFcltyFileList(vo);
	}
