...
@Service("gamMapsCivilFcltyInqireService")
public class GamMapsCivilFcltyInqireServiceImpl extends AbstractServiceImpl
		implements GamMapsCivilFcltyInqireService {

	@Resource(name="gamMapsCivilFcltyInqireDAO")
	  private GamMapsCivilFcltyInqireDAO gamMapsCivilFcltyInqireDAO;
	...
	public EgovMap selectFcltySpecInfo(Map vo) throws Exception {
		return gamMapsCivilFcltyInqireDAO.selectMapsFcltyCdInfo(vo);
	}
