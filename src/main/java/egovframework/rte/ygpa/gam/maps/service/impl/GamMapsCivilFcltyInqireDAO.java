...
@Repository("gamMapsCivilFcltyInqireDAO")
public class GamMapsCivilFcltyInqireDAO extends YGPAAbstractDAO {
	...
	public EgovMap selectMapsFcltyCdInfo(Map vo) throws Exception{
		return (EgovMap) selectByPk("gamMapsCivilFcltyInqireDAO.selectFcltySpecInfoByPk_S", vo);
	}
