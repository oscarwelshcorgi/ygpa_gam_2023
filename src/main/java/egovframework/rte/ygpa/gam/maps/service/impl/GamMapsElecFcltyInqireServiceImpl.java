...
@Service("gamMapsElecFcltyInqireService")
public class GamMapsElecFcltyInqireServiceImpl extends AbstractServiceImpl
		implements GamMapsElecFcltyInqireService {

	@Resource(name="gamMapsElecFcltyInqireDAO")
	  private GamMapsElecFcltyInqireDAO gamMapsElecFcltyInqireDAO;
	...
	public EgovMap selectFcltySpecInfo(Map vo) throws Exception {
		return gamMapsElecFcltyInqireDAO.selectMapsFcltyCdInfo(vo);
	}
	...
	public List selectFcltyFileList(Map vo) throws Exception {
		...
		return gamMapsElecFcltyInqireDAO.selectMapsFcltyFileList(vo);
	}
