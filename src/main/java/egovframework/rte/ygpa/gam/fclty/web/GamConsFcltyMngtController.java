...
public class GamConsFcltyMngtController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/fclty/gamConstFcltyDetail.do")
    @ResponseBody Map<String, Object> fcltyMngSelectView(@RequestParam GamFcltyManageVO fcltyManageVO) throws Exception {
