...
public class GamMechFcltyMngtController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/fclty/gamMechFcltyMngtList.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/fclty/gamMechFcltyPhotoList.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/fclty/gamMechFcltyInsert.do")
	 ...
	 * @throws Exception
	 */
    @RequestMapping("/fclty/gamMechFcltyUpdate.do")
     ...
     * @throws Exception
     */
    @RequestMapping("/fclty/gamMechFcltyDelete.do")
	...
	@RequestMapping(value="/fclty/mergeGamMechFcltyPhotoMngt.do")
