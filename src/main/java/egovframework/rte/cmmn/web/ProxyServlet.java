...
//            response.sendRedirect(location.replace(getProxyHostAndPort() + proxyPath, myHostName));
            response.sendRedirect(location.replace(request.getParameter("url"), myHostName));
...
//                    headerValue = getProxyHostAndPort();
                	headerValue = httpServletRequest.getParameter("url");
                }
    ...
    private String getProxyURL(HttpServletRequest httpServletRequest) {
        ...
        stringProxyURL = httpServletRequest.getParameter("url");

        // Handle the query string
        if(httpServletRequest.getQueryString() != null) {
            stringProxyURL += "?" + httpServletRequest.getParameter("params");
        }
