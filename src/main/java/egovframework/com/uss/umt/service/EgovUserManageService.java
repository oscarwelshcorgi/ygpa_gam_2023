...
public interface EgovUserManageService  {
	 ...
	 * @param userManageUpdateVO 업무사용자 수정정보
	 * @throws Exception
	 */
	public void updateUser(UserManageUpdateVO userManageUpdateVO) throws Exception;
	 ...
	 * @throws Exception
	 */
	public String insertUserHistory(UserManageUpdateVO userManageUpdateVO) throws Exception;
