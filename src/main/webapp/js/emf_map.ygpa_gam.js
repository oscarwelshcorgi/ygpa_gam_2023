...
var EMD = function($, window, document, undefined) {
  ...
  assetRent:null, assetRentDetail:null}, filters:{assetRent:null}, strategies:{assetRent:null, assetRentStats:null, gnrlRentStats:null, htldRentStats:null, cntrRentStats:null, ccntRentStats:null, trnpRentStats:null}, selectControl:null, selectInfoControl:null, dragFeature:null, maxBounds:new OpenLayers.Bounds(-3E4, -6E4, 494288, 988576), maxRes:0.0439453125, maxZoom:14, module_instance:[], init:{frame_breaker:function() {
    ...
    EMD.protocols.gisAssetsCd = new OpenLayers.Protocol.WFS({version:"1.1.0", service:"WFS", url:EMD.gis_engine_url, featureNS:"http://geogate.g-inno.com/dataserver/datahouse", featurePrefix:"datahouse", featureType:"ASSETS_CD_F_A", srsName:"EPSG:5186", geometryName:"G2_SPATIAL"});
    EMD.protocols.assetRent = new OpenLayers.Protocol.WFS({version:"1.1.0", service:"WFS", url:EMD.gis_engine_url, featureNS:"http://geogate.g-inno.com/dataserver/datahouse", featurePrefix:"datahouse", featureType:"ASSETS_RENT_F", srsName:"EPSG:5186", geometryName:"G2_SPATIAL"});
    ...
    EMD.userStyle.assetRentStyle["default"] = {"default":{strokeColor:"#000000", strokeOpacity:1, strokeWidth:1, fillColor:"#6EBDA8", fillOpacity:0.5, pointRadius:6, pointerEvents:"visiblePainted", label:"\uc5c5\uccb4\uba85: ${ENTRPSNM}\n${GR_USAGE_PD_FROM}~${GR_USAGE_PD_TO}", fontColor:"black", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"white", labelOutlineWidth:3}, "select":{strokeColor:"#00FF00", 
    strokeOpacity:1, strokeWidth:3, fillColor:"#D5DD03", fillOpacity:1, pointRadius:6, pointerEvents:"visiblePainted", label:"\uc5c5\uccb4\uba85: ${ENTRPSNM}\n${GR_USAGE_PD_FROM}~${GR_USAGE_PD_TO}", fontColor:"white", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"black", labelOutlineWidth:3}};
    ...
    EMD.userLayer.assetRent = new OpenLayers.Layer.Vector("\uc784\ub300\uc815\ubcf4", {minScale:1E4, strategies:[EMD.strategies.assetRent, EMD.saveStrategy], projection:new OpenLayers.Projection("EPSG:5186"), protocol:EMD.protocols.assetRent, displayInLayerSwitcher:false, styleMap:new OpenLayers.StyleMap(EMD.userStyle.assetRentStyle["default"])});
    ...
    EMD.userLayer.assetRentDetail = new OpenLayers.Layer.Vector("\uc784\ub300\uc0c1\uc138\uc815\ubcf4", {minScale:1E4, strategies:[EMD.strategies.assetRent, EMD.saveStrategy], projection:new OpenLayers.Projection("EPSG:5186"), protocol:EMD.protocols.assetRentDetail, displayInLayerSwitcher:false, styleMap:new OpenLayers.StyleMap(EMD.userStyle.assetRentDetailStyle["default"])});
    ...
    EMD.userLayer.assetRentStats = new OpenLayers.Layer.Vector("\uc784\ub300\ud604\ud669", {minScale:1E4, strategies:[EMD.strategies.assetRentStats], projection:new OpenLayers.Projection("EPSG:5186"), protocol:EMD.protocols.assetRent, styleMap:new OpenLayers.StyleMap(EMD.userStyle.assetRentStyle["default"])});
    ...
    EMD.controls.measureDist = new OpenLayers.Control.Button({title:"\uac70\ub9ac\uce21\uc815", trigger:function() {
      var mapControls = EMD.map.controls;
    ...
    EMD.panel.addControls([EMD.controls.measureDist, EMD.controls.measureArea]);
    ...
    if ($DEBUG) {
      ...
      EMD.map.addLayers([basemap, EMD.lotarea, EMD.userLayer.landCode, EMD.userLayer.gisAssetsCd, EMD.wfs, EMD.userLayer.fcltyConstMarker, EMD.userLayer.fcltySocMarker, EMD.userLayer.fcltyMechMarker, EMD.userLayer.fcltyInfoTeleMarker, EMD.userLayer.fcltyElecPowerMarker]);
    } else {
      var layers = [basemap, EMD.userLayer.landCode, EMD.userLayer.gisAssetsCd, EMD.wfs, EMD.userLayer.assetRent, EMD.userLayer.assetRentDetail];
    ...
    EMD.map.addControls([EMD.selectControl, layerSwitcer, new OpenLayers.Control.MousePosition({prefix:"\uc9c0\ub3c4 \uc88c\ud45c : ", separator:" | ", numDigits:6, displayProjection:new OpenLayers.Projection("EPSG:5186")}), new OpenLayers.Control.Scale, new OpenLayers.Control.Measure(OpenLayers.Handler.PathMeasureCustom, {id:"measureDist", persist:true, handlerOptions:{layerOptions:{styleMap:styleMap}}}), new OpenLayers.Control.Measure(OpenLayers.Handler.PolygonMeasureCustom, {id:"measureArea", 
    persist:true, handlerOptions:{layerOptions:{styleMap:styleMap}}}), EMD.panel]);
  ...
  }, modifyFeature:null, addPrtFcltyMarkerClick:OpenLayers.Class(OpenLayers.Control, {defaultHandlerOptions:{"single":true, "double":false, "pixelTolerance":0, "stopSingle":false, "stopDouble":false}, initialize:function(options) {
    this.handlerOptions = OpenLayers.Util.extend({}, this.defaultHandlerOptions);
    OpenLayers.Control.prototype.initialize.apply(this, arguments);
    ...
    if (EMD.layerDisplay["assetRentStats"] != undefined) {
      EMD.strategies.assetRentStats.setFilter(new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND, filters:[new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO, property:"QUAY_GROUP_CD", value:"P"}), new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.LESS_THAN, property:"GR_USAGE_PD_FROM", value:currDate}), new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.GREATER_THAN_OR_EQUAL_TO, property:"GR_USAGE_PD_TO", value:currDate}), 
    ...
    if (foundFeatures.length == 0) {
      EMD.map.addControl(new OpenLayers.Control.DrawFeature(EMD.userLayer.gisAssetsCd, OpenLayers.Handler.Polygon, {handlerOptions:{holeModifier:"altKey"}, featureAdded:function(feature) {
        EMD.gis.storeLayerObject(layer, feature, code);
      ...
      if (foundFeatures.length > 0) {
        ...
        EMD.modifyFeature = new OpenLayers.Control.ModifyFeature(EMD.userLayer.gisAssetsCd, {handlerOptions:{holeModifier:"altKey"}, featureAdded:function(feature) {
          EMD.gis.storeLayerObject(layer, feature, code);
          EMD.userLayer.gisAssetsCd.drawFeatures([e.feature]);
          EMD.saveStrategy.save();
        }});
        EMD.gis.showEditPanel(module);
