...
var EMD = function($, window, document, undefined) {
  ...
  callbackWindowId:null}, map_panel:null, userLayer:{landCode:null, prtFclty:null, gisAssetsCd:null, portArea:null, quayGroup:null, quayCd:null, berthCd:null, constructCd:null, fcltyMarker:null}, userStyle:{assetCdStyle:{"default":null, "useSttus":null, "notUsgArea":null, "feeSttus":null, "reqSttus":null}, quayStyle:{"default":null, "useSttus":null, "notUsgArea":null, "feeSttus":null, "reqSttus":null}}, popup:{prtFcltyInfo:null, lotAreaInfo:null}, protocols:{prtFclty:null, gisAssetsCd:null}, selectControl:null, 
  selectInfoControl:null, dragFeature:null, maxBounds:new OpenLayers.Bounds(-3E4, -6E4, 494288, 988576), maxRes:0.0439453125, maxZoom:14, module_instance:[], init:{frame_breaker:function() {
    ...
    EMD.userLayer.gisAssetsCd = new OpenLayers.Layer.Vector("\uc790\uc0b0\uc815\ubcf4", {minScale:9E3, strategies:[new OpenLayers.Strategy.Fixed], projection:new OpenLayers.Projection("EPSG:5186"), protocol:EMD.protocols.gisAssetsCd, styleMap:new OpenLayers.StyleMap(EMD.userStyle.assetCdStyle["default"])});
    ...
    var row = module.$("#" + grid).flexGetData();
  ...
  }, showMapDataCode:function(module, layer, code, value) {
  ...
  initialize:function(name, options) {
    ...
    EMD.map.removeControl(EMD.panel);
  }, modifyFeature:function(mode, param) {
    ...
    switch(role) {
      case "loadMap":
        ...
        if (src == null) {
          EMD.gis.loadMapDataCode(module, button.data("gis-layer"), button.data("code-id"), button.data("value"));
        } else {
          EMD.gis.loadMapDataFlexGrid(module, button.data("gis-layer"), button.data("flexi-grid"), button.data("code-id"), button.data("value"));
        }
        break;
      case "showMap":
        var src = button.data("flexi-grid");
