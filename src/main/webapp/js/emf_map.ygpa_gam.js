...
icon:"ui-icon-extlink"}, {label:"\uc5d1\uc140", icon:"ui-icon-excel-down"}];
...
var EMD = function($, window, document, undefined) {
  ...
  callbackWindowId:null}, map_panel:null, userLayer:{landCode:null, prtFclty:null, gisAssetsCd:null, fcltyMarker:null}, popup:{prtFcltyInfo:null}, protocols:{prtFclty:null, gisAssetsCd:null}, selectControl:null, selectInfoControl:null, dragFeature:null, maxBounds:new OpenLayers.Bounds(-3E4, -6E4, 494288, 988576), maxRes:0.0439453125, maxZoom:14, module_instance:[], init:{frame_breaker:function() {
    ...
    EMD.map = new OpenLayers.Map("desktop", {div:"desktop", projection:new OpenLayers.Projection("EPSG:900913"), displayProjection:new OpenLayers.Projection("EPSG:5186"), units:"m", numZoomLevels:19, allOverlays:true, maxExtent:initExtent});
    ...
    EMD.lotarea = new OpenLayers.Layer.Vector("\uc9c0\ubc88", {minScale:5E3, strategies:[new OpenLayers.Strategy.BBOX], projection:new OpenLayers.Projection("EPSG:900913"), protocol:EMD.lotareaProtocol, styleMap:new OpenLayers.StyleMap({"default":{strokeColor:"#000000", strokeOpacity:1, strokeWidth:1, fillColor:"#FBFF9A", fillOpacity:0.5, pointRadius:6, pointerEvents:"visiblePainted", label:"${JIBUN}", fontColor:"black", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", 
    labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"white", labelOutlineWidth:3}, "select":{strokeColor:"#00FF00", strokeOpacity:1, strokeWidth:3, fillColor:"#E92FFF", fillOpacity:1, pointRadius:6, pointerEvents:"visiblePainted", label:"${JIBUN}", fontColor:"white", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"black", labelOutlineWidth:3}})});
    EMD.lotarea.events.register("featureselected", null, function(e) {
      ...
      EMD.gis.getBupjungDongNm(e.feature.attributes.PNU.substring(0, 10), {feature:feature}, function(data) {
        var info = "<h2 class='infoClass'>\uc9c0\ubc88 \uc815\ubcf4</h2><div style='font-size:.9em'><br>\uc8fc\uc18c : " + data.resultList[0].name + " " + data.feature.attributes.JIBUN;
        ...
        if (data.feature.popup != null) {
          EMD.selectControl.unselectAll();
          EMD.map.removePopup(data.feature.popup);
          data.feature.popup.destroy();
        }
        ...
        $("#addLotcodeToAsset").button({icons:{primary:"ui-icon-plus"}, text:true}).click({feature:feature}, function(event) {
          EMD.util.create_window("\uc790\uc0b0\uc815\ubcf4\ucd94\uac00", EMD.context_root + "code/assets/gamAssetCodeMngt.do", null, {action:"addLotcodeFeature", feature:event.data.feature});
        });
      });
    });
    ...
    EMD.userLayer.gisAssetsCd = new OpenLayers.Layer.Vector("\uc790\uc0b0\uc815\ubcf4", {minScale:9E3, strategies:[new OpenLayers.Strategy.BBOX], projection:new OpenLayers.Projection("EPSG:5186"), protocol:EMD.protocols.gisAssetsCd, styleMap:new OpenLayers.StyleMap({"default":{strokeColor:"#000000", strokeOpacity:1, strokeWidth:1, fillColor:"#303294", fillOpacity:0.5, pointRadius:6, pointerEvents:"visiblePainted", label:"\uc2dc\uc124\ucf54\ub4dc: ${GIS_ASSETS_PRT_AT_CODE} ${GIS_ASSETS_CD}-${GIS_ASSETS_SUB_CD}\n\uc2dc\uc124\uba85: ${GIS_ASSETS_NM}\n\n\uc18c\uc7ac\uc9c0: ${GIS_ASSETS_LOCPLC} ${GIS_ASSETS_LNM} ${GIS_ASSETS_LNM_SUB}", 
    fontColor:"black", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"white", labelOutlineWidth:3}, "select":{strokeColor:"#00FF00", strokeOpacity:1, strokeWidth:3, fillColor:"#303294", fillOpacity:1, pointRadius:6, pointerEvents:"visiblePainted", label:"\uc2dc\uc124\ucf54\ub4dc: ${GIS_ASSETS_PRT_AT_CODE} ${GIS_ASSETS_CD}-${GIS_ASSETS_SUB_CD}\n\uc2dc\uc124\uba85: ${GIS_ASSETS_NM}\n\n\uc18c\uc7ac\uc9c0: ${GIS_ASSETS_LOCPLC} ${GIS_ASSETS_LNM} ${GIS_ASSETS_LNM_SUB}", 
    fontColor:"white", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"black", labelOutlineWidth:3}})});
    EMD.userLayer.gisAssetsCd.events.register("featureselected", null, function(e) {
      var feature = e.feature;
      var popup = new OpenLayers.Popup.FramedCloud("popup", feature.geometry.bounds.getCenterLonLat(), new OpenLayers.Size(250, 150), "<div style='font-size:.8em'>ID: " + feature.id + "<br>\uccad\ucf54\ub4dc: " + feature.attributes.GIS_ASSETS_PRT_AT_CODE + +"<br>\uc2dc\uc124\ucf54\ub4dc: " + feature.attributes.GIS_ASSETS_MNG_YEAR + "-" + feature.attributes.GIS_ASSETS_MNG_NO + "-" + feature.attributes.GIS_ASSETS_MNG_CNT + "<br> \uc2dc\uc124\uba85 : " + feature.attributes.GIS_ASSETS_NM + "</div>", 
      null, true);
      feature.popup = popup;
      EMD.map.addPopup(popup);
    });
      ...
      {name:"prtFcltySe", value:e.feature.attributes.prtFcltySe}]}).done(function(data) {
        if (data.resultCode == 0) {
          ...
          if (fclty.filenmPhysicl != null) {
            htmlInfo += "<tr><th>\uc2dc\uc124\uc0ac\uc9c4</th><td><img src='" + EMD.context_root + "cmm/getImage.do?physicalFileNm=" + fclty.filenmPhysicl + "' style='width:300px;' /></td></tr>";
          }
          ...
          $(".prtFcltyInfo td > img").load(function(e) {
            EMD.popup.prtFcltyInfo.setSize(new OpenLayers.Size($("table.prtFcltyInfo").width() + 16, $("table.prtFcltyInfo").height() + 8));
          });
        }
      });
    });
    ...
    EMD.wfs = new OpenLayers.Layer.Vector("Vector Features", {strategies:[new OpenLayers.Strategy.BBOX, saveStrategy], projection:new OpenLayers.Projection("EPSG:5186"), protocol:new OpenLayers.Protocol.WFS({version:"1.1.0", service:"WFS", url:EMD.gis_engine_url, featureNS:"http://geogate.g-inno.com/dataserver/datahouse", featurePrefix:"datahouse", featureType:"ASSETS_CD_F_A", srsName:"EPSG:5186", geometryName:"G2_SPATIAL"}), styleMap:new OpenLayers.StyleMap({"default":{strokeColor:"#000000", strokeOpacity:1, 
    ...
    EMD.map.addControl(new OpenLayers.Control.MousePosition({prefix:"\uc88c\ud45c : ", separator:" | ", numDigits:6, displayProjection:new OpenLayers.Projection("EPSG:5186")}));
    ...
    var list = EMD.userLayer.fcltyMarker.getFeaturesByAttribute("gisAssetsPrtAtCode", prtFclty.gisAssetsPrtAtCode);
    $.each(list, function() {
      if (this.attributes["gisAssetsCd"] == prtFclty.gisAssetsCd && (this.attributes["prtFcltySe"] == prtFclty.prtFcltySe && (this.attributes["gisAssetsSubCd"] == prtFclty.gisAssetsSubCd && (this.attributes["gisPrtFcltyCd"] == prtFclty.gisPrtFcltyCd && this.attributes["gisPrtFcltySeq"] == prtFclty.gisPrtFcltySeq)))) {
        EMD.selectInfoControl.select(this);
        return false;
      }
    });
  }, selectAssetCode:function(gisAssetsPrtAtCode, gisAssetsCd, gisAssetsSubCd) {
    var filter = new OpenLayers.Filter.Logical({type:OpenLayers.Filter.Logical.AND, filters:[new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO, property:"GIS_ASSETS_PRT_AT_CODE", value:gisAssetsPrtAtCode}), new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO, property:"GIS_ASSETS_CD", value:gisAssetsCd}), new OpenLayers.Filter.Comparison({type:OpenLayers.Filter.Comparison.EQUAL_TO, property:"GIS_ASSETS_SUB_CD", value:gisAssetsSubCd})]});
    EMD.protocols.gisAssetsCd.read({filter:EMD.protocols.gisAssetsCd, callback:function(resp) {
      if (resp.error) {
        console.log("error");
        return-1;
      }
    ...
    EMD.protocols.gisAssetsCd.read({filter:filter, callback:function(resp) {
      if (resp.error) {
        ...
        EMD.protocols.gisAssetsCd.create({feature:feature, attributes:assetsCd, callback:function(resp) {
          if (resp.error) {
            console.log("error");
            return-1;
          }
  ...
  initialize:function(name, options) {
    ...
    var response = EMD.protocols.gisAssetsCd.read({maxFeatures:10, callback:function(resp) {
      layer.addFeatures(resp.features);
    }});
  }, showBupJungDongCode:function(code) {
    var shapeParams = OpenLayers.Util.getParameterString({SERVICE:"WFS", VERSION:"1.1.0", REQUEST:"GetFeature", TYPENAME:"LP_PA_CBND_BUBUN", PROPERTYNAME:"PNU,BCHK,STD_SGGCD,JIBUN,BONBUN,BUBUN", PNU:code, filter:"<ogc:Filter xmlns:ogc='http://www.opengis.net/ogc'><ogc:And><ogc:PropertyLike escape='' singleChar='_' wildCard='%'><ogc:PropertyName>PNU</ogc:PropertyName><gml:Literal>" + code + "%</gml:Literal></ogc:PropertyLike></ogc:And></ogc:Filter>", SRSNAME:"EPSG:900913", OUTPUT:"text/xml;subType=gml/3.1.1/profiles/gmlsf/1.0.0/0", 
    EXCEPTIONS:"text/xml"});
