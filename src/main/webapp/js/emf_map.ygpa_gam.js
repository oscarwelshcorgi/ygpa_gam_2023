...
var EMD = function($, window, document, undefined) {
  ...
  return{go:function(ctr, mapBaseUrl, gisEngineUrl, serverUrl) {
  ...
  }, context_root:"", map_base_url:"", gis_engine_url:"", serverUrl:"", vworldKey:"", window_seq:0, win_x:80, win_y:40, drag_handle:null, dragging:false, drag_ui:null, userinfo:null, popupCaller:null, popupId:null, popupParams:null, map:null, map_state:null, map_value:null, map_callback:null, gyhmap:null, wfs:null, lotarea:null, lotareaProtocol:null, panel:null, draw:null, edit:null, edit_win:null, del:null, info:null, save:null, saveStrategy:null, transaction:{type:null, callbackWindowId:null}, 
  map_panel:null, userLayer:{landCode:null, prtFclty:null, gisAssetsCd:null, portArea:null, quayGroup:null, quayCd:null, berthCd:null, constructCd:null, fcltyMarker:null}, userStyle:{assetCdStyle:{"default":null, "useSttus":null, "notUsgArea":null, "feeSttus":null, "reqSttus":null, "evlDtls":null}, quayStyle:{"default":null, "useSttus":null, "notUsgArea":null, "feeSttus":null, "reqSttus":null}}, popup:{prtFcltyInfo:null, lotAreaInfo:null}, protocols:{prtFclty:null, gisAssetsCd:null}, selectControl:null, 
  selectInfoControl:null, dragFeature:null, maxBounds:new OpenLayers.Bounds(-3E4, -6E4, 494288, 988576), maxRes:0.0439453125, maxZoom:14, module_instance:[], init:{frame_breaker:function() {
    ...
    EMD.map = new OpenLayers.Map("desktop", {div:"desktop", projection:new OpenLayers.Projection("EPSG:900913"), displayProjection:new OpenLayers.Projection("EPSG:5186"), units:"m", numZoomLevels:19, maxResolution:156543.0399, allOverlays:true, maxExtent:initExtent, theme:"css/theme/ygpa/style.css"});
    var basemap = new EMD.gis.OpenLayersVworld("\ubc30\uacbd\uc9c0\ub3c4", {isBaseLayer:true, maxExtent:initExtent, type:"png", numZoomLevels:19, baseurl:EMD.map_base_url, projection:new OpenLayers.Projection("EPSG:900913")});
