...
var EMD = function($, window, document, undefined) {
  ...
  callbackWindowId:null}, map_panel:null, userLayer:{landCode:null, prtFclty:null, gisAssetsCd:null, fcltyMarker:null}, popup:{prtFcltyInfo:null, lotAreaInfo:null}, protocols:{prtFclty:null, gisAssetsCd:null}, selectControl:null, selectInfoControl:null, dragFeature:null, maxBounds:new OpenLayers.Bounds(-3E4, -6E4, 494288, 988576), maxRes:0.0439453125, maxZoom:14, module_instance:[], init:{frame_breaker:function() {
    ...
    fontColor:"black", fontSize:"12px", fontFamily:"Courier New, monospace", fontWeight:"bold", labelAlign:"cm", labelXOffset:"2px", labelYOffset:"2px", labelOutlineColor:"white", labelOutlineWidth:3}, "select":{strokeColor:"#00FF00", strokeOpacity:1, strokeWidth:3, fillColor:"#303294", fillOpacity:1, pointRadius:6, pointerEvents:"visiblePainted", label:"\uc2dc\uc124\ucf54\ub4dc: ${GIS_ASSETS_CD}-${GIS_ASSETS_SUB_CD}\n${GIS_ASSETS_NM}", fontColor:"white", fontSize:"12px", fontFamily:"Courier New, monospace", 
    ...
    $("#fileupload").fileupload({url:"/upload/genericMulti.do", autoUpload:true});
...
EmdModule.prototype.requestEApproval = function(params, retfunc) {
  ...
  window.open("", "Window", "width=300, height=400, menubar=no,status=yes,scrollbars=no");
  form.target = "Window";
  form.submit();
};
...
(function($) {
  ...
  $.fn.selectRowId = function(rownum) {
    ...
    $(this.selector).closest("table").find("tr:eq(" + 25 + ")").addClass("trSelected");
  };
  ...
  $.fn.flexUpdateRow = function(i, row) {
    ...
    $(this.selector).closest("table tr:eq(" + i + ")").addClass("trSelected");
  };
