...
<%
  /**
  * @Class Name : GamPopupCntnrRentMngtPrmisn.jsp
  * @Description : 승낙 팝업
...
GamPopupPrtOperRentModule.prototype.onButtonClick = function(buttonId) {
	...
	case 'btnPrmisnExec':
        ...
        this.doAction('<c:url value="/oper/cntnr/popup/gamInsertCntnrRentMngtPrmisn.do" />', inputVO, function(module, result) {
...
<div class="dialog">
	<div class="emdPanel">
		<form id="gamPopupPrmisnForm">
		    <input type="hidden" id="prtAtCode" value="<c:out value="${gamCntnrRentMngtInfo.prtAtCode }"/>"/>
		    <input type="hidden" id="mngYear" value="<c:out value="${gamCntnrRentMngtInfo.mngYear }"/>"/>
		    <input type="hidden" id="mngNo" value="<c:out value="${gamCntnrRentMngtInfo.mngNo }"/>"/>
		    <input type="hidden" id="mngCnt" value="<c:out value="${gamCntnrRentMngtInfo.mngCnt }"/>"/>
