...
<%
/**
 * @Class Name : GamArchFcltyDrwList.jsp
 * @Description : 건축시설 도면목록
...
<%
/**
 * @FUNCTION NAME : GamArchFcltyDrwListModule
 * @DESCRIPTION   : MODULE 고유 함수
 * @PARAMETER     : NONE
**/
%>
function GamArchFcltyDrwListModule() {}

GamArchFcltyDrwListModule.prototype = new EmdModule(1000, 620);
...
**/
%>
GamArchFcltyDrwListModule.prototype.loadComplete = function(params) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.onAtchFileDirTreeItemClick = function(itemId) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.onClosePopup = function(popupId, msg, value) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.onButtonClick = function(buttonId) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.selectFileData = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.displayAtchFileDirectory = function(argDirNo) {
	...
	this.doAction('/fclty/gamSelectArchFcltySpecMngAtchFileDirList.do', inputVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length > 0) {
				...
				if(module.$('#dirQueryOption').val() == "A"){
				...
				module.tree.attachEvent("onDrop", function(id, pId, index){
					if(pId == "0" || module.$('#dirQueryOption').val() != "A"){
...
**/
%>
GamArchFcltyDrwListModule.prototype.treeUpdate = function(treeData) {

	this.doAction('/fclty/gamUpdateArchFcltySpecMngAtchFileDirChage.do', treeData, function(module, result){
...
**/
%>
GamArchFcltyDrwListModule.prototype.refreshDirData = function(argDirNo) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.addAtchFileDirectory = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.renameAtchFileDirectory = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.removeAtchFileDirectory = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.displayAtchFileList = function(argAtchFileDirNo) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.refreshFileData = function(argAtchFileNo) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.selectAllFile = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.saveUploadFileData = function(argAtchFileFcltsMngNo, argAtchFileFcltsDirNo, argAtchFileFcltsJobSe, argAtchFileFcltsDataSe, argAtchFileFcltsMngSeq, argAtchFileNmLogic, argAtchFileNmPhysicl) {
...
**/
%>
GamArchFcltyDrwListModule.prototype.uploadFile = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.downloadFile = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.downloadMultiFile = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.deleteFileData = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.deleteMultiFileData = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.displayPreviewFile = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.showFcltsAtchFileViewPopup = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.enableFileButtonItem = function() {
...
**/
%>
GamArchFcltyDrwListModule.prototype.disableFileButtonItem = function() {
...
var module_instance = new GamArchFcltyDrwListModule();
