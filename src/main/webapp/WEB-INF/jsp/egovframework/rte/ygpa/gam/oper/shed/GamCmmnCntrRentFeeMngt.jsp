 ...
 */
function GamCmmnCntrRentFeeMngtModule() {}

GamCmmnCntrRentFeeMngtModule.prototype = new EmdModule(1000, 550);

// 페이지가 호출 되었을때 호출 되는 함수
GamCmmnCntrRentFeeMngtModule.prototype.loadComplete = function() {

    // 테이블 설정 //       
    this.$("#cmmnCntrRentFeeMngtList").flexigrid({
        module: this,
    ...
    this.$("#cmmnCntrRentFeeMngtList").on('onItemSelected', function(event, module, row, grid, param) {
        module.$('#cmd').val('modify');

        module.$('#gamCmmnCntrRentFeeMngtForm :input').val('');

        module.makeFormValues('#gamCmmnCntrRentFeeMngtForm', row);
        module._editData=module.getFormValues('#gamCmmnCntrRentFeeMngtForm', row);
        module._editRow=module.$('#cmmnCntrRentFeeMngtList').selectedRowIds()[0];
    });
    
    this.$("#cmmnCntrRentFeeMngtList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        // 이벤트내에선 모듈에 대해 선택한다.
        module.$("#cmmnCntrRentFeeMngtListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
        this.$("#cmd").val('modify');
 ...
 * 정의 된 버튼 클릭 시
 */
 GamCmmnCntrRentFeeMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'btnInsertItem':
        	module.$("#cmmnCntrRentFeeMngtListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
            this.$('#gamCmmnCntrRentFeeMngtForm').find(':input').val('');
            this.$("#cmd").val('insert');
        ...
        case 'btnSaveItem':
        	...
        	if( this.$('#prtAtCode').val() == '' ) {
	        	...
	        	var inputVO=this.makeFormArgs('#gamCmmnCntrRentFeeMngtForm');
	        	
	        	this.doAction('<c:url value="/oper/shed/gamUpdateCmmnCntrRentFeeMngt.do" />', inputVO, function(module, result) {
	
	                if(result.resultCode=='0') {
	                    var searchOpt=module.makeFormArgs('#gamCmmnCntrRentFeeMngtSearchForm');
	                    module.$('#cmmnCntrRentFeeMngtList').flexOptions({params:searchOpt}).flexReload();
	                }
        	...
        	*/
        	...
        	if( this.$("#cmd").val() == 'insert' ) {
                ...
                this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentFeeMngt.do" />', inputVO, function(module, result) {
         ...
         // 취소
        case 'btnCancelItem':
            this.$('#gamCmmnCntrRentFeeMngtForm :input').val("");
            break;
        ...
        case 'saveNticListBtn':
            ...
            var reglist = this.$("#cmmnCntrRentFeeMngtList").selectFilterData(filter);
            ...
            if(reglist.length > 0){
                ...
                this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentFeeMngtNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamCmmnCntrRentFeeMngtSearchForm");
                        module.$("#cmmnCntrRentFeeMngtList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'cancelNticListBtn': 
            ...
            if(reglist.length > 0){
                ...
                var inputVO = {nticCnts: nticCnts, prtAtCodes: prtAtCodes, mngYears: mngYears, mngNos: mngNos, mngCnts: mngCnts, nticnos: nticnos, accnutYears: accnutYears };
                this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentFeeMngtNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamCmmnCntrRentFeeMngtSearchForm");
                        module.$("#cmmnCntrRentFeeMngtList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'saveNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentFeeMngtNticSingle.do" />', inputVO, function(module, result) {
        ...
        case 'cancelNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentFeeMngtNticSingle.do" />', inputVO, function(module, result) {
        ...
        */
        ...
        case 'saveNticDetailBtn':
        	var rows = this.$('#cmmnCntrRentFeeMngtList').selectedRows();
        	
        	if(rows.length>=1) {
        		if( confirm("고지의뢰를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentFeeMngtNticSingle.do" />', rows[0], function(module, result) {
        ...
        case 'cancelNticDetailBtn':
            ...
            if(rows.length>=1) {
                if( confirm("고지취소를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentFeeMngtNticSingle.do" />', rows[0], function(module, result) {
...
GamCmmnCntrRentFeeMngtModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamCmmnCntrRentFeeMngtModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamCmmnCntrRentFeeMngtSearchForm');
    //this.showAlert(searchOpt);
    this.$('#cmmnCntrRentFeeMngtList').flexOptions({params:searchOpt}).flexReload();
};

GamCmmnCntrRentFeeMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
...
GamCmmnCntrRentFeeMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
...
var module_instance = new GamCmmnCntrRentFeeMngtModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCmmnCntrRentFeeMngtSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="cmmnCntrRentFeeMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">공컨장치장임대료고지 목록</a></li>
                <li><a href="#tabs2" class="emdTab">공컨장치장임대료고지 상세</a></li>
            </ul>

            <div id="tabs1" class="emdTabPage fillHeight" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <!-- <div style="width: 100%; height: 100%; overflow:auto">  -->
                        <table id="cmmnCntrRentFeeMngtList" style="display:none" class="fillHeight"></table>
                <!-- </div>  -->
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                ...
                <div class="emdControlPanel">
                    ...
                    <form id="gamCmmnCntrRentFeeMngtForm">
