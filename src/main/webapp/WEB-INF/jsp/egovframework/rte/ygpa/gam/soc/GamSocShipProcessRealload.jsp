...
**/
%>
GamSocShipProcessRealloadModule.prototype.validateDuration = function(startDate, endDate, startTitle, endTitle, startIgnore, endIgnore, equals) {
	var result = false;
...
GamSocShipProcessRealloadModule.prototype.onSubmit = function() {
	...
	if(!this.validateDuration(this.$('#sFrDt').val(), this.$('#sToDt').val(),  
			'고지기간 검색 시작일', '고지기간 검색 종료일', false, false, true)) {
		return;
	}
