...
<%
  /**
  * @Class Name : GamCntnrQuayRentUseExptnDtaInqire.jsp
  * @Description : 컨테이너부두사용만기자료조회 테스트 (Prototype)
...
GamAssetCodeListModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'사용기간 From',name:'USAGE_PD_FROM',width:200,sortable:false,align:'center'},
			{display:'사용기간 To',name:'USAGE_PD_TO',width:200,sortable:false,align:'center'}
			],
/* 		searchitems : [
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">사용만기자료조회</a></li>
