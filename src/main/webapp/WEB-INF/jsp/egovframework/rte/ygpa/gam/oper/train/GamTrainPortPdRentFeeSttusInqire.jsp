...
<%
  /**
  * @Class Name : GamTrainPortPdRentFeeSttusInqire.jsp
 ...
 */
function GamTrainPortPdRentFeeSttusInqireModule() {}

GamTrainPortPdRentFeeSttusInqireModule.prototype = new EmdModule(1000, 600);

//페이지가 호출 되었을때 호출 되는 함수
GamTrainPortPdRentFeeSttusInqireModule.prototype.loadComplete = function() {
 
 // 테이블 설정 //       
 this.$("#trainPortPdRentFeeSttusInqireList").flexigrid({
     module: this,
     url: '/oper/train/gamSelectTrainPortPdRentFeeSttusInqireList.do',
     dataType: 'json',
     colModel : [
...
this.$("#trainPortPdRentFeeSttusInqireList").on("onItemSelected", function(event, module, row, grid, param) {
...
* 정의 된 버튼 클릭 시
*/
GamTrainPortPdRentFeeSttusInqireModule.prototype.onButtonClick = function(buttonId) {
...
GamTrainPortPdRentFeeSttusInqireModule.prototype.onSubmit = function() {
 //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

 this.loadData();
};

GamTrainPortPdRentFeeSttusInqireModule.prototype.loadData = function() {
 var searchOpt=this.makeFormArgs('#gamTrainPortPdRentFeeSttusInqireSearchForm');
 //this.showAlert(searchOpt);
 this.$('#trainPortPdRentFeeSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamTrainPortPdRentFeeSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
 switch(newTabId) {
 case 'tabs1':
     break;
 case 'tabs2':
...
var module_instance = new GamTrainPortPdRentFeeSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamTrainPortPdRentFeeSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">철송장임대기간별사용료 고지현황</a></li>
            </ul>
            <div id="tabs1" class="emdTabPage" data-onactivate="onShowTab1Activate">
            <table id="trainPortPdRentFeeSttusInqireList" style="display:none" class="fillHeight"></table>
