...
<%
  /**
  * @Class Name : GamIndoorSpaceMngt.jsp
  * @Description : 실내공간관리
  * @Modification Information
  *
  *   수정일         수정자                   수정내용
  *  -------    --------    ---------------------------
  *  2014.04.04  eunsungj          최초 생성
  *
  * author eunsungj
  * since 2014.02.05
  *
...
<div class="window_main">
	...
	<div class="emdPanel fillHeight">
		<div id="fcltyMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
			<ul>
				<li><a href="#tabs1" class="emdTab">실내공간정보</a></li>
				<li><a href="#tabs2" class="emdTab">시설 정보</a></li>
				<li><a href="#tabs3" class="emdTab">시설 사진</a></li>
			</ul>
			<div id="tabs1" class="emdTabPage" style="overflow: hidden;">
				...
				<div class="emdControlPanel">
					...
					<button id="showInfo">정보 조회</button>
					<button id="showInfo">임대 관리</button>
				</div>
			</div>
				...
				<form id="fcltyManageVO">
					...
					<table class="searchPanel">
						...
						<tr>
							...
							<td colspan="3">
								<input class="ygpaCmmnCd" data-default-prompt="전체" data-code-id="GAM005"/>
							</td>
						</tr>
						<tr>
