...
<%
  /**
  * @Class Name : GamPopupCntnrQuayPenaltyFee.jsp
 ...
 */
function GamPopupCntnrQuayPenaltyFeeModule() {}

GamPopupCntnrQuayPenaltyFeeModule.prototype = new EmdPopupModule(450, 126);

// 팝업이 호출 되었을때 호출 되는 함수
GamPopupCntnrQuayPenaltyFeeModule.prototype.loadComplete = function() {
...
GamPopupCntnrQuayPenaltyFeeModule.prototype.onButtonClick = function(buttonId) {
	switch(buttonId) {
...
GamPopupCntnrQuayPenaltyFeeModule.prototype.onSubmit = function() {
	//this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');
	this.loadData();
};

GamPopupCntnrQuayPenaltyFeeModule.prototype.loadData = function() {
	//var searchOpt=this.makeFormArgs('#gamPopupDisUseForm');
 	//this.$('#grdInfoList').flexOptions({params:searchOpt}).flexReload();
};

// 다음 변수는 고정 적으로 정의 해야 함
var popup_instance = new GamPopupCntnrQuayPenaltyFeeModule();
</script>
<div class="dialog">
	<div class="emdPanel">
