...
GamAssetLndValInqireModule.prototype.loadComplete = function() {
 ...
 this.$("#assetLndValInqireList").flexigrid({
     module: this,
     url: '<c:url value="/oper/train/gamTrainPortPopupInqire.do"/>',
     dataType: 'json',
     colModel : [
 ...
 this.$('#chk').on('click', {module: this}, function(event) {
		...
		d.setHours(0);
	  	document.cookie = "ygpa_popup_c6=/oper/train/gamTrainPortPopupInqire.do; expires=" +d.toUTCString();
...
GamAssetLndValInqireModule.prototype.onButtonClick = function(buttonId) {
 ...
 switch(buttonId) {
     ...
     case 'btnTrainPortRent':
    	 EMD.util.create_window('철송장 목록 관리', '<c:url value="/oper/train/gamTrainPortRentMngt.do"/>', null);
    	 break;
     case 'btnTrainPortFeeMngt':
    	 EMD.util.create_window('철송장 사용료 관리', '<c:url value="/oper/train/gamTrainPortRentFeeMngt.do"/>', null);
    	 break;
     case 'btnTrainPortRentFeePayDtlsMngt':
    	 EMD.util.create_window('철송장 사용료납부관리', '<c:url value="/oper/train/gamTrainPortRentFeePaySttusMngt.do"/>', null);
    	 break;
     case 'btnTrainPortUseExprInqire':
    	 EMD.util.create_window('철송장 만기도래자료조회', '<c:url value="/oper/train/gamTrainPortUseExprInqire.do"/>', null);
    	 break;
 }
};
                ...
                <div class="emdControlPanel">
                    <table style="width:100%;" >
                        ...
                        <tr>
                            ...
                            <td>
                                <button id="btnTrainPortRent">철송장 목록 관리</button>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <button id="btnTrainPortFeeMngt">철송장 사용료고지 관리</button>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <button id="btnTrainPortRentFeePayDtlsMngt">철송장 사용료납부관리</button>
                            </td>
                        </tr>
                        <tr>
                            <th>
                            ...
                            <td>
                                <button id="btnTrainPortUseExprInqire">철송장 만기도래자료조회</button>
                            </td>
                        </tr>
                        </form>
                    </table>
