...
<%
  /**
  * @Class Name : GamCmmnCntrShedRentSttusInqire.jsp
 ...
 */
 function GamCmmnCntrShedRentSttusModule() {}

 GamCmmnCntrShedRentSttusModule.prototype = new EmdModule(910, 550);

 // 페이지가 호출 되었을때 호출 되는 함수
 GamCmmnCntrShedRentSttusModule.prototype.loadComplete = function() {

     // 테이블 설정
     this.$("#operResultList").flexigrid({
         module: this,
         url: '<c:url value="/oper/shed/selectCmmnCntrShedRentSttusInqireList.do" />',
         dataType: 'json',
         colModel : [
     ...
     this.$("#operResultDetailList").flexigrid({  
         module: this,
         url: '<c:url value="/oper/shed/selectCmmnCntrShedRentSttusInqireDetailList.do" />',  
         dataType: 'json',
         colModel : [
  ...
  * 정의 된 버튼 클릭 시
  */
  GamCmmnCntrShedRentSttusModule.prototype.onButtonClick = function(buttonId) {
 ...
 GamCmmnCntrShedRentSttusModule.prototype.onSubmit = function() {
     this.loadData();
 };

 GamCmmnCntrShedRentSttusModule.prototype.loadData = function() {
     var searchOpt=this.makeFormArgs('#gamOperSearchForm');
     this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
 };

 GamCmmnCntrShedRentSttusModule.prototype.onTabChange = function(newTabId, oldTabId) {
	 switch(newTabId) {
     case 'tabs1':
         break;
     case 'tabs2':
...
GamCmmnCntrShedRentSttusModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
 ...
 var module_instance = new GamCmmnCntrShedRentSttusModule();
 </script>
 <!-- 아래는 고정 -->
 ...
 <div class="window_main">
     ...
     <div class="emdPanel fillHeight">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 <li><a href="#tabs1" class="emdTab">공컨장치장사용현황 조회내역</a></li>
                 <li><a href="#tabs2" class="emdTab">공컨장치장사용현황 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">공컨장치장사용현황 상세조회내역</a></li>
             </ul>
