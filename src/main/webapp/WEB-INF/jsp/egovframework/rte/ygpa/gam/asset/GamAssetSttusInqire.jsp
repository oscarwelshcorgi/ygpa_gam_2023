...
<%
  ...
  * @Description : 자산정보현황조회 테스트 (Prototype)
...
GamAssetEvlDtlsInqiryModule.prototype.loadComplete = function() {
	...
	this.$("#assetEvlDtlsList").flexigrid({
		...
		colModel : [
				...
				{display:'자산명', name:'ASSETS_NM',width:100, sortable:false,align:'center'},
				{display:'준공년도', name:'BLDDATE',width:100, sortable:false,align:'center'},
				{display:'자산 구분코드 ', name:'ASSETS_SE_CD',width:100, sortable:false,align:'center'},
				{display:'관리 부서코드 ',name:'MNG_DEPT_CD',width:100,sortable:false,align:'center'},
				{display:'운영 부서코드 ',name:'OPER_DEPT_CD',width:100,sortable:false,align:'center'},
				{display:'지번',name:'지번',width:100,sortable:false,align:'center'},
