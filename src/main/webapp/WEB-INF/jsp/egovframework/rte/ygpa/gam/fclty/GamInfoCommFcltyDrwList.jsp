...
<%
/**
 * @Class Name : GamInfoCommFcltyDrwList.jsp
 * @Description : 정보통신시설 도면목록
 * @Modification Information
 *
 *   수정일          수정자                   수정내용
 *  -------    --------    ---------------------------
 *  2015.9.23	ygkim			최초 생성
 *
 * author ygkim
 * since 2015.09.23
 *
...
<%
/**
 * @FUNCTION NAME : GamInfoCommFcltyDrwListModule
 * @DESCRIPTION   : MODULE 고유 함수
 * @PARAMETER     : NONE
**/
%>
function GamInfoCommFcltyDrwListModule() {}

GamInfoCommFcltyDrwListModule.prototype = new EmdModule(1000, 620);
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.loadComplete = function(params) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.onAtchFileDirTreeItemClick = function(itemId) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.onClosePopup = function(popupId, msg, value) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.onButtonClick = function(buttonId) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.selectFileData = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.displayAtchFileDirectory = function(argDirNo) {
	...
	this.doAction('/fclty/gamSelectInfoCommFcltySpecMngAtchFileDirList.do', inputVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length > 0) {
				...
				if(module.$('#dirQueryOption').val() == "I"){
				...
				module.tree.attachEvent("onDrop", function(id, pId, index){
					if(pId == "0" || module.$('#dirQueryOption').val() != "I"){
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.treeUpdate = function(treeData) {

	this.doAction('/fclty/gamUpdateInfoCommFcltySpecMngAtchFileDirChage.do', treeData, function(module, result){
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.refreshDirData = function(argDirNo) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.addAtchFileDirectory = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.renameAtchFileDirectory = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.removeAtchFileDirectory = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.displayAtchFileList = function(argAtchFileDirNo) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.refreshFileData = function(argAtchFileNo) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.selectAllFile = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.saveUploadFileData = function(argAtchFileFcltsMngNo, argAtchFileFcltsDirNo, argAtchFileFcltsJobSe, argAtchFileFcltsDataSe, argAtchFileFcltsMngSeq, argAtchFileNmLogic, argAtchFileNmPhysicl) {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.uploadFile = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.downloadFile = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.downloadMultiFile = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.deleteFileData = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.deleteMultiFileData = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.displayPreviewFile = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.showFcltsAtchFileViewPopup = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.enableFileButtonItem = function() {
...
**/
%>
GamInfoCommFcltyDrwListModule.prototype.disableFileButtonItem = function() {
...
var module_instance = new GamInfoCommFcltyDrwListModule();
