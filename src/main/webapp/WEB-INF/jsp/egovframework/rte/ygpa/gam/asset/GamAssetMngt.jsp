...
GamAssetCodeModule.prototype.loadComplete = function() {
	...
	this.$("#erpAssetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'자산번호', name:'assetno', width:62, sortable:true, align:'left'},
			{display:'자산번호순번', name:'assetNoSeq', width:128, sortable:true, align:'left'},
			{display:'자산관리번호', name:'assetMngtNo', width:80, sortable:true, align:'center'},
			...
			{display:'현재수량', name:'curQty', width:128, sortable:true, align:'center'},
			{display:'취득금액', name:'deprctnAmt', width:128, sortable:true, align:'center'},
