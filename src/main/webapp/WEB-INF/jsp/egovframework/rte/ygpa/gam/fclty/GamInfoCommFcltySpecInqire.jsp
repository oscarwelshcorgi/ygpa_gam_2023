...
**/
%>
GamInfoCommFcltySpecInqireModule.prototype.selectFileData = function() {
...
**/
%>
GamInfoCommFcltySpecInqireModule.prototype.hideFcltyMaintMngList = function() {
...
**/
%>
GamInfoCommFcltySpecInqireModule.prototype.showFcltyMaintMngList = function(argParent) {
...
**/
%>
GamInfoCommFcltySpecInqireModule.prototype.buildFcltyMaintMngList = function() {
	...
	this.doAction('/fclty/gamSelectInfoCommFcltySpecInqireMntnRprDtlsList.do', searchVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length <= 0) {
					...
					<form id="detailForm">
						...
						<table class="detailPanel" style="width:100%;">
							...
							<tr>
								...
								<td>
									...
									<input type="text" size="11" id="prtPrtFcltyMnger" class="emdcal" disabled/>
								</td>
						...
						<table class="detailPanel" style="width:100%;">
							...
							<tr>
								...
								<td>
									<input type="text" size="58" id="instlSe" maxlength="50" disabled/>
								</td>
								<th style="width:10%; height:18px;">준　공　일　자</th>
								<td>
									<input type="text" size="58" id="bldDt" class="emdcal" disabled/>
								</td>
							</tr>
							<tr>
