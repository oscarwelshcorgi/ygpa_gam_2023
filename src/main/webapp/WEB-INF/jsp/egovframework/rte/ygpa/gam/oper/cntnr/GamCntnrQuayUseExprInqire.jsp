...
GamCntnrQuayUseExprInqireModule.prototype.loadComplete = function() {
    this.$("#cntnrQuayUseExprInqireList").flexigrid({
        module: this,
        url: '/oper/cntnr/gamSelectCntnrQuayUseExprInqireList.do',
        dataType: 'json',
        colModel : [
...
GamCntnrQuayUseExprInqireModule.prototype.loadUseList = function() {
...
GamCntnrQuayUseExprInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#cntnrQuayUseExprInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamCntnrQuayUseExprInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('/oper/cntnr/gamSelectCntnrQuayUseExprInqireDetailList.do', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamCntnrQuayUseExprInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamCntnrQuayUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#cntnrQuayUseExprInqireList').selectedRowCount()==0) {
    ...
    <div class="emdPanel fillHeight">
        <div id="cntnrQuayUseExprInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                	...
                	<!-- <h2>컨테이너부두임대 내역</h2> -->
                	<div id="gamCntnrQuayUseExprInqireForm">
                	...
                	<!-- <h2>컨테이너부두임대 상세내역</h2> -->
                 	<div id="gamCntnrQuayUseExprInqireDetailForm">
