...
<%
  /**
  * @Class Name : GamMarineCenterPdRentfeeSttusInqire.jsp
  * @Description : 마린센터기간별사용료현황조회
 ...
 */
function GamMarineCenterPdRentfeeSttusInqireModule() {}

GamMarineCenterPdRentfeeSttusInqireModule.prototype = new EmdModule(1000, 600);

//페이지가 호출 되었을때 호출 되는 함수
GamMarineCenterPdRentfeeSttusInqireModule.prototype.loadComplete = function() {
 
 // 테이블 설정 //       
 this.$("#marineCenterPdRentfeeSttusInqireList").flexigrid({
     module: this,
     url: '<c:url value="/oper/center/gamSelectMarineCenterPdRentfeeSttusInqireList.do"/>',
     dataType: 'json',
     colModel : [
...
this.$("#marineCenterPdRentfeeSttusInqireList").on("onItemSelected", function(event, module, row, grid, param) {
...
* 정의 된 버튼 클릭 시
*/
GamMarineCenterPdRentfeeSttusInqireModule.prototype.onButtonClick = function(buttonId) {
...
GamMarineCenterPdRentfeeSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
...
GamMarineCenterPdRentfeeSttusInqireModule.prototype.onSubmit = function() {
 //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

 this.loadData();
};

GamMarineCenterPdRentfeeSttusInqireModule.prototype.loadData = function() {
 var searchOpt=this.makeFormArgs('#gamMarineCenterPdRentfeeSttusInqireSearchForm');
 //this.showAlert(searchOpt);
 this.$('#marineCenterPdRentfeeSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamMarineCenterPdRentfeeSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
 switch(newTabId) {
 case 'tabs1':
     break;
 case 'tabs2':
...
var module_instance = new GamMarineCenterPdRentfeeSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamMarineCenterPdRentfeeSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">마린센터기간별사용료현황</a></li>
            </ul>
            <div id="tabs1" class="emdTabPage" data-onactivate="onShowTab1Activate">
            <table id="marineCenterPdRentfeeSttusInqireList" style="display:none" class="fillHeight"></table>
            <!-- 
