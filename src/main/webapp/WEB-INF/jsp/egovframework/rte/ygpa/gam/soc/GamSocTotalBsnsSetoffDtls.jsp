...
**/
%>
GamSocTotalBsnsSetoffDtlsModule.prototype.validateDuration = function(startDate, endDate, startTitle, endTitle, startIgnore, endIgnore, equals) {
	var result = false;
...
GamSocTotalBsnsSetoffDtlsModule.prototype.onSubmit = function() {
	...
	if(!this.validateDuration(this.$('#sFrDt').val(), this.$('#sToDt').val(),  
			'처리기간 시작일', '처리기간 종료일', false, false, true)) {
		return;
	}
    this.loadData();
};
