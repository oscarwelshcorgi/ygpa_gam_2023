...
<%
  /**
  * @Class Name : GamFcltyUseRealloadInqire.jsp
  * @Description : 항만시설사용실적조회 테스트 (Prototype)
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">사용실적조회</a></li>
				<li><a href="#tabs2" class="emdTab">시설상세</a></li>
				<li><a href="#tabs3" class="emdTab">시설사진</a></li>
			</ul>
