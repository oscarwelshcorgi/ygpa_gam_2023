                ...
                <table style="width:100%;" class="searchPanel">
                    <tbody>
						...
						<tr>    
							<th>요금종류</th>
                            <td>
                                <input type="text" size="7" id="sFeeTp" maxlength="10" readonly/>
                                <input type="text" size="10" id="sFeeTpNm" disabled/>
                        ...
                        <tr>            
                        	<th>신청업체</th>
                            <td>
                                <input type="text" size="7" id="sAppAgentCode" maxlength="10" readonly/>
                                <input type="text" size="10" id="sAppAgentNm" disabled/>
