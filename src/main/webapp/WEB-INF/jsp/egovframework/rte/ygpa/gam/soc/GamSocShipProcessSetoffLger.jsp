...
GamSocShipProcessSetoffLgerModule.prototype.loadComplete = function() {
    ...
    this.$("#socShipProcessSetoffLgerList").flexigrid({
        module: this,
        url: '/soc/gamSocShipProcessSetoffLgerList.do',
        dataType: 'json',
        colModel : [
...
**/
%>
GamSocShipProcessSetoffLgerModule.prototype.validateDuration = function(startDate, endDate, startTitle, endTitle, startIgnore, endIgnore, equals) {
	var result = false;
    	               	...
    	               	<table style="width:100%;" class="summaryPanel">
							...
							<tr>
								...
								<td style="text-align:right;" colspan="9">
    	                        	<button data-role="printPage" data-search-option="gamSocShipProcessSetoffLgerSearchForm" data-url='/soc/gamSelectSocShipProcessSetoffLgerListPrint.do'>인쇄</button>
        	                    </td>
							</tr>
						</table>
					</form>
