...
<%
/**
 * @Class Name : GamMachFcltyDrwList.jsp
...
<%
/**
 * @FUNCTION NAME : GamMachFcltyDrwListModule
 * @DESCRIPTION   : MODULE 고유 함수
 * @PARAMETER     : NONE
**/
%>
function GamMachFcltyDrwListModule() {}

GamMachFcltyDrwListModule.prototype = new EmdModule(1000, 620);
...
**/
%>
GamMachFcltyDrwListModule.prototype.loadComplete = function(params) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.onAtchFileDirTreeItemClick = function(itemId) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.onClosePopup = function(popupId, msg, value) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.onButtonClick = function(buttonId) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.selectFileData = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.displayAtchFileDirectory = function(argDirNo) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.refreshDirData = function(argDirNo) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.addAtchFileDirectory = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.renameAtchFileDirectory = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.removeAtchFileDirectory = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.displayAtchFileList = function(argAtchFileDirNo) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.refreshFileData = function(argAtchFileNo) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.selectAllFile = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.saveUploadFileData = function(argAtchFileFcltsMngNo, argAtchFileFcltsDirNo, argAtchFileFcltsJobSe, argAtchFileFcltsDataSe, argAtchFileFcltsMngSeq, argAtchFileNmLogic, argAtchFileNmPhysicl) {
...
**/
%>
GamMachFcltyDrwListModule.prototype.uploadFile = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.downloadFile = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.downloadMultiFile = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.deleteFileData = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.deleteMultiFileData = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.displayPreviewFile = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.showFcltsAtchFileViewPopup = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.enableFileButtonItem = function() {
...
**/
%>
GamMachFcltyDrwListModule.prototype.disableFileButtonItem = function() {
...
var module_instance = new GamMachFcltyDrwListModule();
