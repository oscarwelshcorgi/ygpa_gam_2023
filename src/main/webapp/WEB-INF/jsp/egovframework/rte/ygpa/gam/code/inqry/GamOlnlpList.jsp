...
<%
  ...
  * @Description : 공시지가 조회 테스트 (Prototype)
...
GamAssetCodeListModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'GIS 자산 SUB 코드', name:'GIS_ASSETS_SUB_CD',width:200, sortable:false,align:'center'},
			{display:'공시지가 순번',name:'OLNLP_SEQ',width:160,sortable:false,align:'center'},
			{display:'공시지가 유효 시작 일자',name:'OLNLP_SEQ',width:160,sortable:false,align:'center'},
			{display:'공시지가 유효 종료 일자',name:'OLNLP_SEQ',width:160,sortable:false,align:'center'},
			{display:'공시지가 금액',name:'OLNLP_SEQ',width:160,sortable:false,align:'center'},
