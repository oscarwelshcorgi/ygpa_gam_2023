...
<%
  /**
  * @Class Name : GamCntnrQuayAearDtaInqire.jsp
  * @Description : 컨테이너부두미수납자료조회 테스트 (Prototype)
...
GamAssetCodeListModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'수납 구분',name:'RCIV_SE',width:160,sortable:false,align:'center'},
			{display:'징수 의뢰 수납 일자',name:'RCIV_DT',width:240,sortable:false,align:'center'}
			],
/* 		searchitems : [
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">미수납자료조회</a></li>
