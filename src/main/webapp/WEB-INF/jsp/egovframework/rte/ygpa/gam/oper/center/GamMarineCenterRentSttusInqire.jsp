...
GamMarineCenterRentSttusInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#marineCenterRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#marineCenterRentListTab").tabs("option", {active: 1});
    });
...
GamMarineCenterRentSttusInqireModule.prototype.loadRentList = function() {
    this.$("#marineCenterRentListTab").tabs("option", {active: 0});
...
GamMarineCenterRentSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#marineCenterRentSttusInqireList').selectedRows()[0];
...
GamMarineCenterRentSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#marineCenterRentSttusInqireList').selectedRows()[0];

    this.$('#marineCenterRentSttusInqireFileList').flexOptions({params:row}).flexReload();
};
...
GamMarineCenterRentSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#marineCenterRentSttusInqireList').selectedRowCount()==0) {
