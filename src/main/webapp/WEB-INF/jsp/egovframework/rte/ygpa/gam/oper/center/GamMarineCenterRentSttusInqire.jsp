...
<%
  /**
  * @Class Name : GamMarineCenterRentSttusInqire.jsp
 ...
 */
function GamMarineCenterRentSttusInqireModule() {}

GamMarineCenterRentSttusInqireModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamMarineCenterRentSttusInqireModule.prototype.loadComplete = function() {
    ...
    // 자산임대상세 테이블 설정
    this.$("#marineCenterRentSttusInqireDetailList").flexigrid({
        module: this,
        url: '<c:url value="/oper/center/gamSelectMarineCenterRentSttusInqireDetailList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#marineCenterRentSttusInqireList").on('onItemSelected', function(event, module, row, grid, param) {
        module.$('#cmd').val('modify');

        module.$('#gamMarineCenterRentSttusInqireForm :input').val('');

        module.makeFormValues('#gamMarineCenterRentSttusInqireForm', row);
        module._editData=module.getFormValues('#gamMarineCenterRentSttusInqireForm', row);
        module._editRow=module.$('#marineCenterRentSttusInqireList').selectedRowIds()[0];
        ...
        var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireForm');
        module.$('#marineCenterRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
        module.$('#marineCenterRentSttusInqireFileList').flexOptions({params:searchOpt}).flexReload();
        
        //this._deleteDataFileList=[]; //삭제파일목록 초기화
    });

    this.$("#marineCenterRentSttusInqireDetailList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.$('#btnApplyGisAssetsCode').prop('disabled', false);
        module.$('#gamMarineCenterRentSttusInqireDetailForm :input').val('');
        
        module.makeFormValues('#gamMarineCenterRentSttusInqireDetailForm', row);
        module._editData=module.getFormValues('#gamMarineCenterRentSttusInqireDetailForm', row);
        module._editRow=module.$('#marineCenterRentSttusInqireDetailList').selectedRowIds()[0];
    });
    
    this.$("#marineCenterRentSttusInqireFileList").on('onItemSelected', function(event, module, row, grid, param) {
        module.makeFormValues('#gamMarineCenterRentSttusInqireFileForm', row);
        module._editDataFile=module.getFormValues('#gamMarineCenterRentSttusInqireFileForm', row);
        module._editRowFile=module.$('#marineCenterRentSttusInqireFileList').selectedRowIds()[0];
    ...
    this.$("#marineCenterRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
    ...
    this.$("#marineCenterRentSttusInqireDetailList").on('onItemDoubleClick', function(event, module, row, grid, param) {
...
GamMarineCenterRentSttusInqireModule.prototype.onCalc = function() {
 ...
 * 정의 된 버튼 클릭 시
 */
 GamMarineCenterRentSttusInqireModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        // 최초신청
        case 'addMarineCenterRentSttusInqireFirst':
            this.$("#assetRentListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            this.$('#gamMarineCenterRentSttusInqireForm').find(':input').val('');
            this.$('#gamMarineCenterRentSttusInqireDetailForm').find(':input').val('');
            this.$('#gamMarineCenterRentSttusInqireFileForm').find(':input').val('');
            
            //this.$("#marineCenterRentSttusInqireDetailList").flexRemove();
            this.$("#marineCenterRentSttusInqireDetailList").flexAddData({resultList:[]}); //그리드 초기화
            this.$("#marineCenterRentSttusInqireFileList").flexAddData({resultList:[]}); //그리드 초기화
            this.$("#cmd").val('insert');
        ...
        // 연장신청
        case 'addMarineCenterRentSttusInqireRenew':
            var rows = this.$('#marineCenterRentSttusInqireList').selectedRows();
            ...
            if(rows.length>=1) {
                ...
                if( confirm("연장신청을 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentSttusInqireRenew.do" />', rows[0], function(module, result) {

                        if(result.resultCode=='0') {
                            var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireSearchForm');
                            module.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                        }
        ...
        case 'btnSaveItem':
            ...
            if( confirm("저장하시겠습니까?") ) {
                ...
                //this._editData=this.getFormValues('#gamMarineCenterRentSttusInqireDetailForm', this._editData);

                inputVO[inputVO.length]={name: 'updateList', value :JSON.stringify(this.$('#marineCenterRentSttusInqireDetailList').selectFilterData([{col: '_updtId', filter: 'U'}])) };

                inputVO[inputVO.length]={name: 'insertList', value: JSON.stringify(this.$('#marineCenterRentSttusInqireDetailList').selectFilterData([{col: '_updtId', filter: 'I'}])) };
                ...
                inputVO[inputVO.length]={name: 'updateFileList', value :JSON.stringify(this.$('#marineCenterRentSttusInqireFileList').selectFilterData([{col: '_updtId', filter: 'U'}])) };

                inputVO[inputVO.length]={name: 'insertFileList', value: JSON.stringify(this.$('#marineCenterRentSttusInqireFileList').selectFilterData([{col: '_updtId', filter: 'I'}])) };

                inputVO[inputVO.length]={name: 'deleteFileList', value: JSON.stringify(this._deleteDataFileList) };
                
                //var otherForm=this.getFormValues('#gamMarineCenterRentSttusInqireForm', {});  // 폼만 있을 경우

                this._editData2=this.getFormValues('#gamMarineCenterRentSttusInqireForm', {_updtId:'I'});
                inputVO[inputVO.length]={name: 'form', value: JSON.stringify(this._editData2) };    // 폼의 데이터를 컨트롤러에 보낸다.

                //console.log(inputVO);
                // 데이터를 저장 하고 난 뒤 리스트를 다시 로딩 한다.

                this.doAction('<c:url value="/oper/center/gamSaveMarineCenterRentSttusInqire.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireForm');
                        module.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                        //module.$('#marineCenterRentSttusInqireDetailList').flexReload();
                        module.$('#marineCenterRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                        module.$('#marineCenterRentSttusInqireFileList').flexOptions({params:searchOpt}).flexReload();
                    }
                    alert(result.resultMsg);
        ...
        case 'btnRemoveItem':
            ...
            if(rows.length == 0) {
                ...
                if( confirm("신청삭제를 하시겠습니까?") ) {
                    ...
                    var inputVO=this.makeFormArgs('#gamMarineCenterRentSttusInqireForm');

                    this.doAction('<c:url value="/oper/center/gamDeleteMarineCenterRentSttusInqire.do" />', inputVO, function(module, result) {
                    ...
                    this.$("#assetRentListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
                    this.$('#gamMarineCenterRentSttusInqireForm :input').val("");
                    this.$("#cmd").val('insert');
                }
            }
        ...
        case 'btnSaveComment':
            ...
            this.doAction('<c:url value="/oper/center/gamUpdateMarineCenterRentSttusInqireComment.do" />', inputVO, function(module, result) {
                if(result.resultCode=='0') {
                    var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireSearchForm');
                    module.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                }
        ...
        case 'btnInsertItemDetail':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this._editData=this.getFormValues('#gamMarineCenterRentSttusInqireDetailForm', {_updtId:'I'});
                this._editRow=this.$('#marineCenterRentSttusInqireDetailList').flexGetData().length;
            }
        ...
        case 'btnRemoveItemDetail':
            var rows = this.$('#marineCenterRentSttusInqireDetailList').selectedRows();

            if(rows.length == 0) {
                alert("자산임대상세목록에서 삭제할 행을 선택하십시오.");
            } else {
                if(this.$('#marineCenterRentSttusInqireDetailList').selectedRowIds().length>0) {
                    for(var i=this.$('#marineCenterRentSttusInqireDetailList').selectedRowIds().length-1; i>=0; i--) {
                        var row=this.$('#marineCenterRentSttusInqireDetailList').flexGetRow(this.$('#marineCenterRentSttusInqireDetailList').selectedRowIds()[i]);

                        if(row._updtId==undefined || row._updtId!='I') {
                            this._deleteDataList[this._deleteDataList.length]=row;  // 삽입 된 자료가 아니면 DB에 삭제를 반영한다.
                        }
                        this.$('#marineCenterRentSttusInqireDetailList').flexRemoveRow(this.$('#marineCenterRentSttusInqireDetailList').selectedRowIds()[i]);
                    }
                }
            }
        ...
        case 'btnSaveItemDetail':
            ...
            var inputVO=this.makeFormArgs('#gamMarineCenterRentSttusInqireDetailForm');


            if(this.$("#detailCmd").val()=='insert') {

                this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentSttusInqireDetail.do" />', {aaa : "rrrrrrrrrrrrrr"}, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/center/gamUpdateMarineCenterRentSttusInqireDetail.do" />', inputVO, function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireForm');
                        module.$('#marineCenterRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'btnPrmisn': // 사용승낙
            ...
            if(rows.length>=1) {
                ...
                this.doExecuteDialog('insertMarineCenterRentSttusInqirePrmisnPopup', '승낙', '<c:url value="/oper/center/popup/showMarineCenterRentSttusInqirePrmisn.do"/>', opts);
        ...
        case 'btnPrmisnCancel': // 승낙취소
            ...
            if(rows.length>=1) {
                if( confirm("승낙취소를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/center/gamUpdateMarineCenterRentSttusInqirePrmisnCancel.do" />', rows[0], function(module, result) {
                        if(result.resultCode=='0') {
                            var searchOpt=module.makeFormArgs('#gamMarineCenterRentSttusInqireForm');
                            module.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                        }
        ...
        case 'btnRentSttusInqireDetailApply': //임대상세적용
            ...
            if(this._editRow!=null) {  // 이전에 _updtId 로 선택 한 것을 _editRow 로 변경 2014-03-14.001
                ...
                this.$('#marineCenterRentSttusInqireDetailList').flexUpdateRow(this._editRow, this._editData);
                this._editRow=null;    // 편집 저장 하였으므로 로우 편집을 종료 한다.
            }
            else {
                this.$('#marineCenterRentSttusInqireDetailList').flexAddRow(this._editData);
            }
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
                ...
                $.each(result, function(){
                    //module.$('#marineCenterRentSttusInqireFileList').flexAddRow({photoSj: '', filenmLogical: this.logicalFileNm, filenmPhyicl: this.physcalFileNm, regUsr: userid, registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
                    //module.$('#marineCenterRentSttusInqireFileList').flexAddRow({prtAtCode: '', mngYear: '', mngNo: '', mngCnt: '', photoSeq: '', photoSj: '', filenmLogic: this.logicalFileNm, filenmPhysicl: this.physcalFileNm, shotDt: '', photoDesc: '', regUsr: '', registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
                    module.$('#marineCenterRentSttusInqireFileList').flexAddRow({_updtId:'I', prtAtCode: '', mngYear: '', mngNo: '', mngCnt: '', photoSeq: '', photoSj: '', filenmLogic: this.logicalFileNm, filenmPhysicl: this.physcalFileNm, shotDt: '', photoDesc: '', regUsr: '', registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
                });
            }, '첨부파일 업로드');
            
            //this._editDataFile=this.getFormValues('#gamMarineCenterRentSttusInqireFileForm', {_updtId:'I'});
            //this._editRowFile=this.$('#marineCenterRentSttusInqireFileList').flexGetData().length;
        ...
        case 'btnApplyPhotoData':
            ...
            this._editDataFile=this.getFormValues('#gamMarineCenterRentSttusInqireFileForm', this._editDataFile);
            ...
            if(this._editRowFile!=null) {  // 이전에 _updtId 로 선택 한 것을 _editRowFile 로 변경 2014-03-14.001
                ...
                this.$('#marineCenterRentSttusInqireFileList').flexUpdateRow(this._editRowFile, this._editDataFile);
                this._editRowFile=null;    // 편집 저장 하였으므로 로우 편집을 종료 한다.
            }
            else {
                this.$('#marineCenterRentSttusInqireFileList').flexAddRow(this._editDataFile);
            }
        ...
        // 파일 삭제 (Grid상에서만 삭제됨)
        case 'btnRemoveFile':
            var rows = this.$('#marineCenterRentSttusInqireFileList').selectedRows();

            if(rows.length == 0) {
                alert("파일목록에서 삭제할 행을 선택하십시오.");
            } else {
                if(this.$('#marineCenterRentSttusInqireFileList').selectedRowIds().length>0) {
                    for(var i=this.$('#marineCenterRentSttusInqireFileList').selectedRowIds().length-1; i>=0; i--) {
                        var row=this.$('#marineCenterRentSttusInqireFileList').flexGetRow(this.$('#marineCenterRentSttusInqireFileList').selectedRowIds()[i]);
                        ...
                        this.$('#marineCenterRentSttusInqireFileList').flexRemoveRow(this.$('#marineCenterRentSttusInqireFileList').selectedRowIds()[i]);
                    }
                }
            }
        ...
        case 'btnDownloadFile':
    		var selectRow = this.$('#marineCenterRentSttusInqireFileList').selectedRows();
...
GamMarineCenterRentSttusInqireModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamMarineCenterRentSttusInqireModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamMarineCenterRentSttusInqireSearchForm');
    //this.showAlert(searchOpt);
    this.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamMarineCenterRentSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
        var row = this.$('#marineCenterRentSttusInqireList').selectedRows();
        if(row.length==0) {
            this.$('#cmd').val('insert');
        }
        else {
        ...
        break;
    case 'tabs3':
        var row = this.$('#marineCenterRentSttusInqireDetailList').selectedRows();
        if(row.length==0) {
            this.$('#detailCmd').val('insert');
        }
        else {
...
GamMarineCenterRentSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
     ...
     case 'insertEntrpsInfoPopup':
         ...
         break;
     case 'insertMarineCenterRentSttusInqirePrmisnPopup':
         if (msg != 'cancel') {
             if( value == "0" ) {
                 var searchOpt=this.makeFormArgs('#gamMarineCenterRentSttusInqireSearchForm');
                 this.$('#marineCenterRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
...
var module_instance = new GamMarineCenterRentSttusInqireModule();
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamMarineCenterRentSttusInqireSearchForm">
        ...
        <div id="assetRentListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td style="text-align: right">
                                <!-- 
                                <button id="addMarineCenterRentSttusInqireFirst">최초신청</button>
                                ...
                                <button id="btnPrmisnCancel">승낙취소</button>
                                 -->
                                 <button id="addMarineCenterRentSttusInqireRenew">연장신청</button>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                <div class="emdControlPanel"></div>
                    <form id="gamMarineCenterRentSttusInqireForm">
                ...
                <div style="vertical-align: bottom; text-align: right;">
                 ...
                 <!-- <table id="marineCenterRentSttusInqireDetailList" style="display:none" class="fillHeight"></table> -->
                 <table id="marineCenterRentSttusInqireDetailList" style="display:none"></table>
            ...
            <div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItemDetail">저장</button></div>  -->
                    <form id="gamMarineCenterRentSttusInqireDetailForm">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <select id="applcTariff">
                                     ...
                                     -->
                                    <input id="applcTariff" class="ygpaCmmnCd calcInput" data-default-prompt="선택" onkeyup="$(this).trigger('change')" data-code-id=GAM023 disabled/>

                                    <input type="text" size="14" id="applcTariffStr" disabled/>
                            ...
                            <tr>
                                ...
                                <td><input type="text" size="20" class="ygpaCurrency" id="fee" disabled/>원</td>
                                <th><span class="label">감면사용료</span></th>
                                <td colspan="3"><input type="text" size="20" class="ygpaCurrency calcInput" id="rdcxptFee" onkeyup="$(this).trigger('change')" disabled/>원</td>
                            </tr>
                            <tr>
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <table id="marineCenterRentSttusInqireFileList" style="display:none" class="fillHeight"></table>
                ...
                <form id="gamMarineCenterRentSttusInqireFileForm">
