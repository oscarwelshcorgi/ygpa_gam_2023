...
<%
  /**
  * @Class Name : GamPlotSeCdMngt.jsp
  * @Description : 부지구분 코드관리 테스트 (Prototype)
...
GamAssetCodeModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'부두 그룹 영역 GIS 코드',name:'GIS_CD',width:160,sortable:false,align:'center'},
			{display:'부두 코드',name:'QUAY_CD',width:160,sortable:false,align:'center'},
			{display:'부두 영역 GIS코드',name:'GIS_CD',width:640,sortable:false,align:'center'},
			{display:'선석 시설 코드',name:'BERTH_CD',width:640,sortable:false,align:'center'},
			{display:'선석 영역 GIS 코드',name:'GIS_CD',width:640,sortable:false,align:'center'}
			],
/* 		searchitems : [
