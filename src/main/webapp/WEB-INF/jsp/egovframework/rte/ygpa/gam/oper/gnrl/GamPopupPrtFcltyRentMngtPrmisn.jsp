...
GamPopupPrtOperRentModule.prototype.onButtonClick = function(buttonId) {
	...
	case 'btnPrmisnExec':
		...
		if( confirm("승낙 하시겠습니까?") ) {
	        ...
	        //this.doAction('<c:url value="/oper/gnrl/gamInsertPrtFcltyRentMngtPrmisn.do" />', inputVO, function(module, result) {   
	        this.doAction('<c:url value="/oper/gnrl/gamUpdatePrtFcltyRentMngtPrmisn.do" />', inputVO, function(module, result) {   
