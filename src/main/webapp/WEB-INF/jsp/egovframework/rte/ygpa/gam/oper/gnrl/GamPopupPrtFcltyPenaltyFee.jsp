...
<%
  /**
  * @Class Name : GamPopupPrtFcltyPenaltyFee.jsp
 ...
 */
function GamPopupPrtFcltyPenaltyFeeModule() {}

GamPopupPrtFcltyPenaltyFeeModule.prototype = new EmdPopupModule(450, 126);

// 팝업이 호출 되었을때 호출 되는 함수
GamPopupPrtFcltyPenaltyFeeModule.prototype.loadComplete = function() {
...
GamPopupPrtFcltyPenaltyFeeModule.prototype.onButtonClick = function(buttonId) {
	switch(buttonId) {
...
GamPopupPrtFcltyPenaltyFeeModule.prototype.onSubmit = function() {
	//this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');
	this.loadData();
};

GamPopupPrtFcltyPenaltyFeeModule.prototype.loadData = function() {
	//var searchOpt=this.makeFormArgs('#gamPopupDisUseForm');
 	//this.$('#grdInfoList').flexOptions({params:searchOpt}).flexReload();
};

// 다음 변수는 고정 적으로 정의 해야 함
var popup_instance = new GamPopupPrtFcltyPenaltyFeeModule();
</script>
<div class="dialog">
	<div class="emdPanel">
