...
GamHtldUseExprInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#htldUseExprInqireList').selectedRows()[0];
...
GamHtldUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#htldUseExprInqireList').selectedRowCount()==0) {
