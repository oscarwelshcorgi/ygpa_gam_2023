...
<%
  /**
  * @Class Name : GamCivilMaintHistInqire.jsp
  * @Description : 유지보수이력조회 테스트 (Prototype)
...
GamAssetCodeListModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'운영자',name:'OPR_USR',width:640,sortable:false,align:'center'},
			{display:'운영자 직급',name:'OPR_USR_JOBLVL',width:640,sortable:false,align:'center'},
			{display:'운영자 명',name:'OPR_USR_NM',width:640,sortable:false,align:'center'},
			{display:'운영자 연락처',name:'OPR_USR_PHONE_NO',width:640,sortable:false,align:'center'},
			{display:'보수자',name:'RPR_USR',width:640,sortable:false,align:'center'},
			{display:'보수자 직급',name:'RPR_USR_JOBLVL',width:640,sortable:false,align:'center'},
			{display:'보수자 명',name:'RPR_USR_NM',width:640,sortable:false,align:'center'},
			{display:'보수자 연락처',name:'RPR_USR_PHONE_NO',width:640,sortable:false,align:'center'},
