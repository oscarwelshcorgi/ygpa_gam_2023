...
GamPopupSocApplyInfoModule.prototype.loadComplete = function() {
	...
	this.$("#grdInfoList").flexigrid({
		...
		colModel : [
					...
					{display:"항명",			name:"prtKorNm", 	width:40, 		sortable:true, 		align:"center"},
					{display:"준공년도",		name:"cmplYr", 		width:50, 		sortable:true, 		align:"center"},
					{display:"공사번호",		name:"constNo", 	width:50, 		sortable:true, 		align:"center"},
					...
					{display:"요청횟수",		name:"useNo", 		width:50, 		sortable:true, 		align:"center"},
					{display:"보전처리요청액",	name:"exmpAmnt", 	width:90, 		sortable:true, 		align:"center"},
					{display:"보전처리누계액",	name:"exmpAcc", 	width:90, 		sortable:true, 		align:"center"},
					...
					{display:"사용여부",		name:"useYn", 		width:50, 		sortable:true, 		align:"center"},
					{display:"공사명칭",		name:"item", 		width:100, 		sortable:true, 		align:"center"},
					{display:"특이사항",		name:"remark", 		width:150, 		sortable:true, 		align:"center"},
					{display:"신청일자",		name:"applDate", 	width:50, 		sortable:true, 		align:"center"}
			],
		height: "320"
	});
