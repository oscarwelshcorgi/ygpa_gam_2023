...
@media print {
  ...
  <c:if test="${arrrgItem!=null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/shed/printRentFeeSepNoticeIssue.do' />"/>
  </c:if>
  <c:if test="${arrrgItem==null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/shed/printRentFeeNoticeIssue.do' />"/>
  </c:if>
