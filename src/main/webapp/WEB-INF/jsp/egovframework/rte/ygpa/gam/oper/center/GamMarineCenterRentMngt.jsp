...
GamMarineCenterRentMngtModule.prototype = new EmdModule(910, 550);
...
GamMarineCenterRentMngtModule.prototype.loadComplete = function() {
    ...
    this.$("#marineCenterRentMngtList").flexigrid({
        module: this,
        url: '<c:url value="/oper/center/selectMarineCenterRentList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#marineCenterRentDetailList").flexigrid({
        module: this,
        url: '<c:url value="/oper/center/selectMarineCenterRentDetailList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#marineCenterRentMngtList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        // 이벤트내에선 모듈에 대해 선택한다.
        module.$("#marineCenterRentListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
    ...
    this.$("#marineCenterRentDetailList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        // 이벤트내에선 모듈에 대해 선택한다.
        module.$("#marineCenterRentListTab").tabs("option", {active: 2});    // 탭을 전환 한다.
 ...
 GamMarineCenterRentMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'addMarineCenterRentFirst':
            this.$("#marineCenterRentListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            //this.$(":input").val('');
        ...
        case 'btnSaveItem':
            ...
            if(this.$("#cmd").val()=='insert') {
            	...
            	this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentFirst.do" />', inputVO, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/center/gamUpdateMarineCenterRent.do" />', inputVO, function(module, result) {
                	if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamMarineCenterRentForm');
                        module.$('#marineCenterRentMngtList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnRemoveItem':
            if( this.$('#cmd').val() == 'modify' ) {
                ...
                this.$("#marineCenterRentListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
                this.$('#gamMarineCenterRentForm :input').val("");
                this.$("#cmd").val('insert');
        ...
        case 'btnInsertItemDetail':
        	...
        	if( this.$('#prtAtCode').val() == '' ) {
        		...
        		this.$("#marineCenterRentListTab").tabs("option", {active: 2});  // 탭을 전환 한다.
                this.$('#gamMarineCenterRentDetailForm :input').val("");
        ...
        case 'btnRemoveItemDetail':
            ...
            if(rows.length>=1) {
                this.doAction('<c:url value="/oper/center/gamDeleteMarineCenterRentDetail.do" />', rows[0], function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamMarineCenterRentForm');
                        module.$('#marineCenterRentDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnSaveItemDetail':
            ...
            if(this.$("#detailCmd").val()=='insert') {
                ...
                this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentDetail.do" />', inputVO, function(module, result) {
...
<div class="window_main">
    ...
    <div class="emdPanel">
        <div id="marineCenterRentListTab" class="emdTabPanel" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">마린센터임대 조회내역</a></li>
                <li><a href="#tabs2" class="emdTab">마린센터임대 상세조회 목록내역</a></li>
                <li><a href="#tabs3" class="emdTab">마린센터임대 상세조회내역</a></li>
                <li><a href="#tabs4" class="emdTab">사진</a></li>
            </ul>

            <div id="tabs1" class="emdTabPage" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <div style="width: 100%; height: 100%; overflow:auto">
                        <table id="marineCenterRentMngtList" style="display:none"></table>
                </div>
                    ...
                    <form id="gamMarineCenterRentDetailForm">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <select id="quayCd">
                                        <option value="X" selected="selected">마린센터</option>
                                    </select>
                                    <!-- 
                                    <select id="quayCd">
                                        <option value="" selected="selected">선택</option>
