...
/*                     alert("결재완료 상태가 아닙니다.");
                ...
                this.doExecuteDialog('insertAssetRentPrmisnPopup', '승낙', '<c:url value="/oper/center/popup/showMarineCenterRentPrmisn.do"/>', opts);
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
        ...
        case 'btnMarineCenterRentMngtListExcelDownload':	// 엑셀 다운로드
        	this.$('#assetRentMngtList').flexExcelDown('<c:url value="/oper/center/selectMarineCenterRentMngtListExcel.do"/>');
            break;
    }
};
