 ...
 */
	...
	this.$("#fcltyPhotoList").flexigrid({
		module: this,
		url: '/fclty/gamMechFcltyPhotoList.do',
		dataType: 'json',
		colModel : [
...
// 			this.$("#prtFcltyChangeDt").val(this.$("#prtFcltyChangeDt").val().replace(/\-/g,""));
		...
		case 'btnSaveFile':	// 저장
			if( confirm("사진 목록을 저장하시겠습니까?") ) {
			    ...
			    this.doAction('/fclty/mergeGamMechFcltyPhotoMngt.do', inputVO, function(module, result) {
			        if(result.resultCode == 0){
				...
				this.$("#prtFcltySeNm").hide();
		 		if(this._params.action!=null || this._params.action=='prtFcltyMngt') {
		 			var prtFclty = [
		 	     	 	...
		 	     	 	this.doAction('/fclty/gamMechFcltyDetail.do', prtFclty, function(module, result) {
