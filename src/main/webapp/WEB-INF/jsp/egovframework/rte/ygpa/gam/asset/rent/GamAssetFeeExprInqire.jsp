...
GamAssetFeeExprInqireModule.prototype.loadRentList = function() {
...
GamAssetFeeExprInqireModule.prototype.loadDetailForm = function() {
...
GamAssetFeeExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#assetFeeExprInqireList').selectedRowCount()==0) {
