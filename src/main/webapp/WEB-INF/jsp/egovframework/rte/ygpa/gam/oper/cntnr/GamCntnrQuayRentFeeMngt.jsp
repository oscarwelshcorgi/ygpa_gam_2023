    ...
    switch(buttonId) {
        ...
        case 'btnNticIssuePrint2':	// 고지서 출력
            if(this.$('#assetRentFeeList').selectedRowCount()>0) {
                ...
                this.printPayNotice('/oper/cntnr/printRentFeeNotice.do', rows);
            } else {
        ...
        case 'btnTaxPrint2':	// 계산서 출력
            if(this.$('#assetRentFeeList').selectedRowCount()>0) {
                ...
                this.printTaxNotice('/oper/cntnr/printCntnrQuayRentFeeTaxNotice.do', rows);
            } else {
            	alert("목록에서 고지서를 출력 할 항목을 선택하십시오.");
            	return;
            }
        ...
        case 'btnCntnrQuayRentFeeMngtListExcelDownload':	// 엑셀 다운로드
        	this.$('#assetRentFeeList').flexExcelDown('/oper/cntnr/selectCntnrQuayRentFeeMngtListExcel.do');
            	break;
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
                <li><a href="#tabs1" class="emdTab">컨테이너부두임대 사용료고지 목록</a></li>
                <li><a href="#tabs2" class="emdTab">컨테이너부두임대 사용료고지 상세</a></li>
            </ul>
