...
GamTrainPortUseExprInqireModule.prototype.loadUseList = function() {
...
GamTrainPortUseExprInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#trainPortUseExprInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamTrainPortUseExprInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('<c:url value="/oper/train/gamSelectTrainPortUseExprInqireDetailList.do" />', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamTrainPortUseExprInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamTrainPortUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#trainPortUseExprInqireList').selectedRowCount()==0) {
    ...
    <div class="emdPanel fillHeight">
        <div id="trainPortUseExprInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                	...
                	<!-- <h2>철송장임대 내역</h2> -->
                	<div id="gamTrainPortUseExprInqireForm">
                	...
                	<!-- <h2>철송장임대 상세내역</h2> -->
                 	<div id="gamTrainPortUseExprInqireDetailForm">
