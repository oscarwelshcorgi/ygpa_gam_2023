...
GamTrainPortUseExprInqireModule.prototype.loadComplete = function() {
    this.$("#trainPortUseExprInqireList").flexigrid({
        module: this,
        url: '/oper/train/gamSelectTrainPortUseExprInqireList.do',
        dataType: 'json',
        colModel : [
...
GamTrainPortUseExprInqireModule.prototype.loadDetailForm = function() {
		...
		this.makeDivValues('#gamTrainPortUseExprInqireForm', row); // 결과값을 채운다.
   	 	...
   	 	this.doAction('/oper/train/gamSelectTrainPortUseExprInqireDetailList.do', detailParam, function(module, result) {
