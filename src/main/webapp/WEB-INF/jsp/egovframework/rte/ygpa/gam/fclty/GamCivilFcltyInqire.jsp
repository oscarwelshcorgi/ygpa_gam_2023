...
<div class="window_main">
	...
	<div class="emdPanel">
		<div class="viewStack">
			<form id="fcltyForm">
				<input type="hidden" id="uniqFcltyCd" value="AD" />
				<table class="searchPanel">
					<tbody>
						<tr>
							...
							<th>항만시설코드</th>
							<td>
								<input id="searchFcltyCd" type="text" size="2" maxlength="2" title="검색조건" value="AD" disabled="disabled"/>&nbsp;-&nbsp;
				...
				<form id="fcltyManageVO">
					...
					<table class="searchPanel">
						...
						<tr>
							...
							<td><input type="text" size="27" id="prtFcltyMngEntrpsCd" disabled="disabled"/></td>
						</tr>
						<tr>
