...
GamInfoCommFcltySpecMngModule.prototype.onButtonClick = function(buttonId) {
	...
	switch (buttonId) {
		...
		case 'btnExcelFormDownload':
			window.open("<c:url value='/form/gamInfoCommFcltySpecMng.xlsx' />", '_blank');
			break;
		...
		case 'btnSpecRemove':
			...
			break;
		case 'popupSearchFcltsMngGroupNo':
			this.doExecuteDialog(buttonId, "시설물 관리 그룹 선택", '/popup/showInfoCommFcltsMngGroup.do', null);
			break;
		case 'popupSpecGisAssetsCd':
...
**/
%>
GamInfoCommFcltySpecMngModule.prototype.selectFileData = function() {
...
**/
%>
 GamInfoCommFcltySpecMngModule.prototype.copyData = function() {
...
**/
%>
GamInfoCommFcltySpecMngModule.prototype.hideFcltyMaintMngList = function() {
...
**/
%>
GamInfoCommFcltySpecMngModule.prototype.showFcltyMaintMngList = function(argParent) {
...
**/
%>
GamInfoCommFcltySpecMngModule.prototype.buildFcltyMaintMngList = function() {
	...
	var searchVO = [{ name: 'fcltsMngGroupNo', value: this.$('#fcltsMngGroupNo').val() },
					{ name: 'fcltsJobSe', value: "I" },
	                { name: 'fcltsMngNo', value: this.$('#fcltsMngNo').val() }
	               ];
	this.doAction('/fclty/gamSelectInfoCommFcltySpecMngMntnRprDtlsList.do', searchVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length <= 0) {
	...
	<div class="emdPanel fillHeight">
		...
		<div id="mainTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
			...
			<ul>
				...
				<li><a href="#fileTab" class="emdTab">정보통신시설 설계도서</a></li>
			</ul>
			<!-- 212. TAB 1 AREA (LIST) -->
					...
					<form id="listSumForm">
						<table style="width:100%;">
							<tr>
								...
								<td><input type="text" size="12" id="sumAcqAmt" class="ygpaNumber" disabled="disabled"/></td>
								<td style="text-align:right;">
									...
									<button id="btnShowMap" data-role="showMap" data-gis-layer="gisTeleFclty" data-flexi-grid="mainGrid" data-style="default">맵조회</button>
									<button id="btnEditMap" data-role="editMap" data-gis-layer="gisTeleFclty">맵편집</button>
					...
					<form id="detailForm">
						...
						<table class="detailPanel" style="width:100%;">
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" size="149" id="stndrd" maxlength="80"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="3">
									<input type="text" size="149" id="ctrlMthd" maxlength="50"/>
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td>
									<input type="text" size="58" id="instlHt" class="ygpaNumber" data-decimal-point="2" maxlength="10"/> m
								</td>
								<th style="width:10%; height:18px;">제　조　일　자</th>
								<td>
									<input type="text" size="58" id="instlDt" class="emdcal"/>
								</td>
							</tr>
							<tr>
								<th style="width:10%; height:18px;">수　　　　　량</th>
								<td>
									<input type="text" size="58" id="qy" class="ygpaNumber" maxlength="6"/> 개
								</td>
								<th style="width:10%; height:18px;">취　득　금　액</th>
								<td>
									<input type="text" size="58" id="acqAmt" class="ygpaNumber" maxlength="20"/> 원
								</td>
							</tr>
							<tr>
