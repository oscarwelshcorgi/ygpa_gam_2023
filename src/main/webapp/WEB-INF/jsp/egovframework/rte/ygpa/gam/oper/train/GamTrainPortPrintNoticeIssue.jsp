...
@media print {
  ...
  <c:if test="${arrrgItem!=null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/train/printRentFeeSepNoticeIssue.do' />"/>
  </c:if>
  <c:if test="${arrrgItem==null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/train/printRentFeeNoticeIssue.do' />"/>
  </c:if>
