...
<%
  /**
  * @Class Name : GamCntnrRentFeeMngt.jsp
 ...
 */
function GamCntnrRentFeeMngtModule() {}

GamCntnrRentFeeMngtModule.prototype = new EmdModule(1000, 550);

// 페이지가 호출 되었을때 호출 되는 함수
GamCntnrRentFeeMngtModule.prototype.loadComplete = function() {

    // 테이블 설정 //       
    this.$("#operResultList").flexigrid({
        module: this,
        url: '<c:url value="/oper/cntnr/gamSelectCntnrRentFeeMngtList.do" />',
        dataType: 'json',
        colModel : [
 ...
 * 정의 된 버튼 클릭 시
 */
 GamCntnrRentFeeMngtModule.prototype.onButtonClick = function(buttonId) {

    switch(buttonId) {

        // 조회
        case 'searchBtn':
            var searchOpt=this.makeFormArgs('#gamCntnrRentFeeMngtSearchForm');
        ...
        case 'btnSaveItem':
        	if( this.$('#prtAtCode').val() == '' ) {
	        	...
	        	var inputVO=this.makeFormArgs('#gamCntnrRentFeeMngtForm');
	        	
	        	this.doAction('<c:url value="/oper/cntnr/gamUpdateCntnrRentFeeMngt.do" />', inputVO, function(module, result) {
	
	                if(result.resultCode=='0') {
	                    var searchOpt=module.makeFormArgs('#gamCntnrRentFeeMngtSearchForm');
         ...
         // 취소
        case 'btnCancelItem':
            this.$('#gamCntnrRentFeeMngtForm :input').val("");
            break;
        ...
        case 'saveNticListBtn':
            ...
            if(reglist.length > 0){
                ...
                this.doAction('<c:url value="/oper/cntnr/gamInsertCntnrRentFeeMngtNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamCntnrRentFeeMngtSearchForm");
                        module.$("#operResultList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'cancelNticListBtn': 
            ...
            if(reglist.length > 0){
                ...
                var inputVO = {nticCnts: nticCnts, prtAtCodes: prtAtCodes, mngYears: mngYears, mngNos: mngNos, mngCnts: mngCnts, nticnos: nticnos, accnutYears: accnutYears };
                this.doAction('<c:url value="/oper/cntnr/gamDeleteCntnrRentFeeMngtNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamCntnrRentFeeMngtSearchForm");
                        module.$("#operResultList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'saveNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/cntnr/gamInsertCntnrRentFeeMngtNticSingle.do" />', inputVO, function(module, result) {
        ...
        case 'cancelNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/cntnr/gamDeleteCntnrRentFeeMngtNticSingle.do" />', inputVO, function(module, result) {
...
GamCntnrRentFeeMngtModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamCntnrRentFeeMngtModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamCntnrRentFeeMngtSearchForm');
    //this.showAlert(searchOpt);
    this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
};

GamCntnrRentFeeMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
...
GamCntnrRentFeeMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
...
var module_instance = new GamCntnrRentFeeMngtModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCntnrRentFeeMngtSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">컨테이너부두임대료 목록내역</a></li>
                <li><a href="#tabs2" class="emdTab">컨테이너부두임대료 상세조회내역</a></li>
            </ul>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                ...
                <div class="emdControlPanel">
                    ...
                    <form id="gamCntnrRentFeeMngtForm">
