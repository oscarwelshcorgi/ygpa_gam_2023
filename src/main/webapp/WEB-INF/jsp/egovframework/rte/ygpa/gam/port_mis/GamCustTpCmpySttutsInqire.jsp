...
<%
  ...
  * @Description : 항만시설사용목록관리  테스트 (Prototype)
...
GamAssetEvlDtlsInqiryModule.prototype.loadComplete = function() {
	...
	this.$("#assetEvlDtlsList").flexigrid({
		...
		colModel : [
				...
				{display:'자산 명', name:'ASSETS_NM',width:160, sortable:false,align:'center'},
				{display:'소재지',name:'LOCPLC',width:100,sortable:false,align:'center'},
				{display:'지번',name:'LNM',width:100,sortable:false,align:'center'},
				{display:'지번SUB',name:'LNM_SUB',width:100,sortable:false,align:'center'},
				{display:'면적',name:'AR',width:100,sortable:false,align:'center'},
				{display:'자산가액',name:'VAL_AMOUNT',width:100,sortable:false,align:'center'},
				{display:'취득가액',name:'REC_AMOUNT',width:100,sortable:false,align:'center'},
				{display:'평가기관',name:'VAL_AGENT',width:100,sortable:false,align:'center'},
				{display:'평가일자',name:'VAL_DT',width:100,sortable:false,align:'center'},
				{display:'자산 구분',name:'ASSETS_SE_CD',width:100,sortable:false,align:'center'},
				{display:'재산 구분',name:'PRPRTY_CD',width:100,sortable:false,align:'center'},
				{display:'출자 방식',name:'INVSTMNT_MTHD',width:100,sortable:false,align:'center'}
			],
/* 		searchitems : [
...
<div class="window_main">
	...
	<div class="emdPanel">
				...
				<div class="emdControlPanel"><button id="toExcel">엑셀(XLS) 저장</button><button data-role="showMap" data-gis-layer="gisAssetsCd" data-flexi-grid="assetEvlDtlsList" data-style="default">맵조회</button></div>
	</div>
</div>
