...
<%
  /**
  * @Class Name : GamPopupTrainPortRentLstMngtPrmisn.jsp
  * @Description : 승낙 팝업
...
GamPopupPrtOperRentModule.prototype.onButtonClick = function(buttonId) {
	...
	case 'btnPrmisnExec':
        ...
        this.doAction('<c:url value="/oper/train/popup/gamInsertTrainPortRentLstMngtPrmisn.do" />', inputVO, function(module, result) {
...
<div class="dialog">
	<div class="emdPanel">
		<form id="gamPopupPrmisnForm">
		    <input type="hidden" id="prtAtCode" value="<c:out value="${gamTrainPortRentLstMngtInfo.prtAtCode }"/>"/>
		    <input type="hidden" id="mngYear" value="<c:out value="${gamTrainPortRentLstMngtInfo.mngYear }"/>"/>
		    <input type="hidden" id="mngNo" value="<c:out value="${gamTrainPortRentLstMngtInfo.mngNo }"/>"/>
		    <input type="hidden" id="mngCnt" value="<c:out value="${gamTrainPortRentLstMngtInfo.mngCnt }"/>"/>
