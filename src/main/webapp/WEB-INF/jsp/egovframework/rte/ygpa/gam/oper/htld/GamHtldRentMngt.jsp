...
<validator:javascript formName="gamHtldRentMngtVld" staticJavascript="false" xhtml="true" cdata="false" />
<validator:javascript formName="gamHtldRentMngtDetailVld" staticJavascript="false" xhtml="true" cdata="false" />
<validator:javascript formName="gamHtldRentMngtPhotoVld" staticJavascript="false" xhtml="true" cdata="false" />
...
GamHtldRentMngtModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamHtldRentMngtModule.prototype.loadComplete = function() {

    // 배후단지임대 테이블 설정
    this.$("#htldRentMngtList").flexigrid({
        module: this,
    ...
    // 배후단지임대상세 테이블 설정
    this.$("#htldRentMngtDetailList").flexigrid({
        module: this,
        url: '<c:url value="/oper/htld/gamSelectHtldRentMngtDetailList.do" />',
        dataType: 'json',
        colModel : [
    ...
    // 첨부파일 테이블 설정
    this.$("#htldRentMngtFileList").flexigrid({
        module: this,
        url: '<c:url value="/oper/htld/gamSelectHtldRentMngtFileList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#htldRentMngtList").on('onItemSelected', function(event, module, row, grid, param) {
    	module.$('#cmd').val('modify');

    	module.$('#gamHtldRentMngtForm :input').val('');

    	module.makeFormValues('#gamHtldRentMngtForm', row);
        module._editData=module.getFormValues('#gamHtldRentMngtForm', row);
        module._editRow=module.$('#htldRentMngtList').selectedRowIds()[0];
        ...
        var searchOpt=module.makeFormArgs('#gamHtldRentMngtForm');
        module.$('#htldRentMngtDetailList').flexOptions({params:searchOpt}).flexReload();
        module.$('#htldRentMngtFileList').flexOptions({params:searchOpt}).flexReload();
    });

    this.$("#htldRentMngtDetailList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.$('#btnApplyGisAssetsCode').prop('disabled', false);
        module.$('#gamHtldRentMngtDetailForm :input').val('');

        module.makeFormValues('#gamHtldRentMngtDetailForm', row);
        module._editData=module.getFormValues('#gamHtldRentMngtDetailForm', row);
        module._editRow=module.$('#htldRentMngtDetailList').selectedRowIds()[0];
    });

    this.$("#htldRentMngtFileList").on('onItemSelected', function(event, module, row, grid, param) {
        module.makeFormValues('#gamHtldRentMngtFileForm', row);
        module._editDataFile=module.getFormValues('#gamHtldRentMngtFileForm', row);
        module._editRowFile=module.$('#htldRentMngtFileList').selectedRowIds()[0];
    ...
    this.$("#htldRentMngtList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#htldRentMngtListTab").tabs("option", {active: 1});
        module.$('#cmd').val('modify');
        module.$('#gamHtldRentMngtForm :input').val('');
    ...
    this.$("#htldRentMngtDetailList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#htldRentMngtListTab").tabs("option", {active: 2});
        module.$('#gamHtldRentMngtDetailForm :input').val('');
...
/*             if( this.$('#sGrUsagePdFrom').val() == '' ) {
            ...
            var searchOpt=this.makeFormArgs('#gamHtldRentMngtSearchForm');
            this.$("#htldRentMngtListTab").tabs("option", {active: 0});
            this.$('#htldRentMngtList').flexOptions({params:searchOpt}).flexReload();
            break;

        // 최초신청
        case 'addHtldRentMngtFirst':
        	/*
            this.$("#htldRentMngtListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            this.$('#gamHtldRentMngtForm').find(':input').val('');
            //this.$("#htldRentMngtDetailList").flexRemove();
            this.$("#htldRentMngtDetailList").flexAddData({resultList:[]}); //그리드 초기화
            this.$("#cmd").val('insert');
            ...
            */
            this.$("#htldRentMngtListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            this.$('#gamHtldRentMngtForm').find(':input').val('');
            this.$('#gamHtldRentMngtDetailForm').find(':input').val('');
            this.$('#gamHtldRentMngtFileForm').find(':input').val('');

            //this.$("#htldRentMngtDetailList").flexRemove();
            this.$("#htldRentMngtDetailList").flexAddData({resultList:[]}); //그리드 초기화
            this.$("#htldRentMngtFileList").flexAddData({resultList:[]}); //그리드 초기화
            this.$("#cmd").val('insert');
        ...
        // 연장신청
        case 'addHtldRentMngtRenew':
            var rows = this.$('#htldRentMngtList').selectedRows();

            if(rows.length>=1) {
                //this.$('#rPrtAtCode').val(row[0]['prtAtCode']);

                if( confirm("연장신청을 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/htld/gamInsertHtldRentMngtRenew.do" />', rows[0], function(module, result) {

                        if(result.resultCode=='0') {
                            var searchOpt=module.makeFormArgs('#gamHtldRentMngtSearchForm');
                            module.$('#htldRentMngtList').flexOptions({params:searchOpt}).flexReload();
                        }
        ...
        case 'btnSaveItem':
        	...
        	if( !validateGamHtldRentMngtVld(this.$('#gamHtldRentMngtForm')[0]) ) {
            	return;
            }
            ...
            */
            ...
            if( confirm("저장하시겠습니까?") ) {
	        	...
	        	//this._editData=this.getFormValues('#gamHtldRentMngtDetailForm', this._editData);

	            inputVO[inputVO.length]={name: 'updateList', value :JSON.stringify(this.$('#htldRentMngtDetailList').selectFilterData([{col: '_updtId', filter: 'U'}])) };

	            inputVO[inputVO.length]={name: 'insertList', value: JSON.stringify(this.$('#htldRentMngtDetailList').selectFilterData([{col: '_updtId', filter: 'I'}])) };
	            ...
	            inputVO[inputVO.length]={name: 'updateFileList', value :JSON.stringify(this.$('#htldRentMngtFileList').selectFilterData([{col: '_updtId', filter: 'U'}])) };

                inputVO[inputVO.length]={name: 'insertFileList', value: JSON.stringify(this.$('#htldRentMngtFileList').selectFilterData([{col: '_updtId', filter: 'I'}])) };

                inputVO[inputVO.length]={name: 'deleteFileList', value: JSON.stringify(this._deleteDataFileList) };

	            //var otherForm=this.getFormValues('#gamHtldRentMngtForm', {});  // 폼만 있을 경우

	            this._editData2=this.getFormValues('#gamHtldRentMngtForm', {_updtId:'I'});
	            inputVO[inputVO.length]={name: 'form', value: JSON.stringify(this._editData2) };    // 폼의 데이터를 컨트롤러에 보낸다.

	            //console.log(inputVO);
	            // 데이터를 저장 하고 난 뒤 리스트를 다시 로딩 한다.

	            this.doAction('<c:url value="/oper/htld/gamSaveHtldRentMngt.do" />', inputVO, function(module, result) {
	            	if(result.resultCode == 0){
	                	var searchOpt=module.makeFormArgs('#gamHtldRentMngtForm');
	                    module.$('#htldRentMngtList').flexOptions({params:searchOpt}).flexReload();
	                	//module.$('#htldRentMngtDetailList').flexReload();
	                	module.$('#htldRentMngtDetailList').flexOptions({params:searchOpt}).flexReload();
	                	module.$('#htldRentMngtFileList').flexOptions({params:searchOpt}).flexReload();
	                }
	                alert(result.resultMsg);
	            ...
	            this.$("#htldRentMngtListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
	        }
        ...
        case 'btnRemoveItem':
            ...
            if(rows.length == 0) {
            	...
            	if( confirm("신청삭제를 하시겠습니까?") ) {
		        	...
		        	var inputVO=this.makeFormArgs('#gamHtldRentMngtForm');

	                this.doAction('<c:url value="/oper/htld/gamDeleteHtldRentMngt.do" />', inputVO, function(module, result) {
	                ...
	                this.$("#htldRentMngtListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
	                this.$('#gamHtldRentMngtForm :input').val("");
	                this.$("#cmd").val('insert');
            	}
            }
        ...
        case 'btnSaveComment':
        	...
        	this.doAction('<c:url value="/oper/htld/gamUpdateHtldRentMngtComment.do" />', inputVO, function(module, result) {
        ...
        case 'btnInsertItemDetail':
        	this.$("#htldRentMngtListTab").tabs("option", {active: 2});  // 탭을 전환 한다.
            this.$('#gamHtldRentMngtDetailForm').find(':input').val('');
            ...
            this._editData=this.getFormValues('#gamHtldRentMngtDetailForm', {_updtId:'I'});
            this._editRow=this.$('#htldRentMngtDetailList').flexGetData().length;

           break;

        // 배후단지임대상세 삭제 (Grid상에서만 삭제됨)
        case 'btnRemoveItemDetail':
            var rows = this.$('#htldRentMngtDetailList').selectedRows();

            if(rows.length == 0) {
                alert("배후단지임대상세목록에서 삭제할 행을 선택하십시오.");
            } else {
                if(this.$('#htldRentMngtDetailList').selectedRowIds().length>0) {
                    for(var i=this.$('#htldRentMngtDetailList').selectedRowIds().length-1; i>=0; i--) {
                        var row=this.$('#htldRentMngtDetailList').flexGetRow(this.$('#htldRentMngtDetailList').selectedRowIds()[i]);

                        if(row._updtId==undefined || row._updtId!='I') {
                            this._deleteDataList[this._deleteDataList.length]=row;  // 삽입 된 자료가 아니면 DB에 삭제를 반영한다.
                        }
                        this.$('#htldRentMngtDetailList').flexRemoveRow(this.$('#htldRentMngtDetailList').selectedRowIds()[i]);
                    }
                    ...
                    for( var i = 0 ; i < this.$('#htldRentMngtDetailList').flexGetData().length ; i++ ) {
                        var row = this.$('#htldRentMngtDetailList').flexGetRow(i);
                    ...
                    if( this.$('#htldRentMngtDetailList').flexGetData().length == 0 ) {
                    	this.$('#grFee').val( "" ); //총사용료
        ...
        case 'btnSaveItemDetail':
            ...
            var inputVO=this.makeFormArgs('#gamHtldRentMngtDetailForm');


            if(this.$("#detailCmd").val()=='insert') {

                this.doAction('<c:url value="/oper/htld/gamInsertHtldRentMngtDetail.do" />', {aaa : "rrrrrrrrrrrrrr"}, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/htld/gamUpdateHtldRentMngtDetail.do" />', inputVO, function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamHtldRentMngtForm');
                        module.$('#htldRentMngtDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'btnPrmisn': // 사용승낙
        	var rows = this.$('#htldRentMngtList').selectedRows();
            var row = this.$('#htldRentMngtList').selectedRows()[0];
            ...
            if(rows.length>=1) {
                ...
                this.doExecuteDialog('insertHtldRentMngtPrmisnPopup', '승낙', '<c:url value="/oper/htld/popup/showHtldRentMngtPrmisn.do"/>', opts);
        ...
        case 'btnPrmisnCancel': // 승낙취소
            ...
            if(rows.length>=1) {
                if( confirm("승낙취소를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/htld/gamUpdateHtldRentMngtPrmisnCancel.do" />', rows[0], function(module, result) {
                        if(result.resultCode=='0') {
                            var searchOpt=module.makeFormArgs('#gamHtldRentMngtForm');
                            module.$('#htldRentMngtList').flexOptions({params:searchOpt}).flexReload();
                        }
        ...
        case 'btnRentDetailApply': //배후단지임대상세적용

        	if( !validateGamHtldRentMngtDetailVld(this.$('#gamHtldRentMngtDetailForm')[0]) ) {
            	return;
            }
        	...
        	*/
            ...
            if(this._editRow!=null) {  // 이전에 _updtId 로 선택 한 것을 _editRow 로 변경 2014-03-14.001
                ...
                this.$('#htldRentMngtDetailList').flexUpdateRow(this._editRow, this._editData);
                this._editRow=null;    // 편집 저장 하였으므로 로우 편집을 종료 한다.
            }
            else {
                this.$('#htldRentMngtDetailList').flexAddRow(this._editData);
            }
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
                ...
                $.each(result, function(){
                    //module.$('#htldRentMngtFileList').flexAddRow({photoSj: '', filenmLogical: this.logicalFileNm, filenmPhyicl: this.physcalFileNm, regUsr: userid, registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
                    //module.$('#htldRentMngtFileList').flexAddRow({prtAtCode: '', mngYear: '', mngNo: '', mngCnt: '', photoSeq: '', photoSj: '', filenmLogic: this.logicalFileNm, filenmPhysicl: this.physcalFileNm, shotDt: '', photoDesc: '', regUsr: '', registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
                    //module.$('#htldRentMngtFileList').flexAddRow({_updtId:'I', prtAtCode: '', mngYear: '', mngNo: '', mngCnt: '', photoSeq: '', photoSj: '', filenmLogic: this.logicalFileNm, filenmPhysicl: this.physcalFileNm, shotDt: '', photoDesc: '', regUsr: '', registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
<<<<<<< .mine
             		module.$('#htldRentMngtFileList').flexAddRow({_updtId:'I', 
             			prtAtCode: '', 
             			mngYear: '', 
             			mngNo: '', 
             			mngCnt: '', 
...
=======
             		module.$('#htldRentMngtFileList').flexAddRow({_updtId:'I', prtAtCode: thisObj.$('#photoPrtAtCode').val(), mngYear: thisObj.$('#photoMngYear').val(), mngNo: thisObj.$('#photoMngNo').val(), mngCnt: thisObj.$('#photoMngCnt').val(),
...
>>>>>>> .r1001
            ...
            //this._editDataFile=this.getFormValues('#gamHtldRentMngtFileForm', {_updtId:'I'});
            //this._editRowFile=this.$('#htldRentMngtFileList').flexGetData().length;

            break;

        case 'btnApplyPhotoData':

        	if(!validateGamHtldRentMngtPhotoVld( this.$('#gamHtldRentMngtFileForm')[0]) ) {
    			return;
    		}
        	...
        	*/
            ...
            this._editDataFile=this.getFormValues('#gamHtldRentMngtFileForm', this._editDataFile);
            ...
            if(this._editRowFile!=null) {  // 이전에 _updtId 로 선택 한 것을 _editRowFile 로 변경 2014-03-14.001
                ...
                this.$('#htldRentMngtFileList').flexUpdateRow(this._editRowFile, this._editDataFile);
                this._editRowFile=null;    // 편집 저장 하였으므로 로우 편집을 종료 한다.
            }
            else {
                this.$('#htldRentMngtFileList').flexAddRow(this._editDataFile);
            }
        ...
        case 'btnRemoveFile':
            ...
            var rows = this.$('#htldRentMngtFileList').selectedRows();

            if(rows.length == 0) {
                alert("파일목록에서 삭제할 행을 선택하십시오.");
            } else {
            	if(!confirm('삭제를 하시겠습니까?')) return; //2014-4-22 추가
                if(this.$('#htldRentMngtFileList').selectedRowIds().length>0) {
                    for(var i=this.$('#htldRentMngtFileList').selectedRowIds().length-1; i>=0; i--) {
                        var row=this.$('#htldRentMngtFileList').flexGetRow(this.$('#htldRentMngtFileList').selectedRowIds()[i]);
                        ...
                        this.$('#htldRentMngtFileList').flexRemoveRow(this.$('#htldRentMngtFileList').selectedRowIds()[i]);
                    }
        ...
        case 'btnEApproval':    // 전자결재 테스트
            if(this.$('#htldRentMngtList').selectedRowCount()>0) {

                //alert(EMD.context_root);

                var rows = this.$('#htldRentMngtList').selectedRows()[0];
...
GamHtldRentMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    ...
    case 'tabs1':
        break;
    case 'tabs2':
        var row = this.$('#htldRentMngtList').selectedRows();
        if(row.length==0) {
            this.$('#cmd').val('insert');
        }
        else {
        ...
        break;
    case 'tabs3':
        var row = this.$('#htldRentMngtDetailList').selectedRows();
        if(row.length==0) {
            this.$('#detailCmd').val('insert');
        }
        else {
...
GamHtldRentMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
     ...
     case 'insertEntrpsInfoPopup':
         ...
         break;
     case 'insertHtldRentMngtPrmisnPopup':
         if (msg != 'cancel') {
             if( value == "0" ) {
                 var searchOpt=this.makeFormArgs('#gamHtldRentMngtSearchForm');
                 this.$('#htldRentMngtList').flexOptions({params:searchOpt}).flexReload();
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamHtldRentMngtSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="htldRentMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
            ...
            <div id="tabs1" class="emdTabPage fillHeight" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <table id="htldRentMngtList" style="display:none" class="fillHeight"></table>
                    ...
                    <table style="width:100%;">
                        ...
                        <tr>
                            <td style="text-align: right">
                                <button id="addHtldRentMngtFirst">최초신청</button>
                                <button id="addHtldRentMngtRenew">연장신청</button>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                <div class="emdControlPanel"></div>
                    <form id="gamHtldRentMngtForm" commandName="gamHtldRentMngtVld" >
                ...
                <div style="vertical-align: bottom; text-align: right;">
                 ...
                 <!-- <table id="htldRentMngtDetailList" style="display:none" class="fillHeight"></table> -->
                 <table id="htldRentMngtDetailList" style="display:none"></table>

                 <table style="width:100%">
                    <tr>
                        <td style="text-align:right" colspan="3"><button id="btnInsertItemDetail" class="buttonAdd" >배후단지임대상세추가</button><button id="btnRemoveItemDetail" class="buttonDelete" >배후단지임대상세삭제</button></td>
                    </tr>
                    <tr>
            ...
            <div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItemDetail">저장</button></div>  -->
                    <form id="gamHtldRentMngtDetailForm" commandName="gamHtldRentMngtDetailVld" >
                ...
                <table style="width:100%">
                    <tr>
                        <td><button id="xxxx">GIS 등록</button><button id="xxxx">위치조회</button></td>
                        <td width="100"></td>
                        <td style="text-align:right"><button id="xxxx">취소</button><button id="btnRentDetailApply">배후단지임대상세적용</button>
                        </td>
                    </tr>
                 </table>
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <table id="htldRentMngtFileList" style="display:none" class="fillHeight"></table>
                ...
                <form id="gamHtldRentMngtFileForm" commandName="gamHtldRentMngtPhotoVld" >
