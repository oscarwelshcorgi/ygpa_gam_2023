 ...
 */
%>
<validator:javascript formName="gamHtldRentMngtVld" method="validateGamHtldRentMngtVld" staticJavascript="false" dynamicJavascript="true" xhtml="true" cdata="false" />
<validator:javascript formName="gamHtldRentMngtDetailVld" method="validateGamHtldRentMngtDetailVld" staticJavascript="false" dynamicJavascript="true" xhtml="true" cdata="false" />
<validator:javascript formName="gamHtldRentMngtPhotoVld" method="validateGamHtldRentMngtPhotoVld" staticJavascript="false" dynamicJavascript="true" xhtml="true" cdata="false" />
<!--
...
GamHtldRentMngtModule.prototype.applyPhotoData = function() {
    ...
    var row=selectRow[0];
	  		var rowid=this.$("#htldRentMngtFileList").selectedRowIds()[0];
	  		row=this.getFormValues('#gamHtldRentMngtFileForm', row);
        if(row["_updtId"]!='I') row["_updtId"]='U';   // 삽입된 데이터가 아니면 업데이트 플래그를 추가한다.
        this.$('#htldRentMngtFileList').flexUpdateRow(rowid, row);
    }
    else {
    }
};
	                 ...
	                 <table class="searchPanel">
	                    ...
	                    <tr>
	                        ...
	                        <th style="text-align:right">
	                        	<button id="btnInsertItemDetail" class="buttonAdd">배후단지임대상세추가</button>
	                        	<button id="btnRemoveItemDetail" class="buttonDelete">배후단지임대상세삭제</button>
	                        </th>
	                    </tr>
	                    </tbody>
	                 </table>
...
-->	                    
            ...
            <div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItemDetail">저장</button></div>  -->
                    <form id="gamHtldRentMngtDetailForm">
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <table id="htldRentMngtFileList" style="display:none"></table>
                ...
                <form id="gamHtldRentMngtFileForm">
