 ...
 */
 ...
 GamHtldRentMngtModule.prototype = new EmdModule(910, 550);
 ...
 GamHtldRentMngtModule.prototype.loadComplete = function() {
     ...
     this.$("#operResultList").flexigrid({
         module: this,
         url: '<c:url value="/oper/htld/selectHtldRentMngtList.do" />',
         dataType: 'json',
         colModel : [
     ...
     this.$("#operResultDetailList").flexigrid({  
         module: this,
         url: '<c:url value="/oper/htld/selectHtldRentMngtDetailList.do" />',  
         dataType: 'json',
         colModel : [
     ...
     switch(buttonId) {
         ...
         case 'btnSaveItem':
             ...
             if(this.$("#cmd").val()=='insert') {
             	...
             	this.doAction('<c:url value="/oper/htld/gamInsertHtldRentMngtFirst.do" />', inputVO, function(module, result) {
                 ...
                 this.doAction('<c:url value="/oper/htld/gamUpdateHtldRentMngt.do" />', inputVO, function(module, result) {	
                 	if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnRemoveItemDetail':
             ...
             if(rows.length>=1) {
                 this.doAction('<c:url value="/oper/htld/gamDeleteHtldRentMngtDetail.do" />', rows[0], function(module, result) {
                     if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultDetailList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnSaveItemDetail':
             ...
             if(this.$("#detailCmd").val()=='insert') {
                 ...
                 this.doAction('<c:url value="/oper/htld/gamInsertHtldRentMngtDetail.do" />', inputVO, function(module, result) {
 ...
 <div class="window_main">
     ...
     <div class="emdPanel fillHeight">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 <li><a href="#tabs1" class="emdTab">배후단지사용목록관리 조회내역</a></li>
                 <li><a href="#tabs2" class="emdTab">배후단지사용목록관리 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">배후단지사용목록관리 상세조회내역</a></li>
