...
<%
  /**
  * @Class Name : GamMarineCenterRentCmpyStsReport.jsp
 ...
 */
function GamMarineCenterRentCmpyStsReportModule() {}

GamMarineCenterRentCmpyStsReportModule.prototype = new EmdModule(1000, 600);

//페이지가 호출 되었을때 호출 되는 함수
GamMarineCenterRentCmpyStsReportModule.prototype.loadComplete = function() {
 
 // 테이블 설정 //       
 this.$("#marineCenterRentCmpyStsReportList").flexigrid({
     module: this,
     url: '<c:url value="/oper/center/gamSelectMarineCenterRentCmpyStsReportList.do"/>',
     dataType: 'json',
     colModel : [
...
this.$("#marineCenterRentCmpyStsReportList").on("onItemSelected", function(event, module, row, grid, param) {
...
* 정의 된 버튼 클릭 시
*/
GamMarineCenterRentCmpyStsReportModule.prototype.onButtonClick = function(buttonId) {
	...
	switch(buttonId) {
	    ...
	    case 'searchBtn':
	        ...
	        var searchOpt=this.makeFormArgs('#gamMarineCenterRentCmpyStsReportSearchForm');
	        this.$('#marineCenterRentCmpyStsReportList').flexOptions({params:searchOpt}).flexReload();
...
GamMarineCenterRentCmpyStsReportModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
...
GamMarineCenterRentCmpyStsReportModule.prototype.onSubmit = function() {
 //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

 this.loadData();
};

GamMarineCenterRentCmpyStsReportModule.prototype.loadData = function() {
 var searchOpt=this.makeFormArgs('#gamMarineCenterRentCmpyStsReportSearchForm');
 //this.showAlert(searchOpt);
 this.$('#marineCenterRentCmpyStsReportList').flexOptions({params:searchOpt}).flexReload();
};

GamMarineCenterRentCmpyStsReportModule.prototype.onTabChange = function(newTabId, oldTabId) {
 switch(newTabId) {
 case 'tabs1':
     break;
 case 'tabs2':
...
var module_instance = new GamMarineCenterRentCmpyStsReportModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamMarineCenterRentCmpyStsReportSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">마린센터업체별사용료현황</a></li>
            </ul>
