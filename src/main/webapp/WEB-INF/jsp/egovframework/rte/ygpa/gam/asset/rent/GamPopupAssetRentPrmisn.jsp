 ...
 GamPopupPrtOperRentModule.prototype.onButtonClick = function(buttonId) {
 	...
 	case 'btnPrmisnExec':
 		...
 		if( confirm("승낙 하시겠습니까?") ) {
 	        ...
 	        //this.doAction('/asset/rent/gamInsertAssetRentMngtPrmisn.do', inputVO, function(module, result) {
 	        this.doAction('/asset/rent/gamUpdateAssetRentMngtPrmisn.do', inputVO, function(module, result) {
 ...
 <div class="dialog">
 	<div class="emdPanel">
 		<form id="gamPopupPrmisnForm">
 		    <input type="hidden" id="prtAtCode" value="<c:out value="${gamAssetRentMngtInfo.prtAtCode }"/>"/>
 		    <input type="hidden" id="mngYear" value="<c:out value="${gamAssetRentMngtInfo.mngYear }"/>"/>
 		    <input type="hidden" id="mngNo" value="<c:out value="${gamAssetRentMngtInfo.mngNo }"/>"/>
 		    <input type="hidden" id="mngCnt" value="<c:out value="${gamAssetRentMngtInfo.mngCnt }"/>"/>
 			<input type="hidden" id="taxtSe" value="<c:out value="${gamAssetRentMngtInfo.taxtSe }"/>"/>
