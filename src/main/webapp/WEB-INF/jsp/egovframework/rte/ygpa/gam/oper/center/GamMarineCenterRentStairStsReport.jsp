...
GamMarineCenterRentStairStsReportModule.prototype.loadComplete = function() {
 ...
 this.$("#marineCenterRentStairStsReportList").flexigrid({
     module: this,
     url: '/oper/center/gamSelectMarineCenterRentStairStsReportList.do',
     dataType: 'json',
     colModel : [
                 ...
                 {display:'층구분', name:'gisAssetsStndrd',width:150, sortable:false,align:'center'},
                 {display:'사용료', name:'sumTotalFee',width:200, sortable:false, sortable:false,align:'right' , displayFormat: 'number'},
                 {display:'감면사용료', name:'sumTotalRdcxptFee',width:200, sortable:false, sortable:false,align:'right' , displayFormat: 'number'}
                 ],
     ...
     preProcess: function(module,data) {
         ...
         module.$('#sumTotalRdcxptFeeSum').val(data.sumTotalRdcxptFeeSum);
