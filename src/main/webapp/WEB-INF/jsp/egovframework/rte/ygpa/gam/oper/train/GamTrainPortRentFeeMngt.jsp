    ...
    switch(buttonId) {
        ...
        case 'btnNticIssuePrint2':	// 고지서 출력
            if(this.$('#assetRentFeeList').selectedRowCount()>0) {
                ...
                this.printPayNotice('/oper/train/printRentFeeNotice.do', rows);
            } else {
        ...
        case 'btnTaxPrint2':	// 계산서 출력
            if(this.$('#assetRentFeeList').selectedRowCount()>0) {
                ...
                this.printTaxNotice('/oper/train/printTrainPortRentFeeTaxNotice.do', rows);
            } else {
            	alert("목록에서 고지서를 출력 할 항목을 선택하십시오.");
            	return;
            }
        ...
        case 'btnRentFeePayMngt':
            ...
            if(rows.length>0) {
       	 	...
       	 	EMD.util.create_window('gamTrainPortRentFeePaySttusMngt', '철송장임대납부현황관리', '/oper/train/gamTrainPortRentFeePaySttusMngt.do', null, opts);
        	break;
    }
};
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
                <li><a href="#tabs1" class="emdTab">철송장임대사용료고지 목록</a></li>
                <li><a href="#tabs2" class="emdTab">철송장임대사용료고지 상세</a></li>
            </ul>
            ...
            <div id="tabs1" class="emdTabPage fillHeight" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                ...
                <div class="emdControlPanel">
                    ...
                    <button id="btnTrainPortRentFeeMngtListExcelDownload">엑셀</button>
