 ...
 */
function GamTestPrtFcltyUsageConfmInqireModule() {}

GamTestPrtFcltyUsageConfmInqireModule.prototype = new EmdModule(1700, 800);

//페이지가 호출 되었을때 호출 되는 함수
GamTestPrtFcltyUsageConfmInqireModule.prototype.loadComplete = function() {

	// 테이블 설정 //
	 this.$("#mainGrid").flexigrid({
	     module: this,
	     url: '/oper/gnrltest/selectPrtFcltyUageConfmInqireList.do',
	     dataType: 'json',
	     colModel : [
...
GamTestPrtFcltyUsageConfmInqireModule.prototype.onButtonClick = function(buttonId) {
    switch(buttonId) {
        case 'searchBtn':
...
GamTestPrtFcltyUsageConfmInqireModule.prototype.loadConfmInqireList = function() {
...
/*
GamTestPrtFcltyUsageConfmInqireModule.prototype.downloadExcel = function() {
	...
	this.$('#mainGrid').flexExcelDown('/oper/gnrltest/downloadPrtFcltyUageConfmInqireXlsList.do');

};
 */
GamTestPrtFcltyUsageConfmInqireModule.prototype.tableToExcel = function() {
...
var module_instance = new GamTestPrtFcltyUsageConfmInqireModule();
</script>
