...
<%
  /**
  * @Class Name : GamAssetListMngt.jsp
  * @Description : 자산정보목록관리 테스트 (Prototype)
...
GamAssetCodeModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
					...
					{display:'자산 코드 ',name:'GIS_ASSETS_CD',width:100,sortable:false,align:'center'},
					{display:'자산 Sub코드 ',name:'GIS_ASSETS_SUB_CD',width:100,sortable:false,align:'center'},
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">자산목록</a></li>
