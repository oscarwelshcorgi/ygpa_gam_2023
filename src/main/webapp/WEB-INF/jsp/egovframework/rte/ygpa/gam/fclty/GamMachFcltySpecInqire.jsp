					...
					<form id="detailForm">
						...
						<table id="bridgeDetailArea" class="detailPanel" style="width:100%; display:none;">
							...
							<tr>
								...
								<td>
									<input type="text" size="59" id="eqpmnStndrd" class="ygpaNumber" data-decimal-point="2" maxlength="10" disabled/> m
								</td>
							...
							<tr>
								...
								<td>
									<input type="text" size="59" id="elctyMthd" maxlength="50" disabled/> mm
								</td>
							</tr>
							<tr>
