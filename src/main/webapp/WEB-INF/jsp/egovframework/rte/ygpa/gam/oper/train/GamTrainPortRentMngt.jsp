 ...
 */
        ...
        case 'btnSaveItemDetail':
            ...
            if(this.$("#detailCmd").val()=='insert') {
                ...
                this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentMngtDetail.do" />', {aaa : "rrrrrrrrrrrrrr"}, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentMngtDetail.do" />', inputVO, function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamTrainPortRentMngtForm');
                        module.$('#trainPortRentMngtDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'btnUploadFile':
            ...
            this._tempRnum = this.$("#trainPortRentMngtFileList").flexGetData().length + 1;
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
                ...
                $.each(result, function(){
                    ...
                    //module.$('#trainPortRentMngtFileList').flexAddRow({_updtId:'I', prtAtCode: '', mngYear: '', mngNo: '', mngCnt: '', photoSeq: '', photoSj: '', filenmLogic: this.logicalFileNm, filenmPhysicl: this.physcalFileNm, shotDt: '', photoDesc: '', regUsr: '', registDt:  EMD.util.getTimeStamp()}); // 업로드 파일명이 physcalFileNm (물리명), logicalFileNm (논리명)으로 리턴 된다.
             		module.$('#trainPortRentMngtFileList').flexAddRow({_updtId:'I', 
             			prtAtCode: '', 
             			mngYear: '', 
             			mngNo: '', 
             			mngCnt: '', 
        ...
        case 'btnApplyPhotoData':
        	...
        	*/
            ...
            this._editDataFile=this.getFormValues('#gamTrainPortRentMngtFileForm', this._editDataFile);
            ...
            if(this._editRowFile!=null) {  // 이전에 _updtId 로 선택 한 것을 _editRowFile 로 변경 2014-03-14.001
                ...
                this.$('#trainPortRentMngtFileList').flexUpdateRow(this._editRowFile, this._editDataFile);
                this._editRowFile=null;    // 편집 저장 하였으므로 로우 편집을 종료 한다.
            }
            else {
                this.$('#trainPortRentMngtFileList').flexAddRow(this._editDataFile);
            }
