 ...
 * @Description : 철송장임대사용목록관리 (철송장임대/일반부두/철송장임대사용목록관리)
...
GamAssetRentMngtModule.prototype.loadComplete = function(param) {
    ...
    this.$("#assetRentMngtList").flexigrid({
        module: this,
        url: '/oper/train/gamSelectTrainPortRentMngtList.do',
        dataType: 'json',
        colModel : [
...
//                    {display:'신청업체', name:'entrpscd',width:60, sortable:false,align:'center'},
    ...
    this.$("#assetRentDetailList").flexigrid({
        module: this,
        url: '/oper/train/gamSelectTrainPortRentMngtDetailList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#assetRentFileList").flexigrid({
        module: this,
        url: '/oper/train/gamSelectTrainPortRentMngtFileList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#assetRentFileList").on('onItemSelected', function(event, module, row, grid, param) {
        ...
        if(row.filenmPhysicl!=null || row.filenmPhysicl!='') {
			...
			if(ext=='jpg' || ext=='jpeg' || ext=='bmp' || ext=='png' || ext=='gif') {
			    $imgURL = module.getUrl("/oper/train/getRentAttachFile.do?physicalFileNm=")+filenm;
...
GamAssetRentMngtModule.prototype.loadRentMaster = function(loadOpt) {
    ...
    this.doAction('/oper/train/selectRentMasterInfo.do', EMD.util.objectToArray(loadOpt), function(module, result) {
 ...
 GamAssetRentMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'addAssetRentRenew':
            ...
            if(rows.length>=1) {
                ...
                if( confirm("연장신청을 하시겠습니까?") ) {
                    this.doAction('/oper/train/gamInsertTrainPortRentMngtRenew.do', rows[0], function(module, result) {
        ...
        case 'btnRemoveItem':
            ...
            if(rows.length == 0) {
            	...
            	if( confirm("신청삭제를 하시겠습니까?") ) {
                    ...
                    this.doAction('/oper/train/gamDeleteTrainPortRentMngt.do', inputVO, function(module, result) {
        ...
        case 'btnSaveComment':
            ...
            this.doAction('/oper/train/gamUpdateTrainPortRentMngtComment.do', inputVO, function(module, result) {
                if(result.resultCode=='0') {
                }
...
/*                     alert("결재완료 상태가 아닙니다.");
                ...
                this.doExecuteDialog('insertAssetRentPrmisnPopup', '승낙', '/oper/train/popup/showTrainPortRentMngtPrmisn.do', opts);
        ...
        */
        ...
        case 'btnNoticeAdit2':
            ...
            if(rows.length>=1) {
                this.doExecuteDialog('insertLevReqestAdit', '추가 사용료 고지', '/oper/train/popupLevReqestAdit.do', rows[0]);
            } else {
                alert("목록에서 선택하십시오.");
            }
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
		...
		case 'btnUploadFile':
				this.uploadSingleFile('/oper/train/uploadRentAttachFile.do', function(module, resp) {
        ...
        case 'btnDownloadFile':
    		...
    		if(selectRow.length > 0) {
    			var row=selectRow[0];
    			this.downloadSingleFile("/oper/train/downloadRentAttachFile.do", row["filenmPhysicl"]);
    		}
    		break;
        ...
        case 'btnTrainPortRentMngtListExcelDownload':	// 엑셀 다운로드
        	this.$('#assetRentMngtList').flexExcelDown('/oper/train/selectTrainPortRentMngtListExcel.do');
            break;
        ...
        case 'btnRentFeeMngt':
            ...
            if(rows.length>0) {
       	 	...
       	 	EMD.util.create_window('gamTrainPortRentFeeMngt', '철송장임대사용료관리', '/oper/train/gamTrainPortRentFeeMngt.do', null, opts);
        	break;
    }
};
    	               	...
    	               	<table style="width:100%;">
	                        <tr>
	                            <td style="text-align: right">
	                                ...
	                                <button id="btnTrainPortRentMngtListExcelDownload">엑셀</button>
