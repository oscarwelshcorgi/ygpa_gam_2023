...
GamCmmnCntrUseExprInqireModule.prototype.loadComplete = function() {
    this.$("#cmmnCntrUseExprInqireList").flexigrid({
        module: this,
        url: '/oper/shed/gamSelectCmmnCntrUseExprInqireList.do',
        dataType: 'json',
        colModel : [
...
GamCmmnCntrUseExprInqireModule.prototype.loadUseList = function() {
...
GamCmmnCntrUseExprInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#cmmnCntrUseExprInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamCmmnCntrUseExprInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('/oper/shed/gamSelectCmmnCntrUseExprInqireDetailList.do', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamCmmnCntrUseExprInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamCmmnCntrUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#cmmnCntrUseExprInqireList').selectedRowCount()==0) {
