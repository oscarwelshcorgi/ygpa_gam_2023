...
<%--
  /**
  * @Class Name : GamPopupIntrrateMngt.jsp
  * @Description : 분납 이자율 관리 팝업
 ...
 */
function GamPopupIntrrateMngtModule() {}

GamPopupIntrrateMngtModule.prototype = new EmdPopupModule(370, 400);

// 페이지가 호출 되었을때 호출 되는 함수
GamPopupIntrrateMngtModule.prototype.loadComplete = function() {
	this.resizable(true);
...
GamPopupIntrrateMngtModule.prototype.onButtonClick = function(buttonId) {
	switch(buttonId) {
	case 'btnSearchData':
		this.loadData();
