...
<div class="window_main">
                        ...
                        <tr>
                            ...
                            <td>
                                 <select id="sPrtAtCode">
                                    <option value="640" selected="selected">마린센터</option>
                                </select>
                                <!-- 
                                <select id="sPrtAtCode">
    ...
    <div class="emdPanel">
        <div id="marineCenterRentFeeListTab" class="emdTabPanel" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">마린센터임대료 목록</a></li>
                <li><a href="#tabs2" class="emdTab">마린센터임대료 상세</a></li>
            </ul>

            <div id="tabs1" class="emdTabPage" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <div style="width: 100%; height: 100%; overflow:auto">
                        <table id="marineCenterRentFeeList" style="display:none"></table>
                </div>
