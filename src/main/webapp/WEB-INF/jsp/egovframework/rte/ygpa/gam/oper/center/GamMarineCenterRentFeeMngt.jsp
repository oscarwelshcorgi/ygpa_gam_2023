...
<%
  /**
  * @Class Name : GamMarineCenterRentFeeMngt.jsp
 ...
 */
function GamMarineCenterRentFeeMngtModule() {}

GamMarineCenterRentFeeMngtModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamMarineCenterRentFeeMngtModule.prototype.loadComplete = function() {

    // 테이블 설정 //       
    this.$("#marineCenterRentFeeList").flexigrid({
        module: this,
    ...
    this.$("#marineCenterRentFeeList").on('onItemSelected', function(event, module, row, grid, param) {
        module.$('#cmd').val('modify');

        module.$('#gamMarineCenterRentFeeForm :input').val('');

        module.makeFormValues('#gamMarineCenterRentFeeForm', row);
        module._editData=module.getFormValues('#gamMarineCenterRentFeeForm', row);
        module._editRow=module.$('#marineCenterRentFeeList').selectedRowIds()[0];
    });
    
    this.$("#marineCenterRentFeeList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        // 이벤트내에선 모듈에 대해 선택한다.
        module.$("#marineCenterRentFeeListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
        this.$("#cmd").val('modify');
    ...
    this.$('#nticPdFrom').val(sToday);
    this.$('#nticPdTo').val(sToday);
};

/**
 * 정의 된 버튼 클릭 시
 */
 GamMarineCenterRentFeeMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'searchBtn':
        	...
        	this.$("#marineCenterRentFeeListTab").tabs("option", {active: 0}); //2014-4-22 추가
        ...
        case 'btnInsertItem':
            module.$("#marineCenterRentFeeListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
            this.$('#gamMarineCenterRentFeeForm').find(':input').val('');
            this.$("#cmd").val('insert');
        ...
        case 'btnSaveItem':
            ...
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                var inputVO=this.makeFormArgs('#gamMarineCenterRentFeeForm');
                
                this.doAction('<c:url value="/oper/center/gamUpdateMarineCenterRentFee.do" />', inputVO, function(module, result) {
    
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamMarineCenterRentFeeSearchForm');
                        module.$('#marineCenterRentFeeList').flexOptions({params:searchOpt}).flexReload();
                    }
            ...
            */
            ...
            if( this.$("#cmd").val() == 'insert' ) {
                ...
                this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentFee.do" />', inputVO, function(module, result) {
         ...
         // 취소
        case 'btnCancelItem':
            this.$('#gamMarineCenterRentFeeForm :input').val("");
            break;
        ...
        case 'saveNticListBtn':
            ...
            var reglist = this.$("#marineCenterRentFeeList").selectFilterData(filter);
            ...
            if(reglist.length > 0){
                ...
                this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentFeeNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamMarineCenterRentFeeSearchForm");
                        module.$("#marineCenterRentFeeList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'cancelNticListBtn': 
            ...
            if(reglist.length > 0){
                ...
                var inputVO = {nticCnts: nticCnts, prtAtCodes: prtAtCodes, mngYears: mngYears, mngNos: mngNos, mngCnts: mngCnts, nticnos: nticnos, accnutYears: accnutYears };
                this.doAction('<c:url value="/oper/center/gamDeleteMarineCenterRentFeeNtic.do" />', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                        var searchOpt = module.makeFormArgs("#gamMarineCenterRentFeeSearchForm");
                        module.$("#marineCenterRentFeeList").flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        */
        ...
        case 'saveNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentFeeNticSingle.do" />', inputVO, function(module, result) {
        ...
        case 'cancelNticDetailBtn':
            if( this.$('#prtAtCode').val() == '' ) {
                ...
                this.doAction('<c:url value="/oper/center/gamDeleteMarineCenterRentFeeNticSingle.do" />', inputVO, function(module, result) {
        ...
        */
        ...
        case 'saveNticDetailBtn':
            var rows = this.$('#marineCenterRentFeeList').selectedRows();
            
            if(rows.length>=1) {
                if( confirm("고지의뢰를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/center/gamInsertMarineCenterRentFeeNticSingle.do" />', rows[0], function(module, result) {
        ...
        case 'cancelNticDetailBtn':
            ...
            if(rows.length>=1) {
                if( confirm("고지취소를 하시겠습니까?") ) {
                    this.doAction('<c:url value="/oper/center/gamDeleteMarineCenterRentFeeNticSingle.do" />', rows[0], function(module, result) {
...
GamMarineCenterRentFeeMngtModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamMarineCenterRentFeeMngtModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamMarineCenterRentFeeSearchForm');
    //this.showAlert(searchOpt);
    this.$('#marineCenterRentFeeList').flexOptions({params:searchOpt}).flexReload();
};

GamMarineCenterRentFeeMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
...
GamMarineCenterRentFeeMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
...
var module_instance = new GamMarineCenterRentFeeMngtModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamMarineCenterRentFeeSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="marineCenterRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
            ...
            <div id="tabs1" class="emdTabPage fillHeight" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <!-- <div style="width: 100%; height: 100%; overflow:auto">  -->
                        <table id="marineCenterRentFeeList" style="display:none" class="fillHeight"></table>
                <!-- </div>  -->
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                ...
                <div class="emdControlPanel">
                    ...
                    <form id="gamMarineCenterRentFeeForm">
