...
<%
  /**
  * @Class Name : GamCntnrRentFeePaySttusMngt.jsp
 ...
 */
function GamCntnrRentFeePaySttusMngtModule() {}

GamCntnrRentFeePaySttusMngtModule.prototype = new EmdModule(1000, 550);

// 페이지가 호출 되었을때 호출 되는 함수
GamCntnrRentFeePaySttusMngtModule.prototype.loadComplete = function() {

    // 테이블 설정 //       
    this.$("#assetRentFeePayList").flexigrid({
        module: this,
        url: '<c:url value="/oper/cntnr/gamSelectCntnrRentFeePaySttusMngtList.do" />',
        dataType: 'json',
        colModel : [
 ...
 * 정의 된 버튼 클릭 시
 */
 GamCntnrRentFeePaySttusMngtModule.prototype.onButtonClick = function(buttonId) {

    switch(buttonId) {

        // 조회
        case 'searchBtn':
            var searchOpt=this.makeFormArgs('#gamCntnrRentFeePaySttusMngtSearchForm');
...
GamCntnrRentFeePaySttusMngtModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamCntnrRentFeePaySttusMngtModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamCntnrRentFeePaySttusMngtSearchForm');
    //this.showAlert(searchOpt);
    this.$('#assetRentFeePayList').flexOptions({params:searchOpt}).flexReload();
};

GamCntnrRentFeePaySttusMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
...
GamCntnrRentFeePaySttusMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
...
var module_instance = new GamCntnrRentFeePaySttusMngtModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCntnrRentFeePaySttusMngtSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeePayListTab" class="emdTabPanel" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">컨테이너부두납부 목록</a></li>
                <li><a href="#tabs2" class="emdTab">컨테이너부두납부 상세</a></li>
            </ul>
