...
GamTrainPortNticArrvlDtaInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#trainPortNticArrvlDtaInqireList").flexigrid({
        module: this,
        url: '/oper/train/gamSelectTrainPortNticArrvlDtaInqireList.do',
        dataType: 'json',
        colModel : [
...
GamTrainPortNticArrvlDtaInqireModule.prototype.loadRentList = function() {
...
GamTrainPortNticArrvlDtaInqireModule.prototype.loadDetailForm = function() {
	...
	this.makeDivValues('#gamTrainPortNticArrvlDtaInqireForm', row); // 결과값을 채운다.

	this.doAction('/oper/train/gamSelectTrainPortNticArrvlDtaInqireDetailList.do', detailParam, function(module, result) {
...
GamTrainPortNticArrvlDtaInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#trainPortNticArrvlDtaInqireList').selectedRowCount()==0) {
    ...
    <div class="emdPanel fillHeight">
        <div id="trainPortNticArrvlDtaInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                	...
                	<!-- <h2>철송장임대 내역</h2> -->
                    <div id="gamTrainPortNticArrvlDtaInqireForm">
					...
					<div id="trainPortNticArrvlDtaInqireDetailForm">
