...
GamCmmnCntrNticArrvlDtaInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#cmmnCntrNticArrvlDtaInqireList").flexigrid({
        module: this,
        url: '/oper/shed/gamSelectCmmnCntrNticArrvlDtaInqireList.do',
        dataType: 'json',
        colModel : [
...
GamCmmnCntrNticArrvlDtaInqireModule.prototype.loadRentList = function() {
...
GamCmmnCntrNticArrvlDtaInqireModule.prototype.loadDetailForm = function() {
 	var row = this.$('#cmmnCntrNticArrvlDtaInqireList').selectedRows()[0];
	...
	this.makeDivValues('#gamCmmnCntrNticArrvlDtaInqireForm', row); // 결과값을 채운다.

	this.doAction('/oper/shed/gamSelectCmmnCntrNticArrvlDtaInqireDetailList.do', detailParam, function(module, result) {
 ...
 GamCmmnCntrNticArrvlDtaInqireModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'openRentFee':	// 사용료 관리 화면을 호출 한다.
	        if(this.$('#cmmnCntrNticArrvlDtaInqireList').selectedRowCount()==1) {
	         	var row = this.$('#cmmnCntrNticArrvlDtaInqireList').selectedRows()[0];
...
GamCmmnCntrNticArrvlDtaInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#cmmnCntrNticArrvlDtaInqireList').selectedRowCount()==0) {
