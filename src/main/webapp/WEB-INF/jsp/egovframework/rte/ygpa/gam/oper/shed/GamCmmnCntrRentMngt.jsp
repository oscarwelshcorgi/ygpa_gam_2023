...
GamAssetRentMngtModule.prototype.calcNationAssetLaw = function() {
    if( this.$('#olnlp').val() != '' && this.$('#usagePdFrom').val() != '' && this.$('#usagePdTo').val() != ''
        ...
        if( exemptSe == '2' ) {     // 전체면제 일 경우 사용료는 0
        	...
        	exemptCnt = dayUseCnt;
            calFee = 0;
        } else {calFee = monfee*usageAr*usageMonths.month+monfee*usageAr*usageMonths.day/usageMonths.lastMonthDay - rdcxptFee;
        }
        var calcStr="";
...
/*                     alert("결재완료 상태가 아닙니다.");
                ...
                this.doExecuteDialog('insertAssetRentPrmisnPopup', '승낙', '<c:url value="/oper/shed/popup/showCmmnCntrRentMngtPrmisn.do"/>', opts);
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
        ...
        case 'btnCmmnCntrRentMngtListExcelDownload':	// 엑셀 다운로드
        	this.$('#assetRentMngtList').flexExcelDown('<c:url value="/oper/gnrl/selectCmmnCntrRentMngtListExcel.do"/>');
            break;
    }
};
    	               	...
    	               	<table style="width:100%;">
	                        <tr>
	                            <td style="text-align: right">
	                                ...
	                                <button id="btnCmmnCntrRentMngtListExcelDownload">엑셀</button>
...
<!-- 								<th width="10%" height="18">부두코드</th>
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <!-- <button id="xxxx">취소</button> --><button id="btnRentDetailApply">임대상세적용</button>
                        </td>
                    </tr>
                 </table>
