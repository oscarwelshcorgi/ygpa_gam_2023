 ...
 * @Description : 항만관련부지사용목록관리 (항만관련부지/일반부두/항만관련부지사용목록관리)
...
GamAssetRentMngtModule.prototype.loadComplete = function() {
    ...
    this.$("#assetRentMngtList").flexigrid({
        module: this,
        url: '/oper/shed/gamSelectCmmnCntrRentMngtList.do',
        dataType: 'json',
        colModel : [
...
//                    {display:'신청업체', name:'entrpscd',width:60, sortable:false,align:'center'},
    ...
    this.$("#assetRentDetailList").flexigrid({
        module: this,
        url: '/oper/shed/gamSelectCmmnCntrRentMngtDetailList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#assetRentFileList").flexigrid({
        module: this,
        url: '/oper/shed/gamSelectCmmnCntrRentMngtFileList.do',
        dataType: 'json',
        colModel : [
...
//            this.$("#assetRentFileList").flexAddData({resultList:[]}); //그리드 초기화
        ...
        case 'addAssetRentRenew':
            ...
            if(rows.length>=1) {
                ...
                if( confirm("연장신청을 하시겠습니까?") ) {
                    this.doAction('/oper/shed/gamInsertCmmnCntrRentMngtRenew.do', rows[0], function(module, result) {
        ...
        case 'btnSaveItem':
            ...
            if( confirm("저장하시겠습니까?") ) {
                ...
                this.doAction('/oper/shed/gamSaveCmmnCntrRentMngt.do', inputVO, function(module, result) {
                    if(result.resultCode == 0){
                    	module.loadData();
        ...
        case 'btnRemoveItem':
            ...
            if(rows.length == 0) {
            	...
            	if( confirm("신청삭제를 하시겠습니까?") ) {
                    ...
                    this.doAction('/oper/shed/gamDeleteCmmnCntrRentMngt.do', inputVO, function(module, result) {
        ...
        case 'btnSaveComment':
            ...
            this.doAction('/oper/shed/gamUpdateCmmnCntrRentMngtComment.do', inputVO, function(module, result) {
                if(result.resultCode=='0') {
                }
...
/*                     alert("결재완료 상태가 아닙니다.");
                ...
                this.doExecuteDialog('insertAssetRentPrmisnPopup', '승낙', '/oper/shed/popup/showCmmnCntrRentMngtPrmisn.do', opts);
        ...
        */
        ...
        case 'btnPrmisnCancel': // 승낙취소
            ...
            if(rows.length>=1) {
                if( confirm("승낙취소를 하시겠습니까?") ) {
                    this.doAction('/oper/shed/gamUpdateCmmnCntrRentMngtPrmisnCancel.do', rows[0], function(module, result) {
                        if(result.resultCode=='0') {
                        	 module.loadData();
                        }
        ...
        case 'btnNoticeAdit2':
            ...
            if(rows.length>=1) {
                this.doExecuteDialog('insertLevReqestAdit', '추가 사용료 고지', '/oper/shed/popupLevReqestAdit.do', rows[0]);
            } else {
                alert("목록에서 선택하십시오.");
            }
...
//              var userid=EMD.util.getLoginUserVO().userNm; 임시
        ...
        case 'btnCmmnCntrRentMngtListExcelDownload':	// 엑셀 다운로드
        	this.$('#assetRentMngtList').flexExcelDown('/oper/shed/selectCmmnCntrRentMngtListExcel.do');
            break;
        ...
        case 'btnRentFeeMngt':
            ...
            if(rows.length>0) {
       	 	...
       	 	EMD.util.create_window('항만관련부지사용료관리', '/oper/shed/gamCmmnCntrRentFeeMngt.do', null, opts);
        	break;
    }
};
