 ...
 */
 ...
 GamCmmnCntrRentMngtModule.prototype = new EmdModule(910, 550);
 ...
 GamCmmnCntrRentMngtModule.prototype.loadComplete = function() {
     ...
     this.$("#operResultList").flexigrid({
         module: this,
         url: '<c:url value="/oper/shed/selectCmmnCntrRentMngtList.do" />',
         dataType: 'json',
         colModel : [
     ...
     this.$("#operResultDetailList").flexigrid({  
         module: this,
         url: '<c:url value="/oper/shed/selectCmmnCntrRentMngtDetailList.do" />',  
         dataType: 'json',
         colModel : [
     ...
     switch(buttonId) {
         ...
         case 'btnSaveItem':
             ...
             if(this.$("#cmd").val()=='insert') {
             	...
             	this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentMngtFirst.do" />', inputVO, function(module, result) {
                 ...
                 this.doAction('<c:url value="/oper/shed/gamUpdateCmmnCntrRentMngt.do" />', inputVO, function(module, result) {	
                 	if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnRemoveItemDetail':
             ...
             if(rows.length>=1) {
                 this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentMngtDetail.do" />', rows[0], function(module, result) {
                     if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultDetailList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnSaveItemDetail':
             ...
             if(this.$("#detailCmd").val()=='insert') {
                 ...
                 this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentMngtDetail.do" />', inputVO, function(module, result) {
 ...
 <div class="window_main">
     ...
     <div class="emdPanel">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 <li><a href="#tabs1" class="emdTab">공컨장치장사용목록관리 조회내역</a></li>
                 <li><a href="#tabs2" class="emdTab">공컨장치장사용목록관리 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">공컨장치장사용목록관리 상세조회내역</a></li>
             </ul>
