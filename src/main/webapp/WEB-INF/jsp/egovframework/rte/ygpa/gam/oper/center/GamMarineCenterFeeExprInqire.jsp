...
GamMarineCenterFeeExprInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#marineCenterFeeExprInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#marineCenterFeeExprInqireListTab").tabs("option", {active: 1});
...
GamMarineCenterFeeExprInqireModule.prototype.loadRentList = function() {
    this.$("#marineCenterFeeExprInqireListTab").tabs("option", {active: 0});
...
GamMarineCenterFeeExprInqireModule.prototype.loadDetailForm = function() {
	...
	this.makeDivValues('#gamMarineCenterFeeExprInqireForm', row); // 결과값을 채운다.

	this.doAction('<c:url value="/oper/center/gamSelectMarineCenterFeeExprInqireDetailList.do" />', detailParam, function(module, result) {

		if (result.resultCode == "0") {
			
			module.makeMultiDivValues('#marineCenterFeeExprInqireDetailForm',result.resultList , function(row) {
			} );	// 리스트 값을 채운다
		} else {
...
GamMarineCenterFeeExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#marineCenterFeeExprInqireList').selectedRowCount()==0) {
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="marineCenterFeeExprInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">마린센터임대(고지도래) 목록</a></li>
