...
GamMarineCenterFeeExprInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#marineCenterFeeExprInqireList").flexigrid({
        module: this,
        url: '/oper/center/gamSelectMarineCenterFeeExprInqireList.do',
        dataType: 'json',
        colModel : [
...
GamMarineCenterFeeExprInqireModule.prototype.loadDetailForm = function() {
	...
	this.doAction('/oper/center/gamSelectMarineCenterFeeExprInqireDetailList.do', detailParam, function(module, result) {
