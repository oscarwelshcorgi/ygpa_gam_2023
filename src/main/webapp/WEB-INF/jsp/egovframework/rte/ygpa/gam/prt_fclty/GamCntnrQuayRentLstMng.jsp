...
<%
  /**
  * @Class Name : GamCntnrQuayRentLstMng.jsp
  * @Description : 컨테이너부두임대목록관리 테스트 (Prototype)
...
GamAssetCodeModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		colModel : [
			...
			{display:'선석명',name:'BERTH_NM',width:56,sortable:false,align:'center'}
			],
/* 		searchitems : [
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">임대목록관리</a></li>
