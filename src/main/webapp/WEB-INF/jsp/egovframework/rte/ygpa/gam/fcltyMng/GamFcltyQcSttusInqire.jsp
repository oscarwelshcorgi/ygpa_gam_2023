						...
						<td width="60%">
							...
							<table  class="detailPanel"  style="width:100%;">
								...
								<tr>
									...
									<td width="32%">
										<input type="text" size="21" id="qcInspBdgt" class="ygpaNumber" disabled="disabled"/> 원
									</td>
									<th style="width:14%; height:18px;">점검　관리　명</th>
									<td>
										<input type="text" size="35" id="qcMngNm" maxlength="70" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">점　검　구　분</th>
									<td>
										<select id="qcSe" disabled="disabled">
		                                    <option value="">선택</option>
									...
									<td>
										<select id="qcInspSe" disabled="disabled">
		                                    <option value="">선택</option>
		                                    <option value="1">정기점검　　　　　　　　　　　　</option>
		                                    <option value="2">정밀점검　　　　　　　　　　　　</option>
		                                    <option value="3">초기점검　　　　　　　　　　　　</option>
								...
								<tr>
									...
									<td>
										<select id="qcInspTp" disabled="disabled">
		                                    <option value="">선택</option>
									...
									<td>
										<input type="text" class="emdcal" id="qcInspDt" size="32" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">점검진단　금액</th>
									<td>
										<input type="text" size="21" id="qcInspAmt" class="ygpaNumber" disabled="disabled"/> 원
									</td>
									<th style="width:14%; height:18px;">점검진단기관명</th>
									<td>
										<input type="text" size="35" id="qcInspInsttNm" maxlength="70" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">책임　기술자명</th>
									<td>
										<input type="text" size="23" id="responEngineerNm" maxlength="20" disabled="disabled"/>
									</td>
									<th style="width:14%; height:18px;">점　검　기　간</th>
									<td>
										<input type="text" size="12" id="qcBeginDt" class="emdcal" disabled="disabled"/> ~
										<input type="text" size="12" id="qcEndDt" class="emdcal" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">작　성　일　자</th>
									<td>
										<input type="text" size="20" id="wrtDt" class="emdcal" disabled="disabled"/>
									</td>
									<th style="width:14%; height:18px;">작　　성　　자</th>
									<td>
										<input type="text" size="35" id="wrtUsr" maxlength="20" disabled="disabled"/>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">상태평가　등급</th>
									<td colspan="3">
										<select id="sttusEvlLvl" disabled="disabled">
		                                    <option value="">선택</option>
										...
										&nbsp;　　점검결과항목선택 :&nbsp;
										<select id="mechFcltsSe" disabled="disabled">
								...
								<tr>
									...
									<td colspan="3">
										<textarea id="qcInspResult" cols="87" rows="5" disabled="disabled"></textarea>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">점　검　내　용</th>
									<td colspan="3">
										<textarea id="actionCn" cols="87" rows="5" disabled="disabled"></textarea>
									</td>
								</tr>
								<tr>
									<th style="width:14%; height:18px;">비　　　　　고</th>
									<td colspan="3">
										<textarea id="rm" cols="87" rows="4" disabled="disabled"></textarea>
									</td>
								</tr>
							</table>
							</form>
