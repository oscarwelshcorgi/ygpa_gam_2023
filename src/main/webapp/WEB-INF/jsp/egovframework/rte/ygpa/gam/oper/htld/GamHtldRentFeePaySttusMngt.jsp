...
GamHtldRentFeePaySttusMngtModule.prototype = new EmdModule(1000, 550);
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeePayListTab" class="emdTabPanel" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">배후단지납부 목록</a></li>
                <li><a href="#tabs2" class="emdTab">배후단지납부 상세</a></li>
            </ul>
