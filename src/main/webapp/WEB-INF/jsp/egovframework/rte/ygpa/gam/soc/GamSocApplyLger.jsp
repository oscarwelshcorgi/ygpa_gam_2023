...
GamSocApplyLgerModule.prototype.loadComplete = function() {
    this.$("#socApplyLgerList").flexigrid({
        ...
        colModel : [
                    ...
                    {display:'신청기간시작',name:'periodFr',	width:90, sortable:false,align:'center'},
                    {display:'신청기간종료',name:'periodTo',	width:90, sortable:false,align:'center'},
                    {display:'적용요율', 	name:'rateGubun',	width:70, sortable:false,align:'center'},
                    {display:'신고일자', 	name:'applDate',	width:80, sortable:false,align:'center'},
                    {display:'허가일자', 	name:'perfDt',		width:80, sortable:false,align:'center'},
                    {display:'사용유무',	name:'useYn',		width:70, sortable:false,align:'center'},
                    {display:'작업자', 	name:'updtUid',		width:100, sortable:false,align:'center'},
                    {display:'작업일자', 	name:'updtDate',	width:80, sortable:false,align:'center'},
