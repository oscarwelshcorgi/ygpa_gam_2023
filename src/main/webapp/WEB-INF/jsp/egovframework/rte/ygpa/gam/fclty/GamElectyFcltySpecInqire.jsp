...
**/
%>
GamElectyFcltySpecInqireModule.prototype.hideFcltyMaintMngList = function() {
...
**/
%>
GamElectyFcltySpecInqireModule.prototype.showFcltyMaintMngList = function(argParent) {
...
**/
%>
GamElectyFcltySpecInqireModule.prototype.buildFcltyMaintMngList = function() {
	...
	this.doAction('/fclty/gamSelectElectyFcltySpecInqireMntnRprDtlsList.do', searchVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length <= 0) {
