...
<%
  /**
  * @Class Name : GamCntnrQuayMtRentFeeSttusInqire.jsp
 ...
 */
function GamCntnrQuayMtRentFeeSttusInqireModule() {}

GamCntnrQuayMtRentFeeSttusInqireModule.prototype = new EmdModule(1000, 600);

//페이지가 호출 되었을때 호출 되는 함수
GamCntnrQuayMtRentFeeSttusInqireModule.prototype.loadComplete = function() {
 
 // 테이블 설정 //       
 this.$("#cntnrQuayMtRentFeeSttusInqireList").flexigrid({
     module: this,
     url: '/oper/cntnr/gamSelectCntnrQuayMtRentFeeSttusInqireList.do',
     dataType: 'json',
     colModel : [
...
* 정의 된 버튼 클릭 시
*/
GamCntnrQuayMtRentFeeSttusInqireModule.prototype.onButtonClick = function(buttonId) {
	...
	switch(buttonId) {
	    ...
	    case 'searchBtn':
	        ...
	        var searchOpt=this.makeFormArgs('#gamCntnrQuayMtRentFeeSttusInqireSearchForm');
	        this.$('#cntnrQuayMtRentFeeSttusInqireList').flexOptions({params:searchOpt}).flexReload();
...
GamCntnrQuayMtRentFeeSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
	// 자산코드 조회
...
GamCntnrQuayMtRentFeeSttusInqireModule.prototype.onSubmit = function() {
 //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

 this.loadData();
};

GamCntnrQuayMtRentFeeSttusInqireModule.prototype.loadData = function() {
 var searchOpt=this.makeFormArgs('#gamCntnrQuayMtRentFeeSttusInqireSearchForm');
 //this.showAlert(searchOpt);
 this.$('#cntnrQuayMtRentFeeSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamCntnrQuayMtRentFeeSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
 switch(newTabId) {
 case 'tabs1':
     break;
 case 'tabs2':
...
var module_instance = new GamCntnrQuayMtRentFeeSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCntnrQuayMtRentFeeSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeeListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">컨테이너부두임대월별사용료 고지현황</a></li>
            </ul>
            <div id="tabs1" class="emdTabPage" data-onactivate="onShowTab1Activate">
            <table id="cntnrQuayMtRentFeeSttusInqireList" style="display:none" class="fillHeight"></table>
