...
<%
  /**
  * @Class Name : GamPrtOperRentFeeMngt.jsp
...
GamOperCodeModule.prototype.loadComplete = function() {
	...
	this.$("#operResultList").flexigrid({
		module: this,
		url: '<c:url value="/oper/gnrl/selectGamPrtOperRentFeeMngt.do"/>',
		dataType: 'json',
		colModel : [
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id="operManageTab" class="emdTabPanel" style="height:100%;" data-onchange="onTabChange">
			<ul>
				<li><a href="#tabs1" class="emdTab">항만시설사용료조회</a></li>
				<li><a href="#tabs2" class="emdTab">항만시설사용료상세</a></li>
				<!--
