 ...
 */
%>
<validator:javascript formName="gamSocPrtFcltyFeeExmpRqestSttusSearchForm" method="validateGamSocPrtFcltyFeeExmpRqestSttus" staticJavascript="false" dynamicJavascript="true" xhtml="true" cdata="false" />
...
GamSocPrtFcltyFeeExmpRqestSttusModule.prototype.loadComplete = function() {
    ...
    this.$("#socPrtFcltyFeeExmpRqestSttusList").flexigrid({
        ...
        colModel : [
                    ...
                    {display:'면제요청청', 	name:'appPrtAtCode',width:80, sortable:false,align:'left'},
                    {display:'요청업체', 	name:'appAgentCode',width:70, sortable:false,align:'center'},
                    {display:'요청업체명', 	name:'appAgentName',width:100, sortable:false,align:'left'},
                    ...
                    {display:'처리조건', 	name:'exmpCond',	width:130, sortable:false,align:'left'},
