...
<%
  /**
  * @Class Name : GamTestPrtFcltyRentFeeSttusByFeeTpInqire.jsp
 ...
 */
function GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule() {}

GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype = new EmdModule(1000, 600);

//페이지가 호출 되었을때 호출 되는 함수
GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.loadComplete = function() {

 // 테이블 설정 //
 this.$("#prtFcltyRentFeeSttusByFeeTpInqireList").flexigrid({
     module: this,
     url: '/oper/gnrltest/selectPrtFcltyMtRentFeeSttusInqireList.do',
     dataType: 'json',
     colModel : [
...
* 정의 된 버튼 클릭 시
*/
GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.onButtonClick = function(buttonId) {
...
GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
...
GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.onSubmit = function() {
	this.loadData();
};

GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.loadData = function() {
...
**/
%>
GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.downloadExcel = function(buttonId) {

	var gridRowCount = 0;
	switch (buttonId) {
		case 'btnExcelDownload':
			gridRowCount = this.$("#prtFcltyRentFeeSttusByFeeTpInqireList").flexRowCount();
			break;
		default:
			return;
	}
	...
	switch (buttonId) {
		case 'btnExcelDownload':
			this.$('#prtFcltyRentFeeSttusByFeeTpInqireList').flexExcelDown('/oper/gnrltest/selectPrtFcltyRentFeeSttusInqireListExcel.do');
			break;
	}
...
var module_instance = new GamTestPrtFcltyRentFeeSttusByFeeTpInqireModule();
</script>
<!-- 아래는 고정 -->
