...
GamCmmnCntrRentSttusInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#cmmnCntrRentSttusInqireList").flexigrid({
        module: this,
        url: '<c:url value="/oper/shed/gamSelectCmmnCntrRentSttusInqireList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#cmmnCntrRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#cmmnCntrRentListTab").tabs("option", {active: 1});
    });
...
GamCmmnCntrRentSttusInqireModule.prototype.loadRentList = function() {
    this.$("#cmmnCntrRentListTab").tabs("option", {active: 0});
...
GamCmmnCntrRentSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#cmmnCntrRentSttusInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamCmmnCntrRentSttusInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('<c:url value="/oper/shed/gamSelectCmmnCntrRentSttusInqireDetailList.do" />', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamCmmnCntrRentSttusInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamCmmnCntrRentSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#cmmnCntrRentSttusInqireList').selectedRows()[0];

    this.$('#cmmnCntrRentSttusInqireFileList').flexOptions({params:row}).flexReload();
};
...
GamCmmnCntrRentSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#cmmnCntrRentSttusInqireList').selectedRowCount()==0) {
    ...
    <div class="emdPanel fillHeight">
        <div id="cmmnCntrRentListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow:hidden;">
            	<h2>자산 임대 내역</h2>
                    <div id="gamCmmnCntrRentSttusInqireForm">
            	...
            	<h2>자산 임대 상세 내역</h2>
                    <div id="gamCmmnCntrRentSttusInqireDetailForm">
