 ...
 */
function GamCmmnCntrRentSttusInqireModule() {}

GamCmmnCntrRentSttusInqireModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamCmmnCntrRentSttusInqireModule.prototype.loadComplete = function() {

    // 테이블 설정
    this.$("#cmmnCntrRentSttusInqireList").flexigrid({
        module: this,
        url: '<c:url value="/oper/shed/selectCmmnCntrRentSttusInqireList.do" />',
        dataType: 'json',
        colModel : [
        ...
        preProcess: function(module,data) {
            ...
            module.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 0});    // 탭을 전환 한다.
    ...
    // 공컨장치장임대상세 테이블 설정
    this.$("#cmmnCntrRentSttusInqireDetailList").flexigrid({
        module: this,
        url: '<c:url value="/oper/shed/selectCmmnCntrRentSttusInqireDetailList.do" />',
        dataType: 'json',
        colModel : [
    ...
    // 첨부파일 테이블 설정
    this.$("#cmmnCntrRentSttusInqireFileList").flexigrid({
        module: this,
        url: '<c:url value="/oper/shed/gamSelectCmmnCntrRentSttusInqireFileList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#cmmnCntrRentSttusInqireList").on('onItemSelected', function(event, module, row, grid, param) {
    	module.$('#cmd').val('modify');
    	
    	module.$('#gamCmmnCntrRentSttusInqireForm :input').val('');
    	
    	module.makeFormValues('#gamCmmnCntrRentSttusInqireForm', row);
        module._editData=module.getFormValues('#gamCmmnCntrRentSttusInqireForm', row);
        module._editRow=module.$('#cmmnCntrRentSttusInqireList').selectedRowIds()[0];
        ...
        var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
        module.$('#cmmnCntrRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
        module.$('#cmmnCntrRentSttusInqireFileList').flexOptions({params:searchOpt}).flexReload();
    });
    
    this.$("#cmmnCntrRentSttusInqireDetailList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.$('#btnApplyGisAssetsCode').prop('disabled', false);
        module.$('#gamCmmnCntrRentSttusInqireDetailForm :input').val('');
        
        //module.makeFormValues('#gamCmmnCntrRentSttusInqireDetailForm', row);
        module.makeDivValues('#gamCmmnCntrRentSttusInqireDetailForm', row);
        module._editData=module.getFormValues('#gamCmmnCntrRentSttusInqireDetailForm', row);
        module._editRow=module.$('#cmmnCntrRentSttusInqireDetailList').selectedRowIds()[0];
    });
    
    this.$("#cmmnCntrRentSttusInqireFileList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.makeFormValues('#gamCmmnCntrRentSttusInqireFileForm', row);
        module.makeDivValues('#gamCmmnCntrRentSttusInqireFileForm', row);
        module._editDataFile=module.getFormValues('#gamCmmnCntrRentSttusInqireFileForm', row);
        module._editRowFile=module.$('#cmmnCntrRentSttusInqireFileList').selectedRowIds()[0];
    ...
    this.$("#cmmnCntrRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 1});    
        module.$('#cmd').val('modify');
        module.$('#gamCmmnCntrRentSttusInqireForm :input').val('');
    ...
    this.$("#cmmnCntrRentSttusInqireDetailList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 2});
        module.$('#gamCmmnCntrRentSttusInqireDetailForm :input').val('');
 ...
 * 정의 된 버튼 클릭 시
 */
 GamCmmnCntrRentSttusInqireModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        // 최초신청
        case 'addCmmnCntrRentSttusInqireFirst':
            this.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            //this.$(":input").val('');
            this.$('#gamCmmnCntrRentSttusInqireForm :input').val("");
            this.$("#cmd").val('insert');

            break;

        // 연장신청
        case 'addCmmnCntrRentSttusInqireRenew':
            var rows = this.$('#cmmnCntrRentSttusInqireList').selectedRows();

            if(rows.length>=1) {
                //this.$('#rPrtAtCode').val(row[0]['prtAtCode']);

                this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentSttusInqireRenew.do" />', rows[0], function(module, result) {

                    if(result.resultCode=='0') {

                        var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireSearchForm');
                        module.$('#cmmnCntrRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        // 공컨장치장임대현황 저장
        case 'btnSaveItem':
            var inputVO=this.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
            if(this.$("#cmd").val()=='insert') {

            	this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentSttusInqireFirst.do" />', inputVO, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/shed/gamUpdateCmmnCntrRentSttusInqire.do" />', inputVO, function(module, result) {
                	if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
                        module.$('#cmmnCntrRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnRemoveItem':
            if( this.$('#cmd').val() == 'modify' ) {
                ...
                this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentSttusInqire.do" />', inputVO, function(module, result) {
                ...
                this.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
                this.$('#gamCmmnCntrRentSttusInqireForm :input').val("");
                this.$("#cmd").val('insert');
        ...
        case 'btnInsertItemDetail':
        	...
        	if( this.$('#prtAtCode').val() == '' ) {
        		alert("공컨장치장임대현황상세 조회후 등록이 가능합니다.");
        	} else {
        		this.$("#cmmnCntrRentSttusInqireListTab").tabs("option", {active: 2});  // 탭을 전환 한다.
                this.$('#gamCmmnCntrRentSttusInqireDetailForm :input').val("");
        ...
        case 'btnRemoveItemDetail':
            ...
            var rows = this.$('#cmmnCntrRentSttusInqireDetailList').selectedRows();

            if(rows.length>=1) {
                this.doAction('<c:url value="/oper/shed/gamDeleteCmmnCntrRentSttusInqireDetail.do" />', rows[0], function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
                        module.$('#cmmnCntrRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnSaveItemDetail':
            ...
            var inputVO=this.makeFormArgs('#gamCmmnCntrRentSttusInqireDetailForm');
            if(this.$("#detailCmd").val()=='insert') {

                this.doAction('<c:url value="/oper/shed/gamInsertCmmnCntrRentSttusInqireDetail.do" />', inputVO, function(module, result) {
            	...
            	this.doAction('<c:url value="/oper/shed/gamUpdateCmmnCntrRentSttusInqireDetail.do" />', inputVO, function(module, result) {
                    if(result.resultCode=='0') {
                    	var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
                        module.$('#cmmnCntrRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'popupEntrpsInfoInput': // 팝업을 호출한다.(공컨장치장임대현황입력)
            var opts;
        ...
        case 'btnPrmisn': // 승낙 (허가)
            ...
            if(rows.length>=1) {
                ...
                this.doExecuteDialog('insertCmmnCntrRentSttusInqirePrmisnPopup', '승낙', '<c:url value="/oper/shed/popup/showCmmnCntrRentSttusInqirePrmisn.do"/>', opts);
        ...
        case 'btnPrmisnCancel': // 승낙취소 (허가취소)
            ...
            if(rows.length>=1) {
                this.doAction('<c:url value="/oper/shed/gamUpdateCmmnCntrRentSttusInqirePrmisnCancel.do" />', rows[0], function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamCmmnCntrRentSttusInqireForm');
                        module.$('#cmmnCntrRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnDownloadFile':
    		var selectRow = this.$('#cmmnCntrRentSttusInqireFileList').selectedRows();
...
GamCmmnCntrRentSttusInqireModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamCmmnCntrRentSttusInqireModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamCmmnCntrRentSttusInqireSearchForm');
    //this.showAlert(searchOpt);
    this.$('#cmmnCntrRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamCmmnCntrRentSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
        var row = this.$('#cmmnCntrRentSttusInqireList').selectedRows();
        if(row.length==0) {
            this.$('#cmd').val('insert');
        }
        else {
        ...
        break;
    case 'tabs3':
    	var row = this.$('#cmmnCntrRentSttusInqireDetailList').selectedRows();
        if(row.length==0) {
            this.$('#detailCmd').val('insert');
        }
        else {
...
GamCmmnCntrRentSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
     ...
     case 'insertEntrpsInfoPopup':
         ...
         break;
     case 'insertCmmnCntrRentSttusInqirePrmisnPopup':
    	 if (msg != 'cancel') {
    		 if( value == "0" ) {
    			 var searchOpt=this.makeFormArgs('#gamCmmnCntrRentSttusInqireSearchForm');
                 this.$('#cmmnCntrRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
...
var module_instance = new GamCmmnCntrRentSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCmmnCntrRentSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="cmmnCntrRentSttusInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">공컨장치장임대현황 목록</a></li>
                <li><a href="#tabs2" class="emdTab">공컨장치장임대현황 내역</a></li>
                <li><a href="#tabs3" class="emdTab">공컨장치장임대현황 상세내역</a></li>
                <li><a href="#tabs4" class="emdTab">첨부파일</a></li>
            </ul>

            <div id="tabs1" class="emdTabPage" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <table id="cmmnCntrRentSttusInqireList" style="display:none" class="fillHeight"></table>
    	               	...
    	               	<table style="width:100%;">
	                        <tr>
                                ...
                                <!--
                                 ...
                                 <button id="addCmmnCntrRentSttusInqireRenew">연장신청</button>
								-->
	                            </td>
	                        </tr>
						</table>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                <!--<div class="emdControlPanel"></div>-->
                    <form id="gamCmmnCntrRentSttusInqireForm">
                 ...
                 <table id="cmmnCntrRentSttusInqireDetailList" style="display:none"></table>

                 <table style="width:100%">
                 	<!-- 
                    <tr>
                        <td style="text-align:right" colspan="3"><button id="btnInsertItemDetail">공컨장치장임대상세추가</button><button id="btnRemoveItemDetail">공컨장치장임대상세삭제</button></td>
                    </tr>
                     -->
                    <!--
                    <tr>
            ...
            <div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItemDetail">저장</button></div> -->
                    <form id="gamCmmnCntrRentSttusInqireDetailForm">
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td width="100"></td>
                        <td style="text-align:right">
                        <button id="xxxx">취소</button><button id="xxxx">공컨장치장임대상세적용</button>
                        &nbsp;
                        </td>
                    </tr>
                </table>
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <table id="cmmnCntrRentSttusInqireFileList" style="display:none" class="fillHeight"></table>
                <div class="emdControlPanel"><button id="btnDownloadFile">다운로드</button></div>
                <form id="gamCmmnCntrRentSttusInqireFileForm">
