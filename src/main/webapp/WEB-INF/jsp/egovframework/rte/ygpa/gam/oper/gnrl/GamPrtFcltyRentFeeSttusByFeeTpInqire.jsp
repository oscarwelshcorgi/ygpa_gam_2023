...
GamPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.loadComplete = function() {
 ...
 this.$("#prtFcltyRentFeeSttusByFeeTpInqireList").flexigrid({
     module: this,
     url: '/oper/gnrl/selectPrtFcltyMtRentFeeSttusInqireList.do',
     dataType: 'json',
     colModel : [
...
**/
%>
GamPrtFcltyRentFeeSttusByFeeTpInqireModule.prototype.downloadExcel = function(buttonId) {
	...
	switch (buttonId) {
		case 'btnExcelDownload':
			this.$('#prtFcltyRentFeeSttusByFeeTpInqireList').flexExcelDown('/oper/gnrl/selectPrtFcltyRentFeeSttusInqireListExcel.do');
			break;
	}
