...
<%
  /**
  * @Class Name : GamNticArrvlDtaInqire.jsp
  * @Description : 고지도래자료조회 테스트 (Prototype)
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">고지도래</a></li>
			...
			<div id="tabs1" class="emdTabPage">
				...
				<div class="emdControlPanel"><button id="loadMap">프린터</button></div>
			</div>
