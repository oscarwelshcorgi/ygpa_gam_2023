 ...
 GamCntnrQuayRentFeePaySttusMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'btnUpdatePayDtls':	// 납부 현황 새로 고침
            this.doAction('<c:url value="/oper/cntnr/updateCntnrQuayRentFeePaySttusMngtList.do" />', null, function(module, result) {
        	...
        	break;
        case 'btnNticArrrg':
            this.doExecuteDialog('nticArrrgPopup', '연체 일괄 고지', '<c:url value="/oper/cntnr/showNticArrrgPopup.do"/>', opts);
        	break;
...
GamCntnrQuayRentFeePaySttusMngtModule.prototype.nticArrrgSingle = function() {
	...
	var nticDetail = [
	 	...
	 	this.doAction('<c:url value="/oper/cntnr/insertNticArrrg.do" />', nticDetail, function(module, result) {
		if (result.resultCode == "0") {
		} else {
		}
		alert(result.resultMsg);
...
GamCntnrQuayRentFeePaySttusMngtModule.prototype.loadDetailPage = function() {
	...
	var nticDetail = [
	 	...
	 	this.doAction('<c:url value="/oper/cntnr/selectCntnrQuayRentFeePaySttusMngtDetail.do" />', nticDetail, function(module, result) {
		if (result.resultCode == "0") {
	 ...
	 // tabs3 -- 연체목록을 채운다 
		...
		this.doAction('<c:url value="/oper/gnrl/selectCntnrQuayRentFeePaySttusMngtListDlyList.do" />', dlyList, function(module, result) {
			if (result.resultCode == "0") {
...
GamCntnrQuayRentFeePaySttusMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    ...
    case 'tabs2':
        ...
        break;
	case 'tabs3':
		this.$("#cntnrQuayRentFeePaySttusMngtListTab").tabs("option", {active: 2});    // 탭을 전환 한다.
	    break;
	}
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="cntnrQuayRentFeePaySttusMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
                <li><a href="#tabs1" class="emdTab">컨테이너부두임대료납부현황 목록</a></li>
                <li><a href="#tabs2" class="emdTab">컨테이너부두임대료납부현황 상세</a></li>
                <li><a href="#tabs3" class="emdTab">컨테이너부두임대료연체현황 목록</a></li>
            </ul>
			...
			<div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItem">저장</button><button id="btnCancelItem">취소</button><button id="btnRemoveItem">삭제</button></div>  -->
                    ...
                    <table style="width:100%;" id="cntnrQuayRentFeePaySttusMngtSum" class="summaryPanel">
						<tr>
