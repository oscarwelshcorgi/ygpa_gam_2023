                ...
                <table style="width:100%;" class="searchPanel">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <th>고지일자</th>
                            <td><input id="sNticDtFrom" data-column-id="nticPdFrom" type="text" class="emdcal"size="8"> ~ <input id="sNticDtTo" data-column-id="nticPdFrom" type="text"class="emdcal" size="8"></td>
                            <th>요금종류</th>
        ...
        <div id="cntnrQuayRentFeePaySttusMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            ...
            <div id="tabs1" class="emdTabPage fillHeight" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                ...
                <div class="emdControlPanel" style="vertical-align: middle;">
                	<table id="cntnrQuayRentFeePaySttusMngtListSum" class="summaryPanel" style="display:inline-table; vertical-align: middle; float:left;">
                		<tr>
                			<th>자료수</th>
