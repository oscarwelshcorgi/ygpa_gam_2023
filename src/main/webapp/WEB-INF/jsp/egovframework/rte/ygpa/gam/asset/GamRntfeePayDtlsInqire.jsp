...
<%
  /**
  * @Class Name : GamRntfeePayDtlsInqire.jsp
  * @Description : 사용료납부내역조회 테스트 (Prototype)
...
GamAssetCodeListModule.prototype.loadComplete = function() {
	...
	this.$("#assetCodeList").flexigrid({
		...
		dataType: 'json',
		colModel : [
			{display:'징수 항코드', name:'PRT_AT_CODE',width:100, sortable:false,align:'center'},
			{display:'요금 종류', name:'CHRGE_KND',width:100, sortable:false,align:'center'},
			{display:'징수 회계년도', name:'ACCNUT_YEAR',width:100, sortable:false,align:'center'},
			{display:'고지 번호',name:'NTICNO',width:100,sortable:false,align:'center'},
			{display:'고지 일지',name:'NTIC_DT',width:100,sortable:false,align:'center'},
			{display:'고지 금액',name:'NTIC_AMT',width:100,sortable:false,align:'center'},
			{display:'납부 기한',name:'PAY_TMLMT',width:100,sortable:false,align:'center'},
			{display:'수납이체 상태코드',name:'RCIV_TRANSFR_STTUS_CD',width:100,sortable:false,align:'center'},
			{display:'수납 일자',name:'RCIV_DT',width:100,sortable:false,align:'center'},
			{display:'불능 코드',name:'INCPCTY_CD',width:100,sortable:false,align:'center'},
			{display:'CHARGER',name:'RCIV_DT',width:100,sortable:false,align:'center'}
...
<div class="window_main">
	...
	<div class="emdPanel">
		<div id='' class="emdTabPanel">
			<ul>
				<li><a href="#tabs1" class="emdTab">사용료 납부목록</a></li>
