 ...
 GamPrtFcltyRentFeePaySttusMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'btnUpdatePayDtls':	// 납부 현황 새로 고침
            this.doAction('/oper/gnrl/updatePrtFcltyRentFeePaySttusMngtList.do', null, function(module, result) {
        ...
        case 'btnRecivePay':
        	...
        	break;
        case 'btnNticArrrg':
            this.doExecuteDialog('nticArrrgPopup', '연체 일괄 고지', '/oper/gnrl/showNticArrrgPopup.do', opts);
        	break;
        ...
        case 'btnNticIssuePrint2':
            ...
            this.printPayNotice('/oper/gnrl/printPrtFcltyRentFeePayNotice2.do', row);
        	break;
	 	...
	 	this.doAction('/oper/gnrl/updateNticArrrg.do', arrrgDetail, function(module, result) {
			if (result.resultCode == "0") {
				if(confirm('연체 고지 되었습니다. 바로 납부 고지서를 출력 하시겠습니까?')) {
					module.printPayNotice('/oper/gnrl/printPrtFcltyRentFeePayNotice.do', row);
				}
			} else {
				alert(result.resultMsg);
			}
...
GamPrtFcltyRentFeePaySttusMngtModule.prototype.receiveFeeSingle = function() {
    if(this.$('#prtFcltyRentFeePaySttusMngtList').selectedRowCount()>0) {

        var rows = this.$('#prtFcltyRentFeePaySttusMngtList').selectedRows()[0];

     	this.doAction('/oper/gnrl/checkOcrResult.do', rows, function(module, result) {
    		if (result.resultCode == "0") {
    	    	...
    	    	module.doExecuteDialog('feePayPopup', '수납 처리', '/oper/gnrl/showFeePayPopup.do', opts);
    		} else {
    			alert(result.resultMsg);
    		}
    	});
...
GamPrtFcltyRentFeePaySttusMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    ...
    case 'feePayPopup':
    	if (msg != 'cancel') {
            ...
            this.doAction('/oper/gnrl/updateRevCollRcvdTp.do', arg, function(module, result) {
