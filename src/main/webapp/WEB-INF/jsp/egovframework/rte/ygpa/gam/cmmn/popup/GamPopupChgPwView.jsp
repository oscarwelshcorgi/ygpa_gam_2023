 ...
 */
function GamChangePassWordPopupModule() {}

/* 팝업모듈 초기화 */
GamChangePassWord.prototype = new EmdPopupModule(640, 480);

// 팝업이 호출 되었을때 호출 되는 함수
GamChangePassWord.prototype.loadComplete = function() {
 ...
 * 정의 된 버튼 클릭 시
 */
 GamChangePassWord.prototype.onButtonClick = function(buttonId) {
...
var popup_instance = new GamChangePassWord();
</script>
<div class="dialog">
	<div class="emdPanel">
		<div class="viewStack">
