...
GamMapPopupModule.prototype.onButtonClick = function(buttonId) {
    switch(buttonId) {
        case 'fcltyCdMngt':
        	EMD.util.create_window("gamInfoCommFcltySpecMng", "정보통신시설 제원 관리", "/fclty/gamInfoCommFcltySpecMng.do", null, {
            ...
            break;
        case 'fcltyCdInqire':
        	EMD.util.create_window("gamInfoCommFcltySpecInqire", "정보통신시설 제원 조회", "/fclty/gamInfoCommFcltySpecInqire.do", null, {
        		action: "prtFcltyInqire"
       			,gisPrtAtCode: this.$('#gisAssetsPrtAtCode').val()
       			,gisAssetsCd: this.$('#gisAssetsCd').val()
       			,gisAssetsSubCd: this.$('#gisAssetsSubCd').val()
        ...
        case 'fcltyQcMng':
        	...
        	break;
        case 'assignFeature':
        	EMD.util.create_window("gamInfoTechFcltySpecMng", "시설 제원 코드 지정", "/fclty/gamInfoTechFcltySpecMng.do", null, {
        		action: "setFeature"
