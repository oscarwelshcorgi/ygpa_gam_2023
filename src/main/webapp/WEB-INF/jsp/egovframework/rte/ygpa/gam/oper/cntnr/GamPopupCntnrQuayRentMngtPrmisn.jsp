...
GamPopupPrtOperRentModule.prototype.onButtonClick = function(buttonId) {
	...
	case 'btnPrmisnExec':
		...
		if( confirm("승낙 하시겠습니까?") ) {
	        ...
	        //this.doAction('/oper/cntnr/gamInsertCntnrQuayRentMngtPrmisn.do', inputVO, function(module, result) {
	        this.doAction('/oper/cntnr/gamUpdateCntnrQuayRentMngtPrmisn.do', inputVO, function(module, result) {
