...
GamPrtFcltyUseExprInqireModule.prototype.loadDetailForm = function() {
		...
		this.makeDivValues('#gamPrtFcltyUseExprInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('/oper/gnrl/gamSelectPrtFcltyUseExprInqireDetailList.do', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamPrtFcltyUseExprInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamPrtFcltyUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
...
**/
%>
GamPrtFcltyUseExprInqireModule.prototype.downloadExcel = function(buttonId) {
	...
	switch (buttonId) {
		case 'btnExcelDownload':
			this.$('#prtFcltyUseExprInqireList').flexExcelDown('/oper/gnrl/selectPrtFcltyExprInqireListExcel.do');
			break;
	}
    ...
    <div class="emdPanel fillHeight">
        <div id="prtFcltyUseExprInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                	...
                	<!-- <h2>항만시설사용 내역</h2> -->
                	<div id="gamPrtFcltyUseExprInqireForm">
                	...
                	<!-- <h2>항만시설사용 상세내역</h2> -->
                 	<div id="gamPrtFcltyUseExprInqireDetailForm">
