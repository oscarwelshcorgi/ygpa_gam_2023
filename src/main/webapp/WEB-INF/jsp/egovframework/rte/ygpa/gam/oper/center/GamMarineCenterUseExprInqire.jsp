...
GamMarineCenterUseExprInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#marineCenterUseExprInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#marineCenterUseExprInqireListTab").tabs("option", {active: 1});
    });
...
GamMarineCenterUseExprInqireModule.prototype.loadUseList = function() {
    this.$("#marineCenterUseExprInqireListTab").tabs("option", {active: 0});
...
GamMarineCenterUseExprInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#marineCenterUseExprInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamMarineCenterUseExprInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('<c:url value="/oper/center/gamSelectMarineCenterUseExprInqireDetailList.do" />', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamMarineCenterUseExprInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamMarineCenterUseExprInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#marineCenterUseExprInqireList').selectedRowCount()==0) {
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="marineCenterUseExprInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                <h2>자산 임대 내역</h2>    
                	<div id="gamMarineCenterUseExprInqireForm">
                 ...
                 <h2>자산 임대 상세 내역</h2>
                 	<div id="gamMarineCenterUseExprInqireDetailForm">
