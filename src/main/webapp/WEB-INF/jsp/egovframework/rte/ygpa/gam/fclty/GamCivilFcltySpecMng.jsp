...
**/
GamCivilFcltySpecMngModule.prototype.validateDuration = function(startDate, endDate, startTitle, endTitle, startIgnore, equals) {
	var result = false;	
				...
				<div style="margin-bottom:10px;">
					...
					<table class="searchPanel">
						...
						<tr>
							...
							<td><input id="hydrntQy" type="text" size="50" class="ygpaNumber" /> 개</td>
						</tr>
						<tr>
						...
						<tr>
						<th width="12%" height="17" >시설물분류코드</th>
							<td colspan="3">
