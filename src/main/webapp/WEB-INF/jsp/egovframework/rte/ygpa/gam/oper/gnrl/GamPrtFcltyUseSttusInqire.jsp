...
GamPrtFcltyUseSttusInqireModule.prototype = new EmdModule(1000, 600);
...
GamPrtFcltyUseSttusInqireModule.prototype.loadRentList = function() {
...
GamPrtFcltyUseSttusInqireModule.prototype.loadDetailForm = function() {
...
GamPrtFcltyUseSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#prtFcltyUseSttusInqireList').selectedRows()[0];
...
GamPrtFcltyUseSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
        ...
        <div id="prtFcltyUseSttusInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow:hidden;">
            	<!-- <h2>항만시설사용 내역</h2> -->
                    ...
                    <div id="gamPrtFcltyUseSttusInqireForm">
            	...
            	<!-- <h2>항만시설사용 상세내역</h2> -->
                    ...
                    <div id="gamPrtFcltyUseSttusInqireDetailForm">
