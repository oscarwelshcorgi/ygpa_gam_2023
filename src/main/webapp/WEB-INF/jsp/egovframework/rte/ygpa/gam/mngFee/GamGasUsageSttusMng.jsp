...
**/
%>
GamGasUsageSttusMngModule.prototype.firstData = function() {
...
**/
%>
GamGasUsageSttusMngModule.prototype.prevData = function() {
...
**/
%>
GamGasUsageSttusMngModule.prototype.nextData = function() {
...
**/
%>
GamGasUsageSttusMngModule.prototype.lastData = function() {
					...
					<form id="detailForm">
						<table class="detailPanel" style="width:100%;">
							...
							<tr>
								...
								<td>
									<input type="text" size="25" id="mngFeeFcltyCd" disabled/>
								</td>
							</tr>
							<tr>
