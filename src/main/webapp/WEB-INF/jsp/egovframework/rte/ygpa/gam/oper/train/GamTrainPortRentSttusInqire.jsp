 ...
 */
 function GamTrainPortRentSttusModule() {}

 GamTrainPortRentSttusModule.prototype = new EmdModule(910, 550);

 // 페이지가 호출 되었을때 호출 되는 함수
 GamTrainPortRentSttusModule.prototype.loadComplete = function() {
  ...
  * 정의 된 버튼 클릭 시
  */
  GamTrainPortRentSttusModule.prototype.onButtonClick = function(buttonId) {
 ...
 GamTrainPortRentSttusModule.prototype.onSubmit = function() {
     this.loadData();
 };

 GamTrainPortRentSttusModule.prototype.loadData = function() {
     var searchOpt=this.makeFormArgs('#gamOperSearchForm');
     this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
 };
...
GamTrainPortRentSttusModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
 ...
 var module_instance = new GamTrainPortRentSttusModule();
 </script>
 <!-- 아래는 고정 -->
     ...
     <div class="emdPanel fillHeight">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 ...
                 <li><a href="#tabs2" class="emdTab">철송장사용현황 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">철송장사용현황 상세조회내역</a></li>
             </ul>
