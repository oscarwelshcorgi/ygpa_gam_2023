...
GamTrainPortRentSttusInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#trainPortRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#trainPortRentListTab").tabs("option", {active: 1});
    });
...
GamTrainPortRentSttusInqireModule.prototype.loadRentList = function() {
    this.$("#trainPortRentListTab").tabs("option", {active: 0});
...
GamTrainPortRentSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#trainPortRentSttusInqireList').selectedRows()[0];
...
GamTrainPortRentSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#trainPortRentSttusInqireList').selectedRows()[0];

    this.$('#trainPortRentSttusInqireFileList').flexOptions({params:row}).flexReload();
};
...
GamTrainPortRentSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#trainPortRentSttusInqireList').selectedRowCount()==0) {
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="trainPortRentListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow:hidden;">
            	<h2>자산 임대 내역</h2>
                    <div id="gamTrainPortRentSttusInqireForm">
            	...
            	<h2>자산 임대 상세 내역</h2>
                    <div id="gamTrainPortRentSttusInqireDetailForm">
