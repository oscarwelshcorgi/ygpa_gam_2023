...
<%
  /**
  * @Class Name : GamTrainPortRentSttusInqire.jsp
 ...
 */
function GamTrainPortRentSttusInqireModule() {}

GamTrainPortRentSttusInqireModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamTrainPortRentSttusInqireModule.prototype.loadComplete = function() {

    // 테이블 설정
    this.$("#trainPortRentSttusInqireList").flexigrid({
        module: this,
        url: '<c:url value="/oper/train/selectTrainPortRentSttusInqireList.do" />',
        dataType: 'json',
        colModel : [
        ...
        preProcess: function(module,data) {
            ...
            module.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 0});    // 탭을 전환 한다.
    ...
    // 철송장임대상세 테이블 설정
    this.$("#trainPortRentSttusInqireDetailList").flexigrid({
        module: this,
        url: '<c:url value="/oper/train/selectTrainPortRentSttusInqireDetailList.do" />',
        dataType: 'json',
        colModel : [
    ...
    this.$("#trainPortRentSttusInqireList").on('onItemSelected', function(event, module, row, grid, param) {
    	module.$('#cmd').val('modify');
    	
    	module.$('#gamTrainPortRentSttusInqireForm :input').val('');
    	
    	module.makeFormValues('#gamTrainPortRentSttusInqireForm', row);
        module._editData=module.getFormValues('#gamTrainPortRentSttusInqireForm', row);
        module._editRow=module.$('#trainPortRentSttusInqireList').selectedRowIds()[0];
        ...
        var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireForm');
        module.$('#trainPortRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
        module.$('#trainPortRentSttusInqireFileList').flexOptions({params:searchOpt}).flexReload();
    });
    
    this.$("#trainPortRentSttusInqireDetailList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.$('#btnApplyGisAssetsCode').prop('disabled', false);
        module.$('#gamTrainPortRentSttusInqireDetailForm :input').val('');
        
        //module.makeFormValues('#gamTrainPortRentSttusInqireDetailForm', row);
        module.makeDivValues('#gamTrainPortRentSttusInqireDetailForm', row);
        module._editData=module.getFormValues('#gamTrainPortRentSttusInqireDetailForm', row);
        module._editRow=module.$('#trainPortRentSttusInqireDetailList').selectedRowIds()[0];
    });
    
    this.$("#trainPortRentSttusInqireFileList").on('onItemSelected', function(event, module, row, grid, param) {
        //module.makeFormValues('#gamTrainPortRentSttusInqireFileForm', row);
        module.makeDivValues('#gamTrainPortRentSttusInqireFileForm', row);
        module._editDataFile=module.getFormValues('#gamTrainPortRentSttusInqireFileForm', row);
        module._editRowFile=module.$('#trainPortRentSttusInqireFileList').selectedRowIds()[0];
    ...
    this.$("#trainPortRentSttusInqireList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 1});    
        module.$('#cmd').val('modify');
        module.$('#gamTrainPortRentSttusInqireForm :input').val('');
    ...
    this.$("#trainPortRentSttusInqireDetailList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        module.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 2});
        module.$('#gamTrainPortRentSttusInqireDetailForm :input').val('');
 ...
 * 정의 된 버튼 클릭 시
 */
 GamTrainPortRentSttusInqireModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        // 최초신청
        case 'addTrainPortRentSttusInqireFirst':
            this.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 1});  // 탭을 전환 한다.
            //this.$(":input").val('');
            this.$('#gamTrainPortRentSttusInqireForm :input').val("");
            this.$("#cmd").val('insert');

            break;

        // 연장신청
        case 'addTrainPortRentSttusInqireRenew':
            var rows = this.$('#trainPortRentSttusInqireList').selectedRows();

            if(rows.length>=1) {
                //this.$('#rPrtAtCode').val(row[0]['prtAtCode']);

                this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentSttusInqireRenew.do" />', rows[0], function(module, result) {

                    if(result.resultCode=='0') {

                        var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireSearchForm');
                        module.$('#trainPortRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        // 철송장임대현황 저장
        case 'btnSaveItem':
            var inputVO=this.makeFormArgs('#gamTrainPortRentSttusInqireForm');
            if(this.$("#cmd").val()=='insert') {

            	this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentSttusInqireFirst.do" />', inputVO, function(module, result) {
                ...
                this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentSttusInqire.do" />', inputVO, function(module, result) {
                	if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireForm');
                        module.$('#trainPortRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnRemoveItem':
            if( this.$('#cmd').val() == 'modify' ) {
                ...
                this.doAction('<c:url value="/oper/train/gamDeleteTrainPortRentSttusInqire.do" />', inputVO, function(module, result) {
                ...
                this.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 0});  // 탭을 전환 한다.
                this.$('#gamTrainPortRentSttusInqireForm :input').val("");
                this.$("#cmd").val('insert');
        ...
        case 'btnInsertItemDetail':
        	...
        	if( this.$('#prtAtCode').val() == '' ) {
        		alert("철송장임대현황상세 조회후 등록이 가능합니다.");
        	} else {
        		this.$("#trainPortRentSttusInqireListTab").tabs("option", {active: 2});  // 탭을 전환 한다.
                this.$('#gamTrainPortRentSttusInqireDetailForm :input').val("");
        ...
        case 'btnRemoveItemDetail':
            ...
            var rows = this.$('#trainPortRentSttusInqireDetailList').selectedRows();

            if(rows.length>=1) {
                this.doAction('<c:url value="/oper/train/gamDeleteTrainPortRentSttusInqireDetail.do" />', rows[0], function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireForm');
                        module.$('#trainPortRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnSaveItemDetail':
            ...
            var inputVO=this.makeFormArgs('#gamTrainPortRentSttusInqireDetailForm');
            if(this.$("#detailCmd").val()=='insert') {

                this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentSttusInqireDetail.do" />', inputVO, function(module, result) {
            	...
            	this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentSttusInqireDetail.do" />', inputVO, function(module, result) {
                    if(result.resultCode=='0') {
                    	var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireForm');
                        module.$('#trainPortRentSttusInqireDetailList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'popupEntrpsInfoInput': // 팝업을 호출한다.(철송장임대현황입력)
            var opts;
        ...
        case 'btnPrmisn': // 승낙 (허가)
            ...
            if(rows.length>=1) {
                ...
                this.doExecuteDialog('insertTrainPortRentSttusInqirePrmisnPopup', '승낙', '<c:url value="/oper/train/popup/showTrainPortRentSttusInqirePrmisn.do"/>', opts);
        ...
        case 'btnPrmisnCancel': // 승낙취소 (허가취소)
            ...
            if(rows.length>=1) {
                this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentSttusInqirePrmisnCancel.do" />', rows[0], function(module, result) {
                    if(result.resultCode=='0') {
                        var searchOpt=module.makeFormArgs('#gamTrainPortRentSttusInqireForm');
                        module.$('#trainPortRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
                    }
        ...
        case 'btnDownloadFile':
    		var selectRow = this.$('#trainPortRentSttusInqireFileList').selectedRows();
...
GamTrainPortRentSttusInqireModule.prototype.onSubmit = function() {
    //this.showAlert(this.$('#prtCode').val()+'을(를) 조회 하였습니다');

    this.loadData();
};

GamTrainPortRentSttusInqireModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamTrainPortRentSttusInqireSearchForm');
    //this.showAlert(searchOpt);
    this.$('#trainPortRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamTrainPortRentSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
        var row = this.$('#trainPortRentSttusInqireList').selectedRows();
        if(row.length==0) {
            this.$('#cmd').val('insert');
        }
        else {
        ...
        break;
    case 'tabs3':
    	var row = this.$('#trainPortRentSttusInqireDetailList').selectedRows();
        if(row.length==0) {
            this.$('#detailCmd').val('insert');
        }
        else {
...
GamTrainPortRentSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
     ...
     case 'insertEntrpsInfoPopup':
         ...
         break;
     case 'insertTrainPortRentSttusInqirePrmisnPopup':
    	 if (msg != 'cancel') {
    		 if( value == "0" ) {
    			 var searchOpt=this.makeFormArgs('#gamTrainPortRentSttusInqireSearchForm');
                 this.$('#trainPortRentSttusInqireList').flexOptions({params:searchOpt}).flexReload();
...
var module_instance = new GamTrainPortRentSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamTrainPortRentSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="trainPortRentSttusInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
            <ul>
                <li><a href="#tabs1" class="emdTab">철송장임대현황 목록</a></li>
                <li><a href="#tabs2" class="emdTab">철송장임대현황 내역</a></li>
                <li><a href="#tabs3" class="emdTab">철송장임대현황 상세내역</a></li>
                <li><a href="#tabs4" class="emdTab">첨부파일</a></li>
            </ul>

            <div id="tabs1" class="emdTabPage" style="overflow: hidden;" data-onactivate="onShowTab1Activate">
                <table id="trainPortRentSttusInqireList" style="display:none" class="fillHeight"></table>
    	               	...
    	               	<table style="width:100%;">
	                        <tr>
                                ...
                                <!--
                                 ...
                                 <button id="addTrainPortRentSttusInqireRenew">연장신청</button>
								-->
	                            </td>
	                        </tr>
						</table>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow: scroll;">
                <!-- <div class="emdControlPanel"></div>-->
                    <form id="gamTrainPortRentSttusInqireForm">
                 ...
                 <table id="trainPortRentSttusInqireDetailList" style="display:none"></table>

                 <table style="width:100%">
                 	<!-- 
                    <tr>
                        <td style="text-align:right" colspan="3"><button id="btnInsertItemDetail">철송장임대상세추가</button><button id="btnRemoveItemDetail">철송장임대상세삭제</button></td>
                    </tr>
                     -->
                    <!--
                    <tr>
            ...
            <div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItemDetail">저장</button></div> -->
                    <form id="gamTrainPortRentSttusInqireDetailForm">
                ...
                <table style="width:100%">
                    <tr>
                        ...
                        <td width="100"></td>
                        <td style="text-align:right">
                        <button id="xxxx">취소</button><button id="xxxx">철송장임대상세적용</button>
                        &nbsp;
                        </td>
                    </tr>
                </table>
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <table id="trainPortRentSttusInqireFileList" style="display:none" class="fillHeight"></table>
                <div class="emdControlPanel"><button id="btnDownloadFile">다운로드</button></div>
                <form id="gamTrainPortRentSttusInqireFileForm">
