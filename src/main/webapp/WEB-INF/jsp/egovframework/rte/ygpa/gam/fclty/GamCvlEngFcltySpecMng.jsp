...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.buildFcltyMaintMngList = function() {
	...
	this.doAction('/fclty/gamSelectCvlEngFcltySpecMngMntnRprDtlsList.do', searchVO, function(module, result) {
		if (result.resultCode == "0") {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.showFcltyMaintMngList = function(argParent) {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.hideFcltyMaintMngList = function() {
...
GamCvlEngFcltySpecMngModule.prototype.onButtonClick = function(buttonId) {
	...
	switch (buttonId) {
		...
		case 'btnExcelFormDownload':
			window.open("<c:url value='/form/gamCvlEngFcltySpecMng.xlsx' />", '_blank');
			break;
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.selectFileData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.firstData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.prevData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.nextData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.lastData = function() {
...
**/
%>
 GamCvlEngFcltySpecMngModule.prototype.copyData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.selectAllFile = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.downloadMultiFile = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.deleteMultiFileData = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.displayPreviewFile = function() {
...
**/
%>
GamCvlEngFcltySpecMngModule.prototype.showFcltsAtchFileViewPopup = function() {
					...
					<form id="listSumForm">
						<table style="width:100%;">
							<tr>
								...
								<td><input type="text" size="12" id="sumYardAr" class="ygpaNumber" disabled="disabled"/></td>
								<th style="width:8%; height:20; text-align:center;">선석</th>
								<td><input type="text" size="12" id="sumBerth" class="ygpaNumber" disabled="disabled"/></td>
