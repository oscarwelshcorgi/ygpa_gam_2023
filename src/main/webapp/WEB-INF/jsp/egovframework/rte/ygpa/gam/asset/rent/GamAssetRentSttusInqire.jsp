...
GamAssetRentSttusInqireModule.prototype.loadRentList = function() {
...
GamAssetRentSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#assetRentSttusInqireList').selectedRows()[0];
...
GamAssetRentSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#assetRentSttusInqireList').selectedRows()[0];

    this.$('#assetRentSttusInqireFileList').flexOptions({params:row}).flexReload();
};
...
GamAssetRentSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#assetRentSttusInqireList').selectedRowCount()==0) {
        ...
        <div id="assetRentListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            ...
            <div id="tabs2" class="emdTabPage" style="overflow:hidden;">
            	<!-- <h2>자산임대 내역</h2> -->
                    ...
                    <div id="gamAssetRentSttusInqireForm">
            	...
            	<!-- <h2>자산임대 상세내역</h2> -->
                    ...
                    <div id="gamAssetRentSttusInqireDetailForm">
