...
<%
  ...
  */
%>
<validator:javascript formName="gamArrrgNtic"
	method="validateGamArrrgNtic" staticJavascript="false"
	dynamicJavascript="true" xhtml="true" cdata="false" />
...
GamAssetRentFeePayDtlsMngtModule.prototype.loadComplete = function(params) {

    // 테이블 설정 //
    this.$("#AssetRentFeePayDtlsMngtList").flexigrid({
        module: this,
...
//					{display:'요금종류', name:'chrgeKnd',width:55, sortable:false,align:'center'},
        ...
        preProcess: function(module,data) {
        	...
        	module.makeDivValues('#AssetRentFeePayDtlsMngtListSum', data);
            */
            return data;
        }
    });

    this.$("#AssetRentFeePayDtlsMngtList").on('onItemSelected', function(event, module, row, grid, param) {
    });

    this.$("#AssetRentFeePayDtlsMngtList").on('onItemDoubleClick', function(event, module, row, grid, param) {
        // 이벤트내에선 모듈에 대해 선택한다.
        module.$("#AssetRentFeePayDtlsMngtListTab").tabs("option", {active: 1});    // 탭을 전환 한다.
    });
    ...
    */
    ...
    /* 연체내역 목록 */
    this.$("#AssetRentFeePayDtlsArrrgList").flexigrid({
        module: this,
        url: '/asset/rent/selectAssetRentFeePayDtlsMngtDlyList.do',
        dataType: 'json',
        colModel : [
        ...
        preProcess: function(module,data) {
    		if (data.resultCode == "0") {
    			module.makeDivValues('#AssetRentFeePayDtlsMngtListForm',data.resultDlyInfo);	// 리스트 값을 채운다

    			module.makeDivValues('#AssetRentFeePayDtlsMngtSum', data.resultSummary); // 결과값을 채운다.
 ...
 GamAssetRentFeePayDtlsMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'popupEntrpsInfo':
            var searchOpt=this.makeFormArgs('#gamAssetRentFeePayDtlsMngtSearchForm');
        ...
        case 'btnUpdatePayDtls':	// 납부 현황 새로 고침
            this.doAction('/asset/rent/updateAssetRentFeePayDtlsMngtList.do', null, function(module, result) {

                if(result.resultCode=='0') {
                    var searchOpt=module.makeFormArgs('#gamAssetRentFeePayDtlsMngtSearchForm');
                    module.$('#AssetRentFeePayDtlsMngtList').flexOptions({params:searchOpt}).flexReload();
                }
        ...
        case 'btnRecivePay':
        	...
        	break;
        case 'btnNticArrrg':
            this.doExecuteDialog('nticArrrgPopup', '연체 일괄 고지', '/asset/rent/showNticArrrgPopup.do', opts);
        	break;
        ...
        case 'btnNticArrrgCancelPk':
        	var rows = this.$('#AssetRentFeePayDtlsArrrgList').selectedRows();
			if(rows.length==0) {
        ...
        case 'btnNticIssuePrint':
        	var rows = this.$('#AssetRentFeePayDtlsMngtList').selectedRows();
        	if(rows.length==0) {
            ...
            this.printPayNotice('/asset/rent/printAssetRentFeePayNotice.do', row);
        	break;
        case 'btnNticIssuePrint2':
            ...
            this.printPayNotice('/asset/rent/printAssetRentFeePayNotice2.do', row);
        	break;
        case 'btnAssetRentFeePayDtlsMngtListExcelDownload':	// 엑셀 다운로드
    		this.$('#AssetRentFeePayDtlsMngtList').flexExcelDown('/asset/rent/selectAssetRentFeePayDtlsMngtListExcel.do');
    		break;
    }
};
...
//	}
	...
	if(this.resultDetail.arrrgNo!=null) {	// 기 연체 고지된 건이 있는지
	 	this.doAction('/asset/rent/updateNticArrrg.do', arrrgDetail, function(module, result) {
			if (result.resultCode == "0") {
				if(confirm('연체 고지 되었습니다. 바로 납부 고지서를 출력 하시겠습니까?')) {
					module.printPayNotice('/asset/rent/printAssetRentFeePayNotice.do', row);
				}
			} else {
				alert(result.resultMsg);
			}
	 	...
	 	this.doAction('/asset/rent/insertNticArrrg.do', arrrgDetail, function(module, result) {
			if (result.resultCode == "0") {
				if(confirm('연체 고지 되었습니다. 바로 납부 고지서를 출력 하시겠습니까?')) {
					module.printPayNotice('/asset/rent/printAssetRentFeePayNotice.do', row);
				}
...
GamAssetRentFeePayDtlsMngtModule.prototype.receiveFeeSingle = function() {
    if(this.$('#AssetRentFeePayDtlsMngtList').selectedRowCount()>0) {

        var rows = this.$('#AssetRentFeePayDtlsMngtList').selectedRows()[0];

     	this.doAction('/asset/rent/checkOcrResult.do', rows, function(module, result) {
    		if (result.resultCode == "0") {
    	    	...
    	    	module.doExecuteDialog('feePayPopup', '수납 처리', '/asset/rent/showFeePayPopup.do', opts);
    		} else {
    			alert(result.resultMsg);
    		}
    	});
...
GamAssetRentFeePayDtlsMngtModule.prototype.nticArrrgCancelAll = function() {
	...
	var arrrgDetail = [
 	...
 	this.doAction('/asset/rent/cancelNticArrrg.do', arrrgDetail, function(module, result) {
		if (result.resultCode == "0") {
			alert('고지 취소 되었습니다.');
			module.loadData();
		} else {
...
GamAssetRentFeePayDtlsMngtModule.prototype.nticArrrgCancelPk = function(ntic) {
	var row=this.$('#AssetRentFeePayDtlsMngtList').selectedRows()[0];
	...
	var arrrgDetail = [
 	...
 	this.doAction('/asset/rent/cancelNticArrrgPk.do', arrrgDetail, function(module, result) {
		if (result.resultCode == "0") {
			alert('고지 취소 되었습니다.');
			module.loadData();
		} else {
...
GamAssetRentFeePayDtlsMngtModule.prototype.nticArrrgPrintCancelPk = function(ntic) {
	var arrrgDetail = [
	               { name: 'prtAtCode', value: ntic.prtAtCode},
	               { name: 'fiscalYr', value: ntic.fiscalYr },
	               { name: 'billNo', value: ntic.billNo },
 	...
 	this.doAction('/asset/rent/cancelNticArrrgPrintPk.do', arrrgDetail, function(module, result) {
		if (result.resultCode == "0") {
			alert('고지 취소 되었습니다.');
			module.loadData();
		} else {
...
GamAssetRentFeePayDtlsMngtModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamAssetRentFeePayDtlsMngtSearchForm');
    this.$("#AssetRentFeePayDtlsMngtListTab").tabs("option", {active: 0});    // 탭을 전환 한다.
    this.$('#AssetRentFeePayDtlsMngtList').flexOptions({params:searchOpt}).flexReload();
};
...
GamAssetRentFeePayDtlsMngtModule.prototype.loadDetailPage = function() {
	...
	var nticDetail = [
	 ...
	 this.doAction('/asset/rent/selectAssetRentFeePayDtlsMngtDetail.do', nticDetail, function(module, result) {
		if (result.resultCode == "0") {
...
GamAssetRentFeePayDtlsMngtModule.prototype.calcDlyDueDate = function() {
	// 납부기한 계산
...
GamAssetRentFeePayDtlsMngtModule.prototype.loadArrrgPage = function() {
	var row = this.$('#AssetRentFeePayDtlsMngtList').selectedRows()[0];
	var searchOpt = [];
    ...
    this.$('#AssetRentFeePayDtlsArrrgList').flexOptions({params:searchOpt}).flexReload();
	/*
	var dlyList = [
	               { name: 'prtAtCode', value: row.prtAtCode},
	               { name: 'chrgeKnd', value: row.chrgeKnd },
	...
	this.doAction('/asset/rent/selectAssetRentFeePayDtlsMngtDlyList.do', dlyList, function(module, result) {
		if (result.resultCode == "0") {
...
GamAssetRentFeePayDtlsMngtModule.prototype.getMonthInterval = function (time1,time2,gubun){
	/* 날짜 계산 */
...
GamAssetRentFeePayDtlsMngtModule.prototype.getDayInterval = function (fdate,tdate){
...
GamAssetRentFeePayDtlsMngtModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	...
	if(newTabId=='tabs2' || newTabId=='tabs3') {
		if(this.$('#AssetRentFeePayDtlsMngtList').selectedRowCount()!=1) {
...
GamAssetRentFeePayDtlsMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
    ...
    case 'feePayPopup':
    	if (msg != 'cancel') {
            ...
            this.doAction('/asset/rent/updateRevCollRcvdTp.do', arg, function(module, result) {
...
<div class="window_main">
	...
	<div id="searchViewStack" class="emdPanel">
		<div class="viewPanel">
			<form id="gamAssetRentFeePayDtlsMngtSearchForm">
				<table style="width: 100%;" class="searchPanel">
					<tbody>
						<tr>
							<th style="width: 70px">항코드</th>
							<td style="width: 170px"><input id="sPrtAtCode"
								class="ygpaCmmnCd" data-default-prompt="전체"
								data-code-id="GAM019" /></td>
							<th style="width: 70px">고지업체</th>
							<td><input type="text" size="6" id="sEntrpscd"
								maxlength="10" /> <input type="text" size="12" id="sEntrpsNm"
								disabled />
								<button id="popupEntrpsInfo" class="popupButton">선택</button></td>
							<th style="width: 70px">납부구분</th>
							<td><input id="rcivSe" class="ygpaCmmnCd"
								data-code-id="GAM025" data-default-prompt="전체" value="0" /></td>
							<td rowspan="2"><button id="searchBtn" class="buttonSearch">조회</button></td>
						</tr>

						<tr>
							<th>관리번호</th>
							<td><input id="sMngYear" type="text" class="mngYear">
								<input id="sMngNo" type="text" class="mngNo"> <input
								id="sMngCnt" type="text" class="mngCnt"></td>
							<th>고지일자</th>
							<td><input id="sNticDtFrom" data-column-id="nticPdFrom"
								type="text" class="emdcal" size="8"> ~ <input
								id="sNticDtTo" data-column-id="nticPdTo" type="text"
								class="emdcal" size="8"></td>
							<th>요금종류</th>
							<td><input id="sChrgeKnd" class="ygpaCmmnCd"
								data-default-prompt="전체" data-code-id="GAM024" /></td>
						</tr>
					</tbody>
				</table>
			</form>
	...
	<div class="emdPanel fillHeight">
		<div id="AssetRentFeePayDtlsMngtListTab"
			class="emdTabPanel fillHeight" data-onchange="onTabChange"
			data-onchange-before="onTabChangeBefore">
			<ul>
				<li><a href="#tabs1" class="emdTab">자산임대사용료납부현황 목록</a></li>
				<li><a href="#tabs2" class="emdTab">자산임대사용료납부현황 상세</a></li>
				<!-- change** -->
				<li><a href="#tabs3" class="emdTab">자산임대사용료연체현황 목록</a></li>
			</ul>

			<div id="tabs1" class="emdTabPage fillHeight"
				style="overflow: hidden;" data-onactivate="onShowTab1Activate">
				<table id="AssetRentFeePayDtlsMngtList" style="display: none"
					class="fillHeight"></table>
				<div id="AssetRentFeePayDtlsMngtListSum" class="emdControlPanel">
					<form id="summaryForm">
						<table style="width: 100%;" class="summaryPanel">
							<tr>
								<th width="6%">자료수</th>
								<td><input type="text" size="6" id="sumCnt"
									class="ygpaNumber" disabled="disabled" /></td>
								<th width="8%">총고지금액</th>
								<td><input type="text" size="16" id="sumNhtIsueAmt"
									class="ygpaNumber" disabled="disabled" /></td>
								<th width="6%">부가세</th>
								<td><input type="text" size="16" id="sumVat"
									class="ygpaNumber" disabled="disabled" /></td>
								<th width="10%">총납부금액</th>
								<td><input type="text" size="16" id="sumPayAmt"
									class="ygpaNumber" disabled="disabled" /></td>
								<td><button id="btnUpdatePayDtls"
										data-icon="ui-icon-circle-check">납부확인</button></td>
								<td><button id="btnRecivePay"
										data-icon="ui-icon-circle-check">수납</button></td>
								<td><button
										id="btnAssetRentFeePayDtlsMngtListExcelDownload">엑셀</button></td>
			...
			<div id="tabs2" class="emdTabPage" style="overflow: scroll;">
				...
				<div class="emdPanel">
					...
					<table id="masterPayInfo" class="detailPanel">
						<tr>
							...
							<td style="width: 180px"><span class="ygpaCmmnCd"
								data-code-id="GAM019" data-column-id="prtAtCode"></span> (<span
								data-column-id="prtAtCode"></span>)</td>
						...
						<tr>
							...
							<td><span data-column-id="chrgeKndNm"></span> (<span
								data-column-id="chrgeKnd"></span>)</td>
							<th><span class="label">고지업체</span></th>
							<td colspan="3"><span data-column-id="entrpsNm"></span> (<span
								data-column-id="entrpscd"></span>)</td>
							<th><span class="label">고지금액</span></th>
							<td style="text-align: right;"><span
								data-column-id="nticAmt" class="ygpaNumber"></span> 원</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><span data-column-id="rcivSe" class="ygpaCmmnCd"
								data-code-id="GAM025"></span></td>
						...
						<form id="arrrgDetailVO">
							...
							<table id="arrrgDetailInfo" class="detailPanel"
								...
								<tr>
									...
									<td width="125px"><input id="dlyBillDt"
										data-column-id="dlyBillDt" class="emdcal" style="width: 90px" /></td>
									<th><span class="label">연체고지납부기한</span></th>
									<td width="125px"><input id="dlyDueDt"
										data-column-id="dlyDueDt" class="emdcal" style="width: 90px" /></td>
									<th><span class="label">연체요율</span></th>
									<td><input id="arrrgRate" data-column-id="arrrgRate"
										style="width: 80px" /></td>
								</tr>
								<tr>
									<th><span class="label">연체금액</span></th>
									<td><input id="arrrgAmt" data-column-id="arrrgAmt"
										class="ygpaNumber" style="width: 90px" data-decimal-point="0" />
										원</td>
					...
					<thead>
						<tr>
							<th style="text-align: center; width: 60px"><span
								class="label">회차</span></th>
							<th style="text-align: center; width: 80px"><span
								class="label">회계년도</span></th>
							<th style="text-align: center; width: 80px"><span
								class="label">고지번호</span></th>
							<th style="text-align: center; width: 130px"><span
								class="label">요금종류</span></th>
							<th style="text-align: center; width: 100px"><span
								class="label">고지금액</span></th>
							<th style="text-align: center; width: 80px"><span
								class="label">고지일자</span></th>
							<th style="text-align: center; width: 110px"><span
								class="label">납부기한일자</span></th>
							<th style="text-align: center; width: 80px"><span
								class="label">수납구분</span></th>
							<th style="text-align: center; width: 80px"><span
								class="label">수납일자</span></th>
						</tr>
					</thead>
					<tbody id="detailPayInfo">
						<tr>
							<td style="text-align: center;"><span
								data-column-id="nticCnt"></span></td>
							<td style="text-align: center;"><span
								data-column-id="accnutYear"></span></td>
							<td style="text-align: center;"><span
								data-column-id="nticno"></span></td>
							<td style="text-align: left;"><span
								data-column-id="chrgeKndNm"></span> (<span
								data-column-id="chrgeKnd"></span>)</td>
							<td style="text-align: right;"><span data-column-id="fee"
								class="ygpaNumber"> 원</span></td>
							<td style="text-align: center;"><span
								data-column-id="nticDt"></span></td>
							<td style="text-align: center;"><span
								data-column-id="payTmlmt"></span></td>
							<td style="text-align: center;"><span
								data-column-id="rcivSe" class="ygpaCmmnCd" data-code-id="GAM025"></span></td>
							<td style="text-align: center;"><span
								data-column-id="rcivDt"></span></td>
						</tr>
					</tbody>
				</table>
				<table id="summaryPayInfo" class="summaryPanel">
					<tr>
						...
						<td style="text-align: right; width: 92px"><span
							data-column-id="totalNticAmount" class="ygpaNumber"></span> 원</td>
						<th><span class="label">총 납부 금액</span></th>
						<td style="text-align: right; width: 92px"><span
							data-column-id="feePayAmount" class="ygpaNumber"></span> 원</td>
						<th><span class="label">관리비</span></th>
						<td style="text-align: right; width: 92px"><span
							data-column-id="feeA1" class="ygpaNumber"></span> 원</td>
						<th><span class="label">이자</span></th>
						<td style="text-align: right; width: 92px"><span
							data-column-id="feeA3" class="ygpaNumber"></span> 원</td>
						<th><span class="label">연체료</span></th>
						<td style="text-align: right; width: 92px"><span
							data-column-id="feeD1" class="ygpaNumber"></span> 원</td>
						<th><span class="label">과태료</span></th>
						<td style="text-align: right; width: 92px"><span
							data-column-id="feeD2" class="ygpaNumber"></span> 원</td>
					</tr>
				</table>
			</div>
			<!-- change** -->
			<div id="tabs3" class="emdTabPage" style="overflow: scroll;">
				...
				<form id="AssetRentFeePayDtlsMngtListForm">
					<div>
						<table class="detailForm" style="width: 100%;">
							...
							<tr>
								...
								<th width="16%">연체횟수</th>
								<td><span data-column-id="dlySerNo" class="ygpaNumber"
									style="text-align: right;"></span></td>
							</tr>
							<tr>
								<th width="16%">연체고지금액</th>
								<td><span data-column-id="dlyBillAmnt" class="ygpaNumber"
									style="text-align: right;"></span></td>
				...
				<h2>연체 고지 목록</h2>
				<table id="AssetRentFeePayDtlsArrrgList" style="display: none"
					class="fillHeight"></table>
				<table style="width: 100%; margin-bottom: 2px"
					id="AssetRentFeePayDtlsMngtSum" class="summaryPanel">
					<tr>
						<th width="30%" height="23">자료수</th>
						<td><span id="dpTotCnt" class="ygpaNumber"
							style="text-align: right;"></span></td>
						<th width="30%" height="23">연체고지금액합계</th>
						<td><span id="sumDlyBillAmnt" class="ygpaNumber"
							style="text-align: right;"></span></td>
					</tr>
				</table>
					...
					<tbody>
						<tr>
							<td style="text-align: right">
								<button data-cmd="btnNticArrrgCancelPk"
									data-icon="ui-icon-clock">고지취소</button>
