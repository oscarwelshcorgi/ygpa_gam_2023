 ...
 GamAssetRentFeePayDtlsMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'btnNticPayment':	// 납부 확인
            ...
            this.doExecuteDialog('btnNticPayPopup', '수납 확인', '/asset/rent/showNticPaymentPopup.do', null, row);
        	break;
    }
};
...
GamAssetRentFeePayDtlsMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
    ...
    case 'tabs2':
        ...
        break;
	case 'tabs3':
		this.$("#assetRentFeePayDtlsMngtListTab").tabs("option", {active: 2});    // 탭을 전환 한다.
	    break;
	}
};
    ...
    <div class="emdPanel fillHeight">
        <div id="assetRentFeePayListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
                ...
                <li><a href="#tabs3" class="emdTab">자산임대료납부연체현황 목록</a></li>
            </ul>
                    ...
                    <form id="arrrgDetailVO">
                      <table id="arrrgDetailInfo" class="detailPanel">
                        ...
                        <tr>
                            ...
                            <td><input id="arrrgRate" data-column-id="arrrgRate" style="width:110px"/></td>
			...
			<div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItem">저장</button><button id="btnCancelItem">취소</button><button id="btnRemoveItem">삭제</button></div>  -->
                    ...
                    <table style="width:100%;" id="assetRentFeePayDtlsMngtSum" class="summaryPanel">
						<tr>
