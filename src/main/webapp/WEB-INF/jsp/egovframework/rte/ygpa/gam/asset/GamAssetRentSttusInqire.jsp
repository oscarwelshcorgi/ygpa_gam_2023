...
<%
  ...
  * @Description : 자산임대현황조회  테스트 (Prototype)
...
GamAssetEvlDtlsInqiryModule.prototype.loadComplete = function() {
	...
	this.$("#assetEvlDtlsList").flexigrid({
		...
		colModel : [
				...
				{display:'임대부서 구분코드', name:'MNG_NO',width:200, sortable:false,align:'center'},
				...
				{display:'비고',name:'RM',width:160,sortable:false,align:'center'}
			],
/* 		searchitems : [
