...
**/
%>
GamFcltsClCdMngModule.prototype.firstData = function() {
	...
	var fcltsClCd = row["fcltsClCd"];
	var fcltsJobSe = row["fcltsJobSe"];
	var depthSort = row["depthSort"];
	var fcltsClUpperCd = row["fcltsClUpperCd"];
	var fcltsClUpperNm = row["fcltsClUpperNm"];
	if (fcltsClCd != "") {
		this.$("#mainGrid").selectFilterRow([{col:"fcltsClCd", filter:fcltsClCd}]);
		this._mainmode = 'modify';
		...
		this._saveFcltsClUpperCd = fcltsClUpperCd;
		this._saveFcltsClUpperNm = fcltsClUpperNm;
...
**/
%>
GamFcltsClCdMngModule.prototype.prevData = function() {
...
**/
%>
GamFcltsClCdMngModule.prototype.nextData = function() {
...
**/
%>
GamFcltsClCdMngModule.prototype.lastData = function() {
