...
GamNticArrrgPopupModule.prototype.loadComplete = function(searchOpt) {
	...
	// 그리드 설정
    this.$("#assetRentFeeArrrgList").flexigrid({
        module: this,
        url: '/asset/rent/selectNticArrrgList.do',
        dataType: 'json',
        colModel : [
	...
	this.$("#assetRentFeeArrrgList").on("onItemDoubleClick", function(event, module, row, grid, param) {
...
GamNticArrrgPopupModule.prototype.onButtonClick = function(buttonId) {
	...
	case 'btnSaveArrrg':	// 연체 일괄 고지
		if(confirm("조회된 건에 대해서 연체 일괄 고지를 하시겠습니까?")) {
	        ...
	        this.doAction('/asset/rent/insertNticArrrgList.do', searchOpt, function(module, result) {
...
<!--                             <th>수납 구분</th>
	...
	<div class="emdPanel fillHeight">
		<table id="assetRentFeeArrrgList" style="display: none" class="fillHeight"></table>
