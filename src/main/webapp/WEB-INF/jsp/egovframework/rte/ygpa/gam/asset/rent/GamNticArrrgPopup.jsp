...
GamNticArrrgPopupModule.prototype.loadComplete = function() {
			...
			<table class="searchPanel">
				<tbody>
                        <tr>
                            ...
                            <td style="width: 80px"><input id="sPrtAtCode" class="ygpaCmmnCd" data-default-prompt="전체" data-code-id="GAM019" /></td>
                            <th>관리번호</th>
