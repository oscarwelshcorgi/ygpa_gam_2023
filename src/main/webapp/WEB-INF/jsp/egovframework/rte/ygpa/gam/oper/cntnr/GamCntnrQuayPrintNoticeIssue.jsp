...
@media print {
  ...
  <c:if test="${arrrgItem!=null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/cntnr/printRentFeeSepNoticeIssue.do' />"/>
  </c:if>
  <c:if test="${arrrgItem==null }">
  	<input id="printUrl" type="hidden" value="<c:url value='/oper/cntnr/printRentFeeNoticeIssue.do' />"/>
  </c:if>
