 ...
 */
 function GamCntnrQuayRentSttusModule() {}

 GamCntnrQuayRentSttusModule.prototype = new EmdModule(910, 550);

 // 페이지가 호출 되었을때 호출 되는 함수
 GamCntnrQuayRentSttusModule.prototype.loadComplete = function() {
  ...
  * 정의 된 버튼 클릭 시
  */
  GamCntnrQuayRentSttusModule.prototype.onButtonClick = function(buttonId) {
 ...
 GamCntnrQuayRentSttusModule.prototype.onSubmit = function() {
     this.loadData();
 };

 GamCntnrQuayRentSttusModule.prototype.loadData = function() {
     var searchOpt=this.makeFormArgs('#gamOperSearchForm');
     this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
 };

 GamCntnrQuayRentSttusModule.prototype.onTabChange = function(newTabId, oldTabId) {
     switch(newTabId) {
     case 'tabs1':
         break;
     case 'tabs2':
...
GamCntnrQuayRentSttusModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
 ...
 var module_instance = new GamCntnrQuayRentSttusModule();
 </script>
 <!-- 아래는 고정 -->
 ...
 <div class="window_main">
     ...
     <div class="emdPanel">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 <li><a href="#tabs1" class="emdTab">컨테이너부두사용현황 조회내역</a></li>
                 <li><a href="#tabs2" class="emdTab">컨테이너부두사용현황 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">컨테이너부두사용현황 상세조회내역</a></li>
             </ul>
