...
GamCntnrQuayRentSttusInqireModule.prototype.loadComplete = function() {
    ...
    this.$("#cntnrQuayRentSttusInqireList").flexigrid({
        module: this,
        url: '/oper/cntnr/selectCntnrQuayRentSttusInqireList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#cntnrQuayRentSttusInqireFileList").flexigrid({
        module: this,
        url: '/oper/cntnr/gamSelectCntnrQuayRentSttusInqireFileList.do',
        dataType: 'json',
        colModel : [
...
GamCntnrQuayRentSttusInqireModule.prototype.loadRentList = function() {
...
GamCntnrQuayRentSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#cntnrQuayRentSttusInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamCntnrQuayRentSttusInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('/oper/cntnr/selectCntnrQuayRentSttusInqireDetailList.do', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamCntnrQuayRentSttusInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamCntnrQuayRentSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#cntnrQuayRentSttusInqireList').selectedRows()[0];

    this.$('#cntnrQuayRentSttusInqireFileList').flexOptions({params:row}).flexReload();
};
...
GamCntnrQuayRentSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#cntnrQuayRentSttusInqireList').selectedRowCount()==0) {
...
<div class="window_main">
    ...
    <div class="emdPanel fillHeight">
        <div id="cntnrQuayRentSttusInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
