...
<%
/**
 * @Class Name : GamTestPrtFcltyUseSttusInqire.jsp
 ...
 */
function GamTestPrtFcltyUseSttusInqireModule() {}

GamTestPrtFcltyUseSttusInqireModule.prototype = new EmdModule(1000, 600);

// 페이지가 호출 되었을때 호출 되는 함수
GamTestPrtFcltyUseSttusInqireModule.prototype.loadComplete = function() {

    // 자산임대 테이블 설정
    this.$("#prtFcltyUseSttusInqireList").flexigrid({
        module: this,
        url: '/oper/gnrltest/selectPrtFcltyUseSttusInqireList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#prtFcltyUseSttusInqireFileList").flexigrid({
        module: this,
        url: '/oper/gnrltest/gamSelectPrtFcltyUseSttusInqireFileList.do',
        dataType: 'json',
        colModel : [
    ...
    this.$("#prtFcltyUseSttusInqireFileList").on('onItemSelected', function(event, module, row, grid, param) {
        module.makeFormValues('#gamTestPrtFcltyUseSttusInqireFileForm', row);
...
GamTestPrtFcltyUseSttusInqireModule.prototype.loadRentList = function() {
    this.$("#prtFcltyUseSttusInqireListTab").tabs("option", {active: 0});

    var searchOpt=this.makeFormArgs('#gamTestPrtFcltyUseSttusInqireSearchForm');
    this.$('#prtFcltyUseSttusInqireList').flexOptions({params:searchOpt}).flexReload();
    // console.log('load rent list');
};

GamTestPrtFcltyUseSttusInqireModule.prototype.loadDetailForm = function() {
     	var row = this.$('#prtFcltyUseSttusInqireList').selectedRows()[0];
		...
		this.makeDivValues('#gamTestPrtFcltyUseSttusInqireForm', row); // 결과값을 채운다.

   	 	this.doAction('/oper/gnrltest/selectPrtFcltyUseSttusInqireDetailList.do', detailParam, function(module, result) {
			if (result.resultCode == "0") {
				module.makeMultiDivValues('#gamTestPrtFcltyUseSttusInqireDetailForm',result.resultList , function(row) {
				} );	// 리스트 값을 채운다
			} else {
...
GamTestPrtFcltyUseSttusInqireModule.prototype.loadFileList = function() {
	var row = this.$('#prtFcltyUseSttusInqireList').selectedRows()[0];

    this.$('#prtFcltyUseSttusInqireFileList').flexOptions({params:row}).flexReload();
};

/**
 * 정의 된 버튼 클릭 시
 */
 GamTestPrtFcltyUseSttusInqireModule.prototype.onButtonClick = function(buttonId) {
    switch(buttonId) {
        case 'searchBtn':		 // 조회
			this.loadRentList();
            break;
        ...
        case 'btnDownloadFile':
    		var selectRow = this.$('#prtFcltyUseSttusInqireFileList').selectedRows();
...
**/
%>
GamTestPrtFcltyUseSttusInqireModule.prototype.downloadExcel = function(buttonId) {
	...
	switch (buttonId) {
		case 'btnExcelDownload':
			this.$('#prtFcltyUseSttusInqireList').flexExcelDown('/oper/gnrltest/selectPrtFcltyUseSttusInqireListExcel.do');
			break;
	}

};

GamTestPrtFcltyUseSttusInqireModule.prototype.onSubmit = function() {
    this.loadData();
};

GamTestPrtFcltyUseSttusInqireModule.prototype.loadData = function() {
    var searchOpt=this.makeFormArgs('#gamTestPrtFcltyUseSttusInqireSearchForm');
    //this.showAlert(searchOpt);
    this.$('#prtFcltyUseSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamTestPrtFcltyUseSttusInqireModule.prototype.onTabChangeBefore = function(newTabId, oldTabId) {
	if(oldTabId=="tabs1" && this.$('#prtFcltyUseSttusInqireList').selectedRowCount()==0) {
...
GamTestPrtFcltyUseSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
    switch(newTabId) {
    case 'tabs1':
        break;
    case 'tabs2':
...
GamTestPrtFcltyUseSttusInqireModule.prototype.onClosePopup = function(popupId, msg, value) {
    switch (popupId) {
...
var module_instance = new GamTestPrtFcltyUseSttusInqireModule();
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamTestPrtFcltyUseSttusInqireSearchForm">
    ...
    <div class="emdPanel fillHeight">
        <div id="prtFcltyUseSttusInqireListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
            <ul>
            ...
            <div id="tabs2" class="emdTabPage" style="overflow:hidden;">
            	<!-- <h2>항만시설사용 내역</h2> -->
                    ...
                    <div id="gamTestPrtFcltyUseSttusInqireForm">
            	...
            	<!-- <h2>항만시설사용 상세내역</h2> -->
                    ...
                    <div id="gamTestPrtFcltyUseSttusInqireDetailForm">
            ...
            <div id="tabs4" class="emdTabPage" style="overflow: scroll;">
                ...
                <form id="gamTestPrtFcltyUseSttusInqireFileForm">
