...
<%
  /**
  * @Class Name : GamTrainPortRentLstMngt.jsp
 ...
 */
 function GamTrainPortRentLstMngtModule() {}

 GamTrainPortRentLstMngtModule.prototype = new EmdModule(910, 550);

 // 페이지가 호출 되었을때 호출 되는 함수
 GamTrainPortRentLstMngtModule.prototype.loadComplete = function() {

     // 테이블 설정
     this.$("#operResultList").flexigrid({
         module: this,
         url: '<c:url value="/oper/train/selectTrainPortRentLstMngtList.do" />',
         dataType: 'json',
         colModel : [
     ...
     this.$("#operResultDetailList").flexigrid({  
         module: this,
         url: '<c:url value="/oper/train/selectTrainPortRentLstMngtDetailList.do" />',  
         dataType: 'json',
         colModel : [
  ...
  * 정의 된 버튼 클릭 시
  */
  GamTrainPortRentLstMngtModule.prototype.onButtonClick = function(buttonId) {
     ...
     switch(buttonId) {
         ...
         // 최초신청
         case 'addTrainPortRentLstMngtFirst':
         ...
         // 연장신청
         case 'addTrainPortRentLstMngtRenew':
             var rows = this.$('#operResultList').selectedRows();
             
             if(rows.length>=1) {
                 //this.$('#rPrtAtCode').val(row[0]['prtAtCode']);
                 
                 this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentLstMngtRenew.do" />', rows[0], function(module, result) {
         ...
         case 'btnSaveItem':
             ...
             if(this.$("#cmd").val()=='insert') {
             	...
             	this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentLstMngtFirst.do" />', inputVO, function(module, result) {
                 ...
                 this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentLstMngt.do" />', inputVO, function(module, result) {	
                 	if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnRemoveItem':
             if( this.$('#cmd').val() == 'modify' ) {
                 ...
                 this.doAction('<c:url value="/oper/train/gamDeleteTrainPortRentLstMngt.do" />', inputVO, function(module, result) {
         ...
         case 'btnRemoveItemDetail':
             ...
             if(rows.length>=1) {
                 this.doAction('<c:url value="/oper/train/gamDeleteTrainPortRentLstMngtDetail.do" />', rows[0], function(module, result) {
                     if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultDetailList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnSaveItemDetail':
             ...
             if(this.$("#detailCmd").val()=='insert') {
                 ...
                 this.doAction('<c:url value="/oper/train/gamInsertTrainPortRentLstMngtDetail.do" />', inputVO, function(module, result) {
             	...
             	this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentLstMngtDetail.do" />', inputVO, function(module, result) { 
                     if(result.resultCode=='0') {
                     	var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultDetailList').flexOptions({params:searchOpt}).flexReload();
                     }
         ...
         case 'btnPrmisn': // 승낙 (허가)   
             ...
             if(rows.length>=1) {
                 ...
                 this.doExecuteDialog('insertTrainPortRentLstMngtPrmisnPopup', '승낙', '<c:url value="/oper/train/popup/showTrainPortRentLstMngtPrmisn.do"/>', opts);
         ...
         case 'btnPrmisnCancel': // 승낙취소 (허가취소)
             ...
             if(rows.length>=1) {
                 this.doAction('<c:url value="/oper/train/gamUpdateTrainPortRentLstMngtPrmisnCancel.do" />', rows[0], function(module, result) {
                     if(result.resultCode=='0') {
                         var searchOpt=module.makeFormArgs('#gamOperForm');
                         module.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
                     }
 ...
 GamTrainPortRentLstMngtModule.prototype.onSubmit = function() {
     this.loadData();
 };

 GamTrainPortRentLstMngtModule.prototype.loadData = function() {
     var searchOpt=this.makeFormArgs('#gamOperSearchForm');
     this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();
 };

 GamTrainPortRentLstMngtModule.prototype.onTabChange = function(newTabId, oldTabId) {
     switch(newTabId) {
     case 'tabs1':
         break;
     case 'tabs2':
...
GamTrainPortRentLstMngtModule.prototype.onClosePopup = function(popupId, msg, value) {
	switch (popupId) {
    ...
    case 'insertEntrpsInfoPopup':
        ...
        break;
    case 'insertTrainPortRentLstMngtPrmisnPopup':    
   	 if (msg != 'cancel') {
   		 if( value == "0" ) {
   			 var searchOpt=this.makeFormArgs('#gamOperSearchForm');
                this.$('#operResultList').flexOptions({params:searchOpt}).flexReload();               	 
 ...
 var module_instance = new GamTrainPortRentLstMngtModule();
 </script>
 <!-- 아래는 고정 -->
 ...
 <div class="window_main">
     ...
     <div class="emdPanel">
         <div id="operResultListTab" class="emdTabPanel" data-onchange="onTabChange">
             <ul>
                 <li><a href="#tabs1" class="emdTab">철송장사용목록관리 조회내역</a></li>
                 <li><a href="#tabs2" class="emdTab">철송장사용목록관리 상세조회 목록내역</a></li>
                 <li><a href="#tabs3" class="emdTab">철송장사용목록관리 상세조회내역</a></li>
             </ul>
                 ...
                 <div class="emdControlPanel">
                     <table style="width:100%;" >
                         <tr>
                             ...
                             <td>
                                 <button id="addTrainPortRentLstMngtRenew">연장신청</button>
                                 <button id="addTrainPortRentLstMngtFirst">최초신청</button>
