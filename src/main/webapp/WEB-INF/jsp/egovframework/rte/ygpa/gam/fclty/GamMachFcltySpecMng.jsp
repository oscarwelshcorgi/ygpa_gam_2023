...
**/
%>
GamMachFcltySpecMngModule.prototype.hideFcltyMaintMngList = function() {
...
**/
%>
GamMachFcltySpecMngModule.prototype.showFcltyMaintMngList = function(argParent) {
...
**/
%>
GamMachFcltySpecMngModule.prototype.buildFcltyMaintMngList = function() {
	...
	this.doAction('/fclty/gamSelectMachFcltySpecMngMntnRprDtlsList.do', searchVO, function(module, result) {
		if (result.resultCode == "0") {
			if (result.resultList.length <= 0) {
	...
	<div class="emdPanel fillHeight">
		...
		<div id="mainTab" class="emdTabPanel fillHeight" data-onchange="onTabChange">
			...
			<ul>
				...
				<li><a href="#fileTab" class="emdTab">기계시설 설계도서</a></li>
			</ul>
			<!-- 212. TAB 1 AREA (LIST) -->
