 ...
 GamCntnrQuayNticArrvlDtaInqireModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'openRentFee':	// 사용료 관리 화면을 호출 한다.
	        if(this.$('#cntnrQuayNticArrvlDtaInqireList').selectedRowCount()==1) {
	         	var row = this.$('#cntnrQuayNticArrvlDtaInqireList').selectedRows()[0];
	        	...
	        	EMD.util.create_window('gamCntnrQuayRentFeeMngt', '컨테이너부두임대료관리', EMD.context_root+'/oper/cntnr/gamCntnrQuayRentFeeMngt.do', null, {action: "selectRentFee", nticVo: params});
	    	}
