 ...
 */
function GamCmmnCntrEntrpsRentFeeSttusInqireModule() {}

GamCmmnCntrEntrpsRentFeeSttusInqireModule.prototype = new EmdModule(1000, 600);
...
GamCmmnCntrEntrpsRentFeeSttusInqireModule.prototype.loadComplete = function() {
 ...
 this.$("#cmmnCntrEntrpsRentFeeSttusInqireList").flexigrid({
     module: this,
     url: '/oper/shed/gamSelectCmmnCntrEntrpsRentFeeSttusInqireList.do',
     dataType: 'json',
     colModel : [
...
GamCmmnCntrEntrpsRentFeeSttusInqireModule.prototype.loadData = function() {
 var searchOpt=this.makeFormArgs('#gamCmmnCntrEntrpsRentFeeSttusInqireSearchForm');
 //this.showAlert(searchOpt);
 this.$('#cmmnCntrEntrpsRentFeeSttusInqireList').flexOptions({params:searchOpt}).flexReload();
};

GamCmmnCntrEntrpsRentFeeSttusInqireModule.prototype.onTabChange = function(newTabId, oldTabId) {
 switch(newTabId) {
 case 'tabs1':
     break;
 case 'tabs2':
...
var module_instance = new GamCmmnCntrEntrpsRentFeeSttusInqireModule();
</script>
<!-- 아래는 고정 -->
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCmmnCntrEntrpsRentFeeSttusInqireSearchForm">
