...
GamCmmnCntrRentFeePaySttusMngtModule.prototype.loadComplete = function() {
    ...
    this.$("#cmmnCntrRentFeePaySttusMngtList").flexigrid({
        module: this,
        url: '<c:url value="/oper/shed/gamSelectCmmnCntrRentFeePayDtlsMngtList.do" />',
        dataType: 'json',
        colModel : [
 ...
 GamCmmnCntrRentFeePaySttusMngtModule.prototype.onButtonClick = function(buttonId) {
    ...
    switch(buttonId) {
        ...
        case 'popupEntrpsInfo':
            var searchOpt=this.makeFormArgs('#gamCmmnCntrRentFeePayDtlsSearchForm');
        ...
        case 'btnUpdatePayDtls':	// 납부 현황 새로 고침
            this.doAction('<c:url value="/oper/shed/updateCmmnCntrRentFeePayDtlsMngtList.do" />', null, function(module, result) {

                if(result.resultCode=='0') {
                    var searchOpt=module.makeFormArgs('#gamCmmnCntrRentFeePayDtlsSearchForm');
        	...
        	break;
        case 'btnNticArrrg':
            this.doExecuteDialog('nticArrrgPopup', '연체 일괄 고지', '<c:url value="/oper/shed/showNticArrrgPopup.do"/>', opts);
        	break;
...
GamCmmnCntrRentFeePaySttusMngtModule.prototype.nticArrrgSingle = function() {
	...
	var nticDetail = [
	 	...
	 	this.doAction('<c:url value="/oper/shed/insertNticArrrg.do" />', nticDetail, function(module, result) {
		if (result.resultCode == "0") {
		} else {
		}
		alert(result.resultMsg);
...
GamCmmnCntrRentFeePaySttusMngtModule.prototype.loadDetailPage = function() {
	...
	var nticDetail = [
		...
		this.doAction('<c:url value="/oper/shed/selectCmmnCntrRentFeePaySttusMngtDlyList.do" />', dlyList, function(module, result) {
			if (result.resultCode == "0") {
...
<div class="window_main">
    ...
    <div id="searchViewStack" class="emdPanel">
        <div class="viewPanel">
            <form id="gamCmmnCntrRentFeePayDtlsSearchForm">
        ...
        <div id="cmmnCntrRentFeePaySttusMngtListTab" class="emdTabPanel fillHeight" data-onchange="onTabChange" data-onchange-before="onTabChangeBefore">
			...
			<div id="tabs3" class="emdTabPage" style="overflow: scroll;">
                ...
                <!-- <div class="emdControlPanel"><button id="btnSaveItem">저장</button><button id="btnCancelItem">취소</button><button id="btnRemoveItem">삭제</button></div>  -->
                    ...
                    <table style="width:100%;" id="cmmnCntrRentFeePaySttusMngtSum" class="summaryPanel">
						<tr>
